object frmRelatorioImpo: TfrmRelatorioImpo
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ...
  object Panel2: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Color = clInfoBk
      Ctl3D = False
      DataSource = dmdBroker.dtsRelatorioImpo
      Font.Charset = DEFAULT_CHARSET
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Importador N'#250'mero'
          Width = 138
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'numeroDI'
          Title.Caption = 'DI N'#250'mero'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'totalAdicoes'
          Title.Caption = 'Total Adi'#231#245'es'
          Width = 94
          Visible = True
        end
        item
        ...
        item
          ...
          Title.Caption = 'N'#250'mero Seq Item'
          Width = 120
          Visible = True
        end
        item
