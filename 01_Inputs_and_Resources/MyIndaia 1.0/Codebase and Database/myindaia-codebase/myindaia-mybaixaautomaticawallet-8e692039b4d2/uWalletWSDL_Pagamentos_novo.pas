...
//  >Import : http://senior:8080/g5-senior-services/sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos?xsd
// Encoding : UTF-8
// Version  : 1.0
// (15/04/2024 16:51:36 - - $Rev: 90173 $)
// ************************************************************************ //

unit uWalletWSDL_Pagamentos_novo;
...
function Getsapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos;


implementation
  uses System.SysUtils;

function Getsapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos;
const
...
procedure titulosSubstituirTitulosIntitulosSubstitutos.SetccbFor(Index: Integer; const Astring: string);
begin
  FccbFor := Astring;
  FccbFor_Specified := True;
end;

function titulosSubstituirTitulosIntitulosSubstitutos.ccbFor_Specified(Index: Integer): boolean;
begin
  Result := FccbFor_Specified;
end;

procedure titulosSubstituirTitulosIntitulosSubstitutos.SetcodAge(Index: Integer; const Astring: string);
begin
  FcodAge := Astring;
  FcodAge_Specified := True;
end;

function titulosSubstituirTitulosIntitulosSubstitutos.codAge_Specified(Index: Integer): boolean;
begin
  Result := FcodAge_Specified;
end;

procedure titulosSubstituirTitulosIntitulosSubstitutos.SetcodBan(Index: Integer; const Astring: string);
begin
  FcodBan := Astring;
  FcodBan_Specified := True;
end;

function titulosSubstituirTitulosIntitulosSubstitutos.codBan_Specified(Index: Integer): boolean;
begin
...
initialization
  ...
  InvRegistry.RegisterInvokeOptions(TypeInfo(sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos), ioLiteral);
  InvRegistry.RegisterInvokeOptions(TypeInfo(sapiens_Syncmyindaia_com_br_custom_mfi_cpa_titulos), ioSOAP12);
