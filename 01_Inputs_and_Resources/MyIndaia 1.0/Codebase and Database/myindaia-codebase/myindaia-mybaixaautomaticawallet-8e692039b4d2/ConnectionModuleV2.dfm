  ...
  object qryImpressaoNumerario: TFDQuery
    ...
    SQL.Strings = (
      ...
      '                        '#9#9'                     '
        ...
        '   LEFT JOIN BROKER.DBO.TEXPORTADOR_DI         EXDI  (NOLOCK)  O' +
        'N EXDI.NR_PROCESSO     = PR.NR_PROCESSO'
      
        '   LEFT JOIN BROKER.DBO.TEMPRESA_EST           EX    (NOLOCK)  O' +
        'N EX.CD_EMPRESA        = ISNULL(EXDI.CD_EXPORTADOR, PR.CD_EXPORT' +
        'ADOR)  '
