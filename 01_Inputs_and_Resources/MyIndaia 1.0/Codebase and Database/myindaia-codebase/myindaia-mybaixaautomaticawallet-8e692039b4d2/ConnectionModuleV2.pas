...
uses
  ...
  uWalletWSDL_CadPedidos, Datasnap.Provider, Datasnap.DBClient, IWSystem,
  uWalletWSDL_Pagamentos, ConnectionModule, Soap.SOAPDomConv,
...
uses MyEntitiesBroker, Soap.WebNode;
