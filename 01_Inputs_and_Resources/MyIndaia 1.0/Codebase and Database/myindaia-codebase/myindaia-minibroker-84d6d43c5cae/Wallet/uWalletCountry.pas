...
type
  TFrmWalletCountry = class(TformMyCdBasic)
...
var
  FrmWalletCountry: TFrmWalletCountry;
...
procedure TFrmWalletCountry.DoCreate;
begin
  inherited;
...
procedure TFrmWalletCountry.DoShow;
begin
  inherited;
  adsMain.DisableControls;
  adsMain.close;
  adsMain.SetSourceCriteria(FObjectManager.Find<TCountry>);
  adsMain.Open;
  adsMain.EnableControls;
end;

procedure TFrmWalletCountry.InternalPost;
begin
