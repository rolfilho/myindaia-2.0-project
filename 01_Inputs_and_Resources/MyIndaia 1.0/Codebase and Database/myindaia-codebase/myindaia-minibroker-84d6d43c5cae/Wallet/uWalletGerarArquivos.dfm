inherited frmWalletGerarArquivos: TfrmWalletGerarArquivos
  ...
  object Panel1: TPanel
    ...
    ExplicitLeft = 22
    ExplicitTop = 79
    object rgPadraoImpo: TRadioButton
      Left = 16
      Top = 27
      Width = 137
      Height = 17
      Caption = 'Padr'#227'o Importa'#231#227'o'
      Checked = True
      TabOrder = 0
      TabStop = True
    end
    object rgPadraoExpo: TRadioButton
      Left = 168
      Top = 27
      Width = 137
      Height = 17
      Caption = 'Padr'#227'o Exporta'#231#227'o'
      TabOrder = 1
      TabStop = True
    end
    object rgArquivoTexto: TRadioButton
      Left = 318
      Top = 27
      Width = 159
      Height = 17
      Caption = 'Arquivo Texto (IMPO)'
      TabOrder = 2
      TabStop = True
    end
  end
