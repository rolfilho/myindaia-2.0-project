...
type
  TfrmWalletBank = class(TformMyCdBasic)
...
procedure TfrmWalletBank.DoCreate;
begin
  inherited;
...
procedure TfrmWalletBank.DoShow;
begin
  inherited;
  adsMain.DisableControls;
  adsMain.close;
  adsMain.SetSourceCriteria(FObjectManager.Find<TBank>);
  adsMain.Open;
  adsMain.EnableControls;
end;


procedure TfrmWalletBank.InternalPost;
begin
