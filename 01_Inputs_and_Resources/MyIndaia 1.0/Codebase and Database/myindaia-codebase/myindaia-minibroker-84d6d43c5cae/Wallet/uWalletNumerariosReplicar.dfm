inherited frmWalletNumerariosReplicar: TfrmWalletNumerariosReplicar
  Caption = 'Replicar Numer'#225'rios'
  ClientHeight = 535
  ClientWidth = 871
  Font.Height = -12
  Position = poDesigned
  ...
  object pnlBotoes: TPanel
    ...
    object btnCriarNumerarios: TBitBtn
      Left = 6
      Top = 110
      Width = 75
      Height = 39
      Caption = 'Criar Numer'#225'rios'
      TabOrder = 1
      WordWrap = True
      OnClick = btnCriarNumerariosClick
    end
    ...
    object pnlGrid: TPanel
      ...
      object Panel9: TPanel
        ...
        object Label13: TLabel
          ...
          Width = 128
          Height = 14
          Caption = 'Numer'#225'rio Selecionado:'
        end
  ...
  object adsItens: TAureliusDataset
    ...
    object adsItensJoinCashRequested: TDataSetField
      FieldName = 'JoinCashRequested'
      ReadOnly = True
    end
  end
  object dtsNumerario: TDataSource
    AutoEdit = False
    DataSet = adsNumerario
    Left = 120
    Top = 472
  end
  object adsNumerario: TAureliusDataset
    FieldDefs = <
      item
        Name = 'Self'
        Attributes = [faReadonly]
    ...
    AfterOpen = adsNumerarioAfterOpen
    SubpropsDepth = 1
    SyncSubprops = True
    Left = 144
    Top = 472
    DesignClass = 'MyEntitiesV2.TCashrequested'
    object adsNumerarioSelf: TAureliusEntityField
      FieldName = 'Self'
      ReadOnly = True
    end
    object adsNumerarioId: TLargeintField
      FieldName = 'Id'
      ReadOnly = True
      Required = True
    end
    object adsNumerarioCreated: TDateTimeField
      FieldName = 'Created'
    end
    object adsNumerarioReceiveddate: TDateTimeField
      FieldName = 'Receiveddate'
    end
    object adsNumerarioSeniorkey: TStringField
      FieldName = 'Seniorkey'
      Size = 255
    end
    object adsNumerarioStatus: TStringField
      FieldName = 'Status'
      Size = 255
    end
    object adsNumerarioCashrequesttotal: TFloatField
      FieldName = 'Cashrequesttotal'
      DisplayFormat = '#,##0.00'
    end
    object adsNumerarioBranchId: TAureliusEntityField
      FieldName = 'BranchId'
    end
    object adsNumerarioCustomerId: TAureliusEntityField
      FieldName = 'CustomerId'
    end
    object adsNumerarioCustomclearanceId: TAureliusEntityField
      FieldName = 'CustomclearanceId'
    end
    object adsNumerarioProductId: TAureliusEntityField
      FieldName = 'ProductId'
    end
    object adsNumerarioServiceId: TAureliusEntityField
      FieldName = 'ServiceId'
    end
    object adsNumerarioUserId: TAureliusEntityField
      FieldName = 'UserId'
    end
    object adsNumerarioJoinItemCashRequested: TDataSetField
      FieldName = 'JoinItemCashRequested'
      ReadOnly = True
    end
    object adsNumerarioCustomclearanceIdCustomid: TStringField
