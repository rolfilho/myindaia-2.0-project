...
uses
  ...
  function GetNomeArquivo(AProcesso :String; TipoDocumento : Integer; IdTabela : Integer; ADigPath : String; Extensao : String): String;
...
var
  OrdemDoc: Integer;
  S, N, Prefixo, NomeArquivo: String;
  qryBroker :TFDQuery;
begin
  qryBroker := TFDQuery.Create(nil);
  try
    ...
    qryBroker.sql.text := ' SELECT ISNULL(MAX(DBO.FN_DOCTO_NUMERO(NM_ARQUIVO, :NM_PREFIXO )), 0) AS ORDEM ' +
