      ...
      object TabSheet6: TTabSheet
        ...
        object Panel12: TPanel
          ...
          object Label10: TLabel
            ...
            AutoSize = False
            Caption = 
              'Step 1 - Configure a database connection represented by IDBConne' +
              'ction interface. You can do it programatically or use the TMS Au' +
              'relius DBConnection wizard (File | New | Other | TMS Business). ' +
              'Below is the code used in this demo, an SQLite database located ' +
          ...
          object Memo2: TMemo
            ...
            Lines.Strings = (
              '{ Connection: IDBConnection }'
                ...
                'Connection := TSQLiteNativeConnectionAdapter.Create(ParamStr(0) ' +
                '+ '#39'.db'#39');')
            ParentFont = False
            ReadOnly = True
            TabOrder = 0
      ...
      object TabSheet1: TTabSheet
        ...
        object Panel4: TPanel
          ...
          object Label3: TLabel
            ...
            AutoSize = False
            Caption = 
              'Step 3 - Update database schema. Aurelius will check existing st' +
              'ructure and create missing objects if needed (tables, fields, et' +
              'c.). You can click the button below to update schema again, even' +
              ' though this demo already did it upon start.'
            WordWrap = True
            ExplicitHeight = 36
          end
        end
        ...
        object Panel11: TPanel
          ...
          object GroupBox3: TGroupBox
            ...
            object Label14: TLabel
              ...
              Width = 239
              Height = 13
              Caption = 'Search for people whose name or e-mail contains:'
            end
