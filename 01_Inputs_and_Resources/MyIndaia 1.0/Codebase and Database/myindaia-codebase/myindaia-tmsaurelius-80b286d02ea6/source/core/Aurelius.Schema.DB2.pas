...
begin
  RetrieveColumns(
    'SELECT TABNAME AS TABLE_NAME, TABSCHEMA AS TABLE_SCHEMA, COLNAME AS COLUMN_NAME, '+
...
procedure TDB2SchemaRetriever.GetDBIndexes;
begin
  RetrieveDBIndexes(
    'SELECT I.TABNAME AS TABLE_NAME, I.TABSCHEMA AS TABLE_SCHEMA, I.INDNAME AS INDEX_NAME, IC.COLNAME AS COLUMN_NAME '+
    'FROM SYSCAT.INDEXES I, SYSCAT.INDEXCOLUSE IC ' +
    'WHERE I.INDSCHEMA = IC.INDSCHEMA AND I.INDNAME = IC.INDNAME '+
    'AND I.OWNERTYPE=''U'' AND I.UNIQUERULE = ''D'' AND USER_DEFINED = 1 '+
...
begin
  RetrieveForeignKeys(
    ...
    'TC.TABSCHEMA AS FK_TABLE_SCHEMA, TC.REFTABSCHEMA AS PK_TABLE_SCHEMA, ' +
...
begin
  RetrievePrimaryKeys(
    'SELECT TC.TABNAME AS TABLE_NAME, TC.TABSCHEMA AS TABLE_SCHEMA, ' +
    'TC.CONSTNAME AS CONSTRAINT_NAME, KC.COLNAME AS COLUMN_NAME '+
...
begin
  RetrieveTables(
    'SELECT TABNAME AS TABLE_NAME, TABSCHEMA AS TABLE_SCHEMA '+
    'FROM SYSCAT.TABLES '+
