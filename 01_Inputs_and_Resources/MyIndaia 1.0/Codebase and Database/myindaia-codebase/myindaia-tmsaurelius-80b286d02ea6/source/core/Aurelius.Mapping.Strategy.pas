...
type
  ...
  public
    ...
    function LoadUnsavedValue(RttiType: TRttiType): TValue; virtual; abstract;
    ...
    function LoadDBIndexes(RttiType: TRttiType): TArray<TDBIndex>; virtual; abstract;
    function LoadForeignKeyName(Member: TRttiMember): string; virtual; abstract;
    procedure LoadOrderBy(A: TAssociation); virtual; abstract;
  end;
