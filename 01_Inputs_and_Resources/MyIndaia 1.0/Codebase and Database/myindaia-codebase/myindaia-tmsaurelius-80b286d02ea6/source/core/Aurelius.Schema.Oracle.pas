...
procedure TOracleSchemaRetriever.GetDBIndexes;
begin
  RetrieveDBIndexes(
    'SELECT IX.TABLE_NAME, IX.INDEX_NAME, IC.COLUMN_NAME ' +
    'FROM USER_INDEXES IX '+
    'INNER JOIN USER_IND_COLUMNS IC ON ' +
    '  (IX.TABLE_NAME = IC.TABLE_NAME AND IX.INDEX_NAME = IC.INDEX_NAME) ' +
