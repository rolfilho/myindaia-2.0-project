...
function JsonTypeToStr(const AJsonType: TJsonType): string;
...
begin
  case AJsonType of
    TJsonType.JString: Result := 'string';
    TJsonType.JInteger: Result := 'integer';
    TJsonType.JFloat: Result := 'float';
    TJsonType.JObject: Result := 'object';
    TJsonType.JArray: Result := 'array';
    TJsonType.JBoolean: Result := 'boolean';
    TJsonType.JNull: Result := 'null';
  end;
end;
