...
type
  ...
  strict private
    FDBIndex: TDBIndexMetadata;
  public
    constructor Create(ADBIndex: TDBIndexMetadata);
    function BuildSQL(Generator: ISQLGenerator): string; override;
    property DBIndex: TDBIndexMetadata read FDBIndex write FDBIndex;
  end;
...
function TCreateDBIndexCommand.BuildSQL(Generator: ISQLGenerator): string;
begin
  Result := Generator.GenerateCreateDBIndex(Self.DBIndex);
end;

constructor TCreateDBIndexCommand.Create(ADBIndex: TDBIndexMetadata);
begin
  FDBIndex := ADBIndex;
end;
...
function TDropDBIndexCommand.BuildSQL(Generator: ISQLGenerator): string;
begin
  Result := Generator.GenerateDropDBIndex(Self.DBIndex);
end;
