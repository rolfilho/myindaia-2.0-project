...
type
  ...
  strict private
    ...
    procedure GetDBIndexes(Table: TTableMetadata);
    procedure GetDBIndexColumns(DBIndex: TDBIndexMetadata);
...
procedure TSQLiteSchemaRetriever.GetDBIndexColumns(DBIndex: TDBIndexMetadata);
var
  ResultSet: IDBResultSet;
begin
  ResultSet := Open(Format('pragma index_info("%s")', [DBIndex.Name]));
  while ResultSet.Next do
    DBIndex.Columns.Add(TSchemaUtils.GetColumn(DBIndex.Table, AsString(ResultSet.GetFieldValue('name'))));
end;

procedure TSQLiteSchemaRetriever.GetDBIndexes(Table: TTableMetadata);
var
  ResultSet: IDBResultSet;
...
begin
  ...
  while ResultSet.Next do
    ...
    begin
      ...
      DBIndex.Name := AsString(ResultSet.GetFieldValue('name'));
      GetDBIndexColumns(DBIndex);
    end;
end;
