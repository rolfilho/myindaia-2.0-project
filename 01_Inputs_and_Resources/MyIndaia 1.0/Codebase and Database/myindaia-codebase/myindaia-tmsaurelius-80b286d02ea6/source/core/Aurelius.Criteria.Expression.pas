...
type
  ...
  public
    ...
    class function Neq(AProjection: TSimpleProjection; AValue: Variant): TSimpleExpression; overload;
    class function Neq(ALeft, ARight: TSimpleProjection): TCustomCriterion; overload;
    ...
    class function Like(ALeft, ARight: TSimpleProjection): TCustomCriterion; overload;
...
class function TExpression.Neq(AProjection: TSimpleProjection;
  AValue: Variant): TSimpleExpression;
begin
  Result := TSimpleExpression.Create(AProjection, AValue, TExpressionOperator.NotEqual);
end;

class function TExpression.Neq(ALeft,
  ARight: TSimpleProjection): TCustomCriterion;
begin
  Result := TProjectionExpression.Create(ALeft, ARight, TExpressionOperator.NotEqual);
end;
...
class function TExpression.Like(ALeft,
  ARight: TSimpleProjection): TCustomCriterion;
begin
  Result := TProjectionExpression.Create(ALeft, ARight, TExpressionOperator.Like);
end;
