...
type
  ...
  strict private
    ...
    FDBIndexes: TList<TDBIndexMetadata>;
  public
    constructor Create(ADatabase: TDatabaseMetadata);
    destructor Destroy; override;
    property Database: TDatabaseMetadata read FDatabase;
    ...
    property DBIndexes: TList<TDBIndexMetadata> read FDBIndexes;
  end;
...
begin
  ...
  FDBIndexes := TObjectList<TDBIndexMetadata>.Create(true);
...
destructor TDBIndexMetadata.Destroy;
begin
  FColumns.Free;
  inherited;
end;
