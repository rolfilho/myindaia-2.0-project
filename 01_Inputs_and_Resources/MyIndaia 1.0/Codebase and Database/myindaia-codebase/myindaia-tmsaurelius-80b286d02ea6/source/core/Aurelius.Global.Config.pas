...
type
  ...
  private
    ...
    FUseTransactionsInManager: Boolean;
    procedure Load;
  public
    ...
    // If enabled (default), object manager will use transactions by default when performing databae operations
    property UseTransactionsInManager: Boolean read FUseTransactionsInManager write FUseTransactionsInManager;
  end;
