...
constructor TInterbaseSQLGenerator.Create;
begin
  inherited Create;
  UnregisterFunction('lower');
  UnregisterFunction('length');
  UnregisterFunction('substring');
  UnregisterFunction('position');
  UnregisterFunction('bytelength');
end;
