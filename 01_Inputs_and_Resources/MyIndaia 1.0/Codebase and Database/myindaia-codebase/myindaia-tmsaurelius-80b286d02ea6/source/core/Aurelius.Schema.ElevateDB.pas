...
procedure TElevateDBSchemaRetriever.GetDBIndexes;
begin
  RetrieveDBIndexes(
    'SELECT I.TableName as TABLE_NAME, I.Name as INDEX_NAME, IC.ColumnName as COLUMN_NAME '+
    'FROM Information.Indexes I, Information.IndexColumns IC '+
    'WHERE I.TableName = IC.TableName AND I.Name = IC.IndexName '+
    'AND (I.Type = ''Index'') '+
    'ORDER BY I.TableName, I.Name, IC.OrdinalPos'
  );
end;
...
begin
  RetrieveForeignKeys(
    ...
    'FROM Information.Constraints C INNER JOIN Information.ConstraintColumns CC '+
    '   ON C.TableName = CC.TableName AND C.Name = CC.ConstraintName '+
    ' INNER JOIN Information.ConstraintColumns CP '+
    '   ON C.TargetTable = CP.TableName AND C.TargetTableConstraint = CP.ConstraintName '+
