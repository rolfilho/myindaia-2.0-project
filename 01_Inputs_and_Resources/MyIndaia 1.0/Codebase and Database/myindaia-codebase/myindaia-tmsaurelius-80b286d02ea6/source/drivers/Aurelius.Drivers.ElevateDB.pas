...
function TElevateDBStatementAdapter.Execute: Integer;
begin
  FEDBQuery.ExecSQL;
  Result := FEDBQuery.RowsAffected;
end;
...
begin
  ...
  for P in Params do
  begin
    if (P.ParamName = '') and (I < FEDBQuery.Params.Count) then
      Parameter := FEDBQuery.Params[I]
    else
