...
function TSQLDirectStatementAdapter.Execute: Integer;
begin
  FSDQuery.ExecSQL;
  Result := FSDQuery.RowsAffected;
end;
...
begin
  ...
  for P in Params do
  begin
    if (P.ParamName = '') and (I < FSDQuery.Params.Count) then
      Parameter := FSDQuery.Params[I]
    else
