...
type
  ...
  public
    constructor Create(AConnection: TIBDatabase; ASQLDialect: string; OwnedComponent: TComponent); override;
    destructor Destroy; override;
    procedure Connect;
...
function TIBExpressStatementAdapter.Execute: Integer;
begin
...
begin
  ...
  for P in Params do
  begin
    if (P.ParamName = '') and (I < FIBQuery.Params.Count) then
      Parameter := FIBQuery.Params[I]
    else
