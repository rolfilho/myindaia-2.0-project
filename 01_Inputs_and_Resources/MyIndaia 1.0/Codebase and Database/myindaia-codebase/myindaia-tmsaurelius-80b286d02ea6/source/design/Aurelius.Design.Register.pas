...
implementation
uses
  Windows, SysUtils, Classes, DB, DesignIntf, ToolsApi, DateUtils,
...
begin
  ...
  AboutBoxIndex := AboutBoxServices.AddPluginInfo(
    ...
    Format(
      ...
      'Object-Relational Mapping Framework for Delphi'#13#10 +
      '(c) 2012-%d tmssoftware.com bvba'#13#10 +
      'All Rights Reserved.', [YearOf(Now)]),
      BitmapHandle,
      {$IFDEF TRIAL}
      True, 'Trial version'
      {$ELSE}
