...
// PASTLWTR : 1.2
// File generated on 18/01/2012 13:21:37 from Type Library described below.
...
// *********************************************************************//
  DWebBrowserEvents2 = dispinterface
    ...
    procedure RedirectXDomainBlocked(const pDisp: IDispatch; var StartURL: OleVariant; 
                                     var RedirectURL: OleVariant; var Frame: OleVariant; 
                                     var StatusCode: OleVariant); dispid 286;
  end;
...
// *********************************************************************//
  ...
  TWebBrowserNewProcess = procedure(ASender: TObject; lCauseFlag: Integer; const pWB2: IDispatch; 
                                                      var Cancel: WordBool) of object;
  TWebBrowserThirdPartyUrlBlocked = procedure(ASender: TObject; var URL: OleVariant; 
                                                                dwCount: LongWord) of object;
  TWebBrowserRedirectXDomainBlocked = procedure(ASender: TObject; const pDisp: IDispatch; 
                                                                  var StartURL: OleVariant; 
                                                                  var RedirectURL: OleVariant; 
                                                                  var Frame: OleVariant; 
                                                                  var StatusCode: OleVariant) of object;
