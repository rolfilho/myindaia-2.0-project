...
uses
  Windows, ComObj, ActiveX, AspTlb, MyCOM_TLB, StdVcl, Classes, SysUtils, DB, ADODB, DateUtils,
   Variants, ComServ, uFuncoes, StrUtils, Dialogs, Graphics, IntegraSG, IdMessage, IdSMTP ,Excel2000;
...
type
  ...
  public
    ...
    function Get_IntegraPlanilhaFesto(NmServer, TxArquivo,
      CdUsuario: OleVariant): OleVariant; safecall;
  private
    FServidor: String;
    FArquivo: String;
    ...
    function IntegraPlanilhaCroda(AArquivo: String; AUsuario: String): Boolean;
...
function TIntegraPlan.IntegraPlanilhaCroda(AArquivo: String; AUsuario: String): Boolean;
var
  ...
  vContador, vContadorMercadoria, vLinha, NrItem, NrItemCliente, FazID : Integer;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              Parameters.ParamByName('CD_CLIENTE').Value             := '00500';
              Parameters.ParamByName('CD_RESPONSAVEL').Value         := '0088';
              Parameters.ParamByName('CD_EMPRESA').Value             := '00500';
              ExecSQL;
            end;
            FazID := 1;
          end;
          ...
          begin
            ...
            begin
              ...
              Parameters.ParamByName('CD_USUARIO').Value            := CdUsuario;
              Parameters.ParamByName('CD_IMPORTADOR').Value         := '00500';
            ...
            begin
              ...
              SQL.Add('  AND CD_EMPRESA  = ''00500''');
              ExecSQL;

              SQL.Clear;
              SQL.Add(' EXEC sp_atz_ev_flp_po ''' + NrPedido + ''', ''00500''');
              ExecSQL;
            end;
          end;
          ...
          begin
            ...
            //MERCADORIA
            vNCM         := ConsultaLookup('TMERCADORIA', 'CD_NCM_SH', 'CD_MERCADORIA = ''' + CdMercadoria + '''');
            TxMercadoria := ConsultaLookup('TMERCADORIA', 'NM_MERCADORIA', 'CD_MERCADORIA = ''' + CdMercadoria + '''');
  ...
  try
    ...
    if SameText(ExtractFileExt(TxArquivo), '.txt') then
      ...
      if  AnsiContainsText(TxArquivo, 'CRODA') then
        if IntegraPlanilhaCroda(TxArquivo, CdUsuario) then
