...
// PASTLWTR : 1.2
// File generated on 21/11/2022 16:00:54 from Type Library described below.
...
// *********************************************************************//
  IIntegraPlan = interface(IDispatch)
    ...
    property Echo[Msg: OleVariant]: OleVariant read Get_Echo;
  end;
...
// *********************************************************************//
  IIntegraPlanDisp = dispinterface
    ...
    property Echo[Msg: OleVariant]: OleVariant readonly dispid 213;
  end;
