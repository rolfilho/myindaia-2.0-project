object frm_veiculo_realizacao: Tfrm_veiculo_realizacao
  Left = 104
  Top = 57
  Width = 640
  Height = 480
  BorderIcons = [biSystemMenu]
  Caption = 'Realização por Veículo'
  ...
  object pnl_selecao: TPanel
    ...
    object msk_nr_viagem: TMaskEdit
      ...
      ParentFont = False
      TabOrder = 4
      OnEnter = msk_nr_viagemEnter
      OnExit = msk_nr_viagemExit
      OnKeyDown = msk_cd_unid_negKeyDown
    end
  end
  object dbgrdProcVeic: TDBGrid
    Left = 5
    Top = 168
    Width = 622
    Height = 264
    DataSource = datm_veiculo_realizacao.ds_processo_por_veiculo
    ...
    OnCellClick = dbgrdProcVeicCellClick
    Columns = <
      item
