...
type
  Tfrm_pesq_solic_ch = class(TForm)
    pnl_cadastro: TPanel;
...
var
  frm_pesq_solic_ch: Tfrm_pesq_solic_ch;
...
procedure Tfrm_pesq_solic_ch.msk_dt_inicioExit(Sender: TObject);
begin
  try
...
procedure Tfrm_pesq_solic_ch.msk_dt_terminoExit(Sender: TObject);
begin
  try
...
procedure Tfrm_pesq_solic_ch.msk_dt_terminoEnter(Sender: TObject);
begin
  if msk_dt_termino.Text <> '  /  /    ' then
  begin
    if dt_inicio > dt_termino then
...
procedure Tfrm_pesq_solic_ch.msk_cd_usuarioExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_clienteExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_itemExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_bancoExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_favorecidoExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.btn_co_usuarioClick(Sender: TObject);
begin
...
procedure Tfrm_pesq_solic_ch.btn_co_cliente2Click(Sender: TObject);
begin
  with datm_pesq_solic_ch do
  begin
...
procedure Tfrm_pesq_solic_ch.btn_co_item2Click(Sender: TObject);
begin
  with datm_pesq_solic_ch do
  begin
...
procedure Tfrm_pesq_solic_ch.btn_co_bancoClick(Sender: TObject);
begin
  with datm_pesq_solic_ch do
  begin
...
procedure Tfrm_pesq_solic_ch.btn_co_favorecidoClick(Sender: TObject);
begin
  with datm_pesq_solic_ch do
  begin
...
procedure Tfrm_pesq_solic_ch.btn_sairClick(Sender: TObject);
begin
  Close;
end;

{$HINTS OFF}
procedure Tfrm_pesq_solic_ch.btn_pesq_solic_chClick(Sender: TObject);
var
...
procedure Tfrm_pesq_solic_ch.FormCreate(Sender: TObject);
begin
...
procedure Tfrm_pesq_solic_ch.FormClose(Sender: TObject;
...
procedure Tfrm_pesq_solic_ch.msk_vl_solic_chExit(Sender: TObject);
begin
...
procedure Tfrm_pesq_solic_ch.FormShow(Sender: TObject);
begin
...
procedure Tfrm_pesq_solic_ch.dblckbox_cd_statusClick(Sender: TObject);
begin
  str_status := datm_pesq_solic_ch.tbl_status_solic_ch_CODIGO.AsString;
end;

procedure Tfrm_pesq_solic_ch.dbedt_nr_processoChange(Sender: TObject);
begin
...
procedure Tfrm_pesq_solic_ch.btn_cancelaClick(Sender: TObject);
var
  str_operador : String;
begin
...
procedure Tfrm_pesq_solic_ch.FormKeyPress(Sender: TObject; var Key: Char);
begin
  If Key = #27 then Close;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_clienteKeyDown(Sender: TObject;
...
procedure Tfrm_pesq_solic_ch.msk_cd_unidadeExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.msk_cd_prodExit(Sender: TObject);
begin
  Consiste;
end;

procedure Tfrm_pesq_solic_ch.btn_co_unidadeClick(Sender: TObject);
begin
  str_cd_modulo := '23';
  str_cd_rotina := '2301';
...
procedure Tfrm_pesq_solic_ch.btn_co_prodClick(Sender: TObject);
begin
  str_cd_modulo := '23';
  str_cd_rotina := '2302';
...
function Tfrm_pesq_solic_ch.Consiste : Boolean;
begin
  Consiste := True;
  {Usuário}
  if msk_cd_usuario.Text <> '' then
...
procedure Tfrm_pesq_solic_ch.pgctrl_solic_chChanging(Sender: TObject;
  var AllowChange: Boolean);
begin
