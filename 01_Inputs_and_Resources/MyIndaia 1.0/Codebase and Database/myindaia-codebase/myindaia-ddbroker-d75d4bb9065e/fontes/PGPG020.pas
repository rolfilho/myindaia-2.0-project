...
PROGRAMA: PGPG020.PAS - Data Module - Emissão de Cheques Administrativos
DATA: 09/10/2001
Manutenção: 14/09/2006
*************************************************************************************************)
unit PGPG020;
...
type
  Tdatm_imp_adm = class(TDataModule)
    ...
    qry_lib_adm_DT_MONTAGEM: TDateTimeField;
