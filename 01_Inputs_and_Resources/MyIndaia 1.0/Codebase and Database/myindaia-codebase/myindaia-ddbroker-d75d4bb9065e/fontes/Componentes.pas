...
uses
  Windows, Classes, SysUtils, Messages, ActiveX, Shdocvw, MSHTML, StrUtils;
...
procedure ListarComponentes(lpClassName, lpWindowName: PAnsiChar); overload;
...
procedure ListarComponentes(lpClassName, lpWindowName: PAnsiChar);
begin
