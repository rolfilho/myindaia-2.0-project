object frm_ncm_exp: Tfrm_ncm_exp
  Left = 99
  Top = 70
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de NCM - Documentos'
  ClientHeight = 504
  ClientWidth = 742
  Color = clBtnFace
  ...
  object pgctrl_ncm: TPageControl
    ...
    object ts_lista: TTabSheet
      ...
      object dbgrd_ncm: TDBGrid
        ...
        Height = 429
        Align = alClient
        DataSource = datm_ncm_exp.ds_ncm_
        ...
        TitleFont.Style = []
        OnDblClick = dbgrd_ncmDblClick
        OnKeyPress = dbgrd_ncmKeyPress
        Columns = <
          item
            Expanded = False
            FieldName = 'CODIGO'
