...
uses
  ...
  DBGrids, DBCGrids, PGGP001, ppComm, ppRptExp;
...
begin
  ...
  { Desabilitado e colocado no evento OnActivate, por causa
    da rotina de aviso de comunicado importante -> Erik 16/12/2003
...
begin
  ...
  st_cd_modulo:= str_cd_modulo;
  st_cd_rotina:= str_cd_modulo;
