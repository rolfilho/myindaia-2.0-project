object frm_sda_distr: Tfrm_sda_distr
  Left = 212
  Top = 107
  Width = 640
  Height = 480
  BorderIcons = [biSystemMenu]
  Caption = 'Distribui'#231#227'o de SDA'
  Color = clBtnFace
  ...
  object pnl_cadastro: TPanel
    ...
    object btn_distribuir: TSpeedButton
      Left = 13
      Top = 11
      Width = 25
      Height = 25
  ...
  object dbgrd_sda: TDBGrid
    ...
    Width = 629
    Height = 284
    DataSource = datm_sda_distr.ds_processo_sda
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object mi_menu: TMainMenu
    Left = 482
    Top = 89
    object mi_distribuir: TMenuItem
      Caption = '&Distribuir'
      OnClick = btn_distribuirClick
    end
