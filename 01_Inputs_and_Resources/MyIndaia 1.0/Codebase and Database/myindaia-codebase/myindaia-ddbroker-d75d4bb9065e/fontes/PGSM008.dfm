object datm_faixas_ensaio: Tdatm_faixas_ensaio
  Left = 55
  Top = 42
  Height = 514
  Width = 503
  object ds_ensaio_exp_faixa: TDataSource
    DataSet = qry_ensaio_exp_faixa_
    Left = 38
    Top = 12
  end
  object qry_ensaio_exp_faixa_: TQuery
    OnCalcFields = qry_ensaio_exp_faixa_CalcFields
    ...
    Left = 176
    Top = 12
    object qry_ensaio_exp_faixa_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_UNID_NEG'
      Size = 2
    end
    object qry_ensaio_exp_faixa_CD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_PRODUTO'
      Size = 2
    end
    object qry_ensaio_exp_faixa_CD_CLIENTE: TStringField
      FieldName = 'CD_CLIENTE'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_CLIENTE'
      Size = 5
    end
    object qry_ensaio_exp_faixa_CD_SERVICO: TStringField
      FieldName = 'CD_SERVICO'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_SERVICO'
      Size = 3
    end
    object qry_ensaio_exp_faixa_CD_ITEM: TStringField
      FieldName = 'CD_ITEM'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_ITEM'
      Size = 3
    end
    object qry_ensaio_exp_faixa_NR_FAIXA: TStringField
      DisplayLabel = 'Nº Faixa'
      FieldName = 'NR_FAIXA'
      Origin = 'TRECEITAS_EXP_FAIXA.NR_FAIXA'
      Size = 2
    end
    object qry_ensaio_exp_faixa_VL_INICIO_FAIXA: TFloatField
    ...
    object qry_ensaio_exp_faixa_VL_FIM_FAIXA: TFloatField
    ...
    object qry_ensaio_exp_faixa_VL_NUM_FAIXA: TFloatField
      FieldName = 'VL_NUM_FAIXA'
      Origin = 'TRECEITAS_EXP_FAIXA.VL_NUM_FAIXA'
      DisplayFormat = '#0,.0000'
      EditFormat = '#0.0000'
    end
    object qry_ensaio_exp_faixa_VL_DEN_FAIXA: TFloatField
      FieldName = 'VL_DEN_FAIXA'
      Origin = 'TRECEITAS_EXP_FAIXA.VL_DEN_FAIXA'
    end
    object qry_ensaio_exp_faixa_TP_BASE_CALC_FAIXA: TStringField
      FieldName = 'TP_BASE_CALC_FAIXA'
      Origin = 'TRECEITAS_EXP_FAIXA.TP_BASE_CALC_FAIXA'
      Size = 1
    end
    object qry_ensaio_exp_faixa_CD_MOEDA_FAIXA: TStringField
      FieldName = 'CD_MOEDA_FAIXA'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_MOEDA_FAIXA'
      Size = 3
    end
    object qry_ensaio_exp_faixa_LookCliente: TStringField
    ...
    object qry_ensaio_exp_faixa_LookUnidNeg: TStringField
    ...
    object qry_ensaio_exp_faixa_LookProduto: TStringField
    ...
    object qry_ensaio_exp_faixa_LookServico: TStringField
    ...
    object qry_ensaio_exp_faixa_LookItem: TStringField
      FieldName = 'LookItem'
    ...
    object qry_ensaio_exp_faixa_LookBaseCalcTaxa: TStringField
    ...
    object qry_ensaio_exp_faixa_LookMoedaFaixa: TStringField
    ...
    object qry_ensaio_exp_faixa_Calc_Taxa: TFloatField
      FieldName = 'Calc_Taxa'
      DisplayFormat = '#0,.0000'
      EditFormat = '#0.0000'
      Calculated = True
    end
    object qry_ensaio_exp_faixa_TP_POR_BASE_CALC: TStringField
      FieldName = 'TP_POR_BASE_CALC'
      Origin = 'TRECEITAS_EXP_FAIXA.CD_UNID_NEG'
      Size = 1
    end
    object qry_ensaio_exp_faixa_LookPorBaseCalc: TStringField
