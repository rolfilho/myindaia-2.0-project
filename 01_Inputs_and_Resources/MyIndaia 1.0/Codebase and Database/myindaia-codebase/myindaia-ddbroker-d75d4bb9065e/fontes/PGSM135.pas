...
type
  Tdatm_canc_proc = class(TDataModule)
    ...
    qry_rel_processo_1: TQuery;
    qry_rel_processo_1NR_PROCESSO: TStringField;
    qry_rel_processo_1CD_UNID_NEG: TStringField;
    qry_rel_processo_1CD_PRODUTO: TStringField;
    qry_rel_processo_1CD_CLIENTE: TStringField;
    qry_rel_processo_1CD_SERVICO: TStringField;
    qry_rel_processo_1CD_USUARIO: TStringField;
    qry_rel_processo_1IN_CANCELADO: TStringField;
    qry_rel_processo_1CD_CANCELADOR: TStringField;
    qry_rel_processo_1DT_CANCELAMENTO: TDateTimeField;
    qry_rel_processo_1IN_LIBERADO: TStringField;
    qry_rel_processo_1look_ap_cliente: TStringField;
    qry_rel_processo_1look_produto: TStringField;
    qry_rel_processo_1look_ap_usuario: TStringField;
    qry_rel_processo_1look_ap_unidade: TStringField;
    ds_rel_processo1: TDataSource;
    ...
    qry_rel_processo_1nr_processo_calc: TStringField;
    qry_fat_cc_: TQuery;
    qry_fat_cc_QT_RECEB: TIntegerField;
    qry_fat_cc_QT_SOLIC_CH: TIntegerField;
    qry_fat_cc_QT_FAT_CC: TFloatField;
    qry_pgto_lancado_: TQuery;
    ds_pgto_lancado: TDataSource;
    qry_pgto_lancado_qt_calc_processos: TIntegerField;
    qry_pgto_lancado_VL_TOTAL: TFloatField;
    ...
    qry_rel_processo_AP_PRODUTO: TStringField;
    qry_rel_processo_AP_USUARIO: TStringField;
    qry_rel_processo_AP_UNID_NEG: TStringField;
    qry_rel_processo_nr_processo_calc: TStringField;
    qry_Caixa_Money: TQuery;
    qry_Caixa_MoneyNR_LANCTO: TIntegerField;
    qry_Caixa_MoneyANO_LANCTO: TIntegerField;
    qry_Caixa_MoneyNR_CAIXA: TIntegerField;
    qry_Caixa_MoneyANO_CAIXA: TIntegerField;
    qry_Caixa_MoneyVL_LANCTO_CAIXA: TFloatField;
    qry_Caixa_MoneyNR_LANCTO_FUP: TIntegerField;
