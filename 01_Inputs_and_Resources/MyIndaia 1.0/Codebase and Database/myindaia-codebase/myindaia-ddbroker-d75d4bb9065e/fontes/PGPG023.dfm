object frm_lib_adm: Tfrm_lib_adm
  Left = 152
  Top = 144
  Width = 750
  Height = 550
  ...
  Caption = 'Libera'#231#227'o de TED'#180's Administrativos'
  Color = clBtnFace
  ...
  object dbgrdAdm: TDBGrid
    ...
    Width = 726
    Height = 154
    DataSource = datm_lib_adm.ds_lib_adm
  ...
  object dbgrdItensPendentes: TDBGrid
    ...
    Width = 726
    Height = 152
    DataSource = datm_lib_adm.ds_lib_adm_item
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
