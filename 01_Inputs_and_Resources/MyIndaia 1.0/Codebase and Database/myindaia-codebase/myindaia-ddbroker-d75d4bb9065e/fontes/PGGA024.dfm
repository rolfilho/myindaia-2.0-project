object datm_sel_unid_prod_via: Tdatm_sel_unid_prod_via
  OldCreateOrder = True
  Left = 295
  Top = 387
  Height = 568
  ...
  object ppRelatorio: TppReport
    ...
    PrinterSetup.DocumentName = 'ppsRelDemEst'
    ...
    Template.FileName = 'C:\DDBROKER\RelListaViagens.rtm'
    ...
    object ppDetailBand7: TppDetailBand
      ...
      object ppDBText17: TppDBText
        ...
        DataPipeline = BDE_detalhe_Deadline
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 6
        ...
        ParentDataPipeline = False
        Transparent = True
        DataPipelineName = 'BDE_detalhe_Deadline'
        mmHeight = 2498
        mmLeft = 191294
        mmTop = 0
        mmWidth = 18330
  ...
  object BDE_detalhe: TppBDEPipeline
    ...
    object BDE_detalheppField5: TppField
      FieldAlias = 'NR_VIAGEM_MASK'
      FieldName = 'NR_VIAGEM_MASK'
      FieldLength = 5
      DisplayWidth = 5
      Position = 4
    end
    ...
    object BDE_detalheppMasterFieldLink1: TppMasterFieldLink
  ...
  object qry_detalhe: TQuery
    AfterOpen = qry_detalheAfterOpen
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT'
      
        '  V.CD_UNID_NEG, V.CD_PRODUTO, V.CD_EMBARCACAO, V.NR_VIAGEM, SUB' +
        'STRING(V.NR_VIAGEM, 1,2) + '#39'/'#39' + SUBSTRING(V.NR_VIAGEM, 3,2) NR_' +
        'VIAGEM_MASK,'
      
        '  P.NR_PROCESSO, EN.AP_EMPRESA, A.CD_AGENTE, A.NM_AGENTE, P.TP_E' +
        'STUFAGEM, SUBSTRING(P.NR_PROCESSO, 5, 12) PROCESSO,'
      '  V.DT_ENT, V.DT_ESPERADA, V.NR_VIAGEM_ARMADOR'
      
        'FROM TVIAGEM V, TPROCESSO P, TAGENTE A, TUNID_NEG U, TEMPRESA_NA' +
        'C EN, TVIAGEM_DEADLINE VD, TFOLLOWUP FU'
      'WHERE'
      '  V.CD_UNID_NEG   = P.CD_UNID_NEG AND'
      '  V.CD_PRODUTO    = P.CD_PRODUTO AND'
      '  V.CD_EMBARCACAO = P.CD_EMBARCACAO AND'
      '  V.NR_VIAGEM     = P.NR_VIAGEM AND'
      '  P.CD_AGENTE     = A.CD_AGENTE AND'
      '  P.CD_CLIENTE    = EN.CD_EMPRESA AND'
      '  U.CD_UNID_NEG   = P.CD_UNID_NEG AND'
      '  V.CD_PRODUTO    = '#39'02'#39'             AND'
      '  P.IN_CANCELADO  = '#39'0'#39'         AND'
      ''
      '  VD.CD_UNID_NEG   = V.CD_UNID_NEG AND'
      '  VD.CD_PRODUTO    = P.CD_PRODUTO AND'
      '  VD.CD_EMBARCACAO = P.CD_EMBARCACAO AND'
      '  VD.NR_VIAGEM     = P.NR_VIAGEM'
      ''
      
        '  AND FU.NR_PROCESSO   = P.NR_PROCESSO AND FU.CD_EVENTO     = '#39'2' +
        '89'#39' AND ISNULL(DT_REALIZACAO,'#39#39')  = '#39#39
      ''
      ''
      'GROUP BY'
      
        '  V.CD_UNID_NEG, V.CD_PRODUTO, V.CD_EMBARCACAO, V.NR_VIAGEM, P.N' +
        'R_PROCESSO, EN.AP_EMPRESA, A.CD_AGENTE,'
      
        '  A.NM_AGENTE, P.TP_ESTUFAGEM, V.DT_ENT, V.DT_ESPERADA, V.NR_VIA' +
        'GEM_ARMADOR'
      
        'ORDER BY V.CD_UNID_NEG, V.CD_PRODUTO, V.CD_EMBARCACAO, V.NR_VIAG' +
        'EM, P.NR_PROCESSO, EN.AP_EMPRESA, A.NM_AGENTE')
    Left = 93
    Top = 176
  end
  object dts_detalhe_Deadline: TDataSource
    DataSet = qry_detalhe_Deadline
    Left = 216
    Top = 234
  end
  object qry_detalhe_Deadline: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_detalhe
    SQL.Strings = (
      'SELECT'
      
        '  VD.CD_UNID_NEG, VD.CD_PRODUTO, VD.CD_EMBARCACAO, VD.NR_VIAGEM,' +
        ' P.TP_ESTUFAGEM,'
      '  P.NR_PROCESSO, P.CD_CLIENTE,'
      
        '  P.CD_AGENTE, E.NM_EMBARCACAO, A.NM_AGENTE, U.NM_UNID_NEG, EN.A' +
        'P_EMPRESA,'
      ''
      '  VD.DT_DEADLINE_BL,'
      '  ISNULL(VD.HR_DEADLINE_BL,'#39#39') HR_DEADLINE_BL,'
      '  VD.DT_DEADLINE_CARGA,'
      '  ISNULL(VD.HR_DEADLINE_CARGA,'#39#39') HR_DEADLINE_CARGA,'
      '  VD.DT_DEADLINE_IMO,'
      '  ISNULL(VD.HR_DEADLINE_IMO,'#39#39') HR_DEADLINE_IMO,'
      '  VD.DT_DEADLINE_CARTA_TEMP,'
      '  ISNULL(VD.HR_DEADLINE_CARTA_TEMP,'#39#39') HR_DEADLINE_CARTA_TEMP,'
      '  LE.DESCRICAO LOCAL_EMBARQUE, AZ.NM_ARMAZEM, RC.CD_REFERENCIA,'
      
        '  (select DT_REALIZACAO from TFOLLOWUP where NR_PROCESSO = P.NR_' +
        'PROCESSO and CD_EVENTO = '#39'161'#39') DT_PREVISAO_CHEGADA,'
      
        '  (select DT_REALIZACAO from TFOLLOWUP where NR_PROCESSO = P.NR_' +
        'PROCESSO and CD_EVENTO = '#39'551'#39') DT_SAIDA_EMBARQUE'
      'FROM'
      
        '  TVIAGEM_DEADLINE VD, TPROCESSO P, TEMBARCACAO E, TAGENTE A, TU' +
        'NID_NEG U, TEMPRESA_NAC EN, TFOLLOWUP FU,'
      '  TLOCAL_EMBARQUE LE, TARMAZEM AZ, TREF_CLIENTE RC'
      'WHERE'
      
        '  VD.CD_UNID_NEG   =:CD_UNID_NEG     AND VD.CD_PRODUTO =:CD_PROD' +
        'UTO AND'
      
        '  VD.CD_EMBARCACAO =:CD_EMBARCACAO   AND VD.NR_VIAGEM  =:NR_VIAG' +
        'EM  AND'
      
        '  VD.TP_ESTUFAGEM  =:TP_ESTUFAGEM    AND VD.CD_AGENTE  =:CD_AGEN' +
        'TE  AND'
      ''
      
        '  VD.CD_UNID_NEG   = P.CD_UNID_NEG and  VD.CD_PRODUTO    = P.CD_' +
        'PRODUTO  AND'
      
        '  VD.CD_EMBARCACAO = P.CD_EMBARCACAO and  VD.NR_VIAGEM     = P.N' +
        'R_VIAGEM AND'
      
        '  VD.TP_ESTUFAGEM  = P.TP_ESTUFAGEM AND  VD.CD_AGENTE     = P.CD' +
        '_AGENTE  AND'
      ''
      
        '  E.CD_EMBARCACAO = VD.CD_EMBARCACAO and  P.CD_AGENTE     = A.CD' +
        '_AGENTE  AND'
      
        '  P.CD_CLIENTE    = EN.CD_EMPRESA AND  U.CD_UNID_NEG   = P.CD_UN' +
        'ID_NEG   AND'
      ''
      
        '  FU.NR_PROCESSO   = P.NR_PROCESSO  AND  FU.CD_EVENTO     = '#39'092' +
        #39' AND'
      
        '  ISNULL(FU.DT_REALIZACAO,'#39#39')  = '#39#39' AND  LE.CODIGO        = P.CD' +
        '_LOCAL_EMBARQUE AND'
      
        '  AZ.CD_ARMAZEM =* P.CD_ARMAZEM_ATRACACAO AND RC.NR_PROCESSO   =' +
        ' P.NR_PROCESSO  AND'
      '  RC.TP_REFERENCIA = '#39'05'#39
      '')
    Left = 90
    Top = 235
    ParamData = <
  ...
  object BDE_detalhe_Deadline: TppBDEPipeline
    DataSource = dts_detalhe_Deadline
    SkipWhenNoRecords = False
    UserName = 'BDE_detalhe1'
    Left = 351
    Top = 238
    MasterDataPipelineName = 'BDE_detalhe'
    object BDE_detalhe_DeadlineppField1: TppField
      FieldAlias = 'CD_UNID_NEG'
      FieldName = 'CD_UNID_NEG'
      FieldLength = 2
      DisplayWidth = 2
    ...
    object BDE_detalhe_DeadlineppField2: TppField
      FieldAlias = 'CD_PRODUTO'
      FieldName = 'CD_PRODUTO'
      FieldLength = 2
      DisplayWidth = 2
    ...
    object BDE_detalhe_DeadlineppField3: TppField
      FieldAlias = 'CD_EMBARCACAO'
      FieldName = 'CD_EMBARCACAO'
      FieldLength = 4
      DisplayWidth = 4
    ...
    object BDE_detalhe_DeadlineppField4: TppField
      FieldAlias = 'NR_VIAGEM'
      FieldName = 'NR_VIAGEM'
      FieldLength = 4
      DisplayWidth = 4
    ...
    object BDE_detalhe_DeadlineppField5: TppField
      FieldAlias = 'TP_ESTUFAGEM'
      FieldName = 'TP_ESTUFAGEM'
      FieldLength = 1
      DisplayWidth = 1
    ...
    object BDE_detalhe_DeadlineppField6: TppField
      FieldAlias = 'NR_PROCESSO'
      FieldName = 'NR_PROCESSO'
      FieldLength = 18
      DisplayWidth = 18
    ...
    object BDE_detalhe_DeadlineppField7: TppField
    ...
    object BDE_detalhe_DeadlineppField8: TppField
      FieldAlias = 'CD_AGENTE'
      FieldName = 'CD_AGENTE'
      FieldLength = 4
      DisplayWidth = 4
    ...
    object BDE_detalhe_DeadlineppField9: TppField
    ...
    object BDE_detalhe_DeadlineppField10: TppField
      FieldAlias = 'NM_AGENTE'
      FieldName = 'NM_AGENTE'
      FieldLength = 60
      DisplayWidth = 60
    ...
    object BDE_detalhe_DeadlineppField11: TppField
    ...
    object BDE_detalhe_DeadlineppField12: TppField
      FieldAlias = 'AP_EMPRESA'
      FieldName = 'AP_EMPRESA'
      FieldLength = 10
      DisplayWidth = 10
    ...
    object BDE_detalhe_DeadlineppField13: TppField
      FieldAlias = 'DT_DEADLINE_BL'
    ...
    object BDE_detalhe_DeadlineppField14: TppField
      FieldAlias = 'HR_DEADLINE_BL'
      FieldName = 'HR_DEADLINE_BL'
      FieldLength = 10
      DisplayWidth = 10
      Position = 13
    end
    object BDE_detalhe_DeadlineppField15: TppField
      FieldAlias = 'DT_DEADLINE_CARGA'
    ...
    object BDE_detalhe_DeadlineppField16: TppField
      FieldAlias = 'HR_DEADLINE_CARGA'
      FieldName = 'HR_DEADLINE_CARGA'
      FieldLength = 10
      DisplayWidth = 10
      Position = 15
    end
    object BDE_detalhe_DeadlineppField17: TppField
      FieldAlias = 'DT_DEADLINE_IMO'
    ...
    object BDE_detalhe_DeadlineppField18: TppField
      FieldAlias = 'HR_DEADLINE_IMO'
      FieldName = 'HR_DEADLINE_IMO'
      FieldLength = 10
      DisplayWidth = 10
      Position = 17
    end
    object BDE_detalhe_DeadlineppField19: TppField
      FieldAlias = 'DT_DEADLINE_CARTA_TEMP'
    ...
    object BDE_detalhe_DeadlineppField20: TppField
      FieldAlias = 'HR_DEADLINE_CARTA_TEMP'
      FieldName = 'HR_DEADLINE_CARTA_TEMP'
      FieldLength = 10
      DisplayWidth = 10
      Position = 19
    end
    object BDE_detalhe_DeadlineppField21: TppField
    ...
    object BDE_detalhe_DeadlineppField22: TppField
      FieldAlias = 'NM_ARMAZEM'
      FieldName = 'NM_ARMAZEM'
      FieldLength = 50
      DisplayWidth = 50
      Position = 21
    end
    object BDE_detalhe_DeadlineppField23: TppField
    ...
    object BDE_detalhe_DeadlineppField24: TppField
      FieldAlias = 'DT_PREVISAO_CHEGADA'
    ...
    object BDE_detalhe_DeadlineppField25: TppField
      FieldAlias = 'DT_SAIDA_EMBARQUE'
      FieldName = 'DT_SAIDA_EMBARQUE'
      FieldLength = 0
      DataType = dtDateTime
      DisplayWidth = 18
      Position = 24
    end
    object BDE_detalhe_DeadlineppMasterFieldLink1: TppMasterFieldLink
      MasterFieldName = 'CD_UNID_NEG'
      DetailFieldName = 'CD_UNID_NEG'
      DetailSortOrder = soAscending
    end
    object BDE_detalhe_DeadlineppMasterFieldLink2: TppMasterFieldLink
      MasterFieldName = 'CD_PRODUTO'
      DetailFieldName = 'CD_PRODUTO'
      DetailSortOrder = soAscending
    end
    object BDE_detalhe_DeadlineppMasterFieldLink3: TppMasterFieldLink
      MasterFieldName = 'CD_EMBARCACAO'
      DetailFieldName = 'CD_EMBARCACAO'
      DetailSortOrder = soAscending
    end
  end
  object BDE_viagens_imp: TppBDEPipeline
    DataSource = ds_viagens_imp
    SkipWhenNoRecords = False
    UserName = 'BDE_viagens_imp'
    Left = 306
    Top = 332
  ...
  object ds_viagens_imp: TDataSource
    DataSet = qry_viagens_imp
    Left = 175
    Top = 331
  end
  object qry_viagens_imp: TQuery
    AfterOpen = qry_detalheAfterOpen
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT DISTINCT E.NM_EMBARCACAO,'
      '       P.NR_VIAGEM,'
      '       DEN.DT_REALIZACAO AS DT_PREVISTA,'
      '       DE.DT_REALIZACAO  AS DT_CHEGADA,'
      '       AR.NM_ARMAZEM,'
      '       LD.DESCRICAO AS NM_LOCAL_DESEMBARQUE'
      'FROM          TPROCESSO          P   (NOLOCK)'
      
        '   INNER JOIN VW_DT_ESPERA_NAVIO DEN (NOLOCK) ON DEN.NR_PROCESSO' +
        ' = P.NR_PROCESSO'
      
        '   INNER JOIN TSERVICO           S   (NOLOCK) ON S.CD_SERVICO   ' +
        ' = P.CD_SERVICO'
      
        '   INNER JOIN TLOCAL_EMBARQUE    LD  (NOLOCK) ON LD.CODIGO      ' +
        ' = P.CD_LOCAL_DESEMBARQUE'
      
        '   INNER JOIN TVIAGEM            V   (NOLOCK) ON V.CD_UNID_NEG  ' +
        ' = P.CD_UNID_NEG'
        ...
        '   LEFT  JOIN VW_DT_ENT          DE  (NOLOCK) ON DE.NR_PROCESSO ' +
        ' = P.NR_PROCESSO'
      
        '   LEFT  JOIN TARMAZEM           AR  (NOLOCK) ON AR.CD_ARMAZEM  ' +
        ' = P.CD_ARMAZEM_ATRACACAO'
      
        '   INNER JOIN TEMBARCACAO        E   (NOLOCK) ON E.CD_EMBARCACAO' +
        ' = V.CD_EMBARCACAO'
      'WHERE :CD_UNID_NEG        IN (P.CD_UNID_NEG, '#39'XX'#39')'
      '  AND :CD_CELULA          IN (P.CD_CELULA, '#39'XX'#39')'
      '  AND P.IN_CANCELADO      = '#39'0'#39
      '  AND P.IN_LIBERADO       = '#39'1'#39
      '  AND P.IN_PRODUCAO       = '#39'1'#39
      '  AND :CD_VIA_TRANSPORTE IN (S.CD_VIA_TRANSPORTE, '#39'XX'#39')'
      
        '  AND ISNULL(DEN.DT_REALIZACAO, 0) BETWEEN :DT_INICIAL AND :DT_F' +
        'INAL'
      'ORDER BY DT_PREVISTA DESC, P.NR_VIAGEM')
    Left = 53
    Top = 328
    ParamData = <
      item
    ...
    object qry_viagens_impNM_EMBARCACAO: TStringField
      FieldName = 'NM_EMBARCACAO'
      FixedChar = True
      Size = 40
    end
    object qry_viagens_impNR_VIAGEM: TStringField
      FieldName = 'NR_VIAGEM'
      FixedChar = True
      Size = 15
    end
    object qry_viagens_impDT_PREVISTA: TDateTimeField
      FieldName = 'DT_PREVISTA'
    end
    object qry_viagens_impDT_CHEGADA: TDateTimeField
      FieldName = 'DT_CHEGADA'
    end
    object qry_viagens_impNM_ARMAZEM: TStringField
      FieldName = 'NM_ARMAZEM'
      FixedChar = True
      Size = 50
    end
    object qry_viagens_impNM_LOCAL_DESEMBARQUE: TStringField
      FieldName = 'NM_LOCAL_DESEMBARQUE'
      FixedChar = True
      Size = 50
    end
  end
  object ds_viagens_detalhe_imp: TDataSource
    DataSet = qry_viagens_detalhe_imp
    Left = 176
    Top = 386
  end
  object qry_viagens_detalhe_imp: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT SUBSTRING(P.NR_PROCESSO, 5, 14) AS NR_PROCESSO_SIMPLES,'
      '       P.NR_PROCESSO,'
      '       P.CD_PRODUTO,'
      '       U.NM_UNID_NEG,'
      '       U.CD_UNID_NEG,'
      ...
      'FROM          TPROCESSO          P   (NOLOCK)'
        ...
        '   INNER JOIN TEMPRESA_NAC       EN  (NOLOCK) ON EN.CD_EMPRESA  ' +
        ' = P.CD_CLIENTE'
        ...
        '   INNER JOIN  TEMBARCACAO        E   (NOLOCK) ON E.CD_EMBARCACA' +
        'O = V.CD_EMBARCACAO'
      'WHERE :CD_UNID_NEG        IN (P.CD_UNID_NEG, '#39'XX'#39')'
      '  AND :CD_CELULA          IN (P.CD_CELULA, '#39'XX'#39')'
      '  AND P.IN_CANCELADO      = '#39'0'#39
      ...
      '  AND :CD_VIA_TRANSPORTE IN (S.CD_VIA_TRANSPORTE, '#39'XX'#39')'
        ...
        '  AND ISNULL(DEN.DT_REALIZACAO, 0) BETWEEN :DT_INICIAL AND :DT_F' +
        'INAL'
      'ORDER BY E.NM_EMBARCACAO, DT_PREVISTA DESC, P.NR_VIAGEM')
    Left = 50
    Top = 387
    ParamData = <
      item
    ...
    object qry_viagens_detalhe_impNR_PROCESSO_SIMPLES: TStringField
      FieldName = 'NR_PROCESSO_SIMPLES'
      FixedChar = True
      Size = 14
    end
    object qry_viagens_detalhe_impNR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      FixedChar = True
      Size = 18
    end
    object qry_viagens_detalhe_impCD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      FixedChar = True
      Size = 2
    end
    object qry_viagens_detalhe_impNM_UNID_NEG: TStringField
      FieldName = 'NM_UNID_NEG'
      FixedChar = True
      Size = 50
    end
    object qry_viagens_detalhe_impCD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      FixedChar = True
      Size = 2
    end
    object qry_viagens_detalhe_impCD_EMBARCACAO: TStringField
      FieldName = 'CD_EMBARCACAO'
      FixedChar = True
      Size = 4
    end
    object qry_viagens_detalhe_impNM_EMBARCACAO: TStringField
      FieldName = 'NM_EMBARCACAO'
      FixedChar = True
      Size = 40
    end
    object qry_viagens_detalhe_impNR_VIAGEM: TStringField
      FieldName = 'NR_VIAGEM'
      FixedChar = True
      Size = 15
    end
    object qry_viagens_detalhe_impNR_VIAGEM_ARMADOR: TStringField
      FieldName = 'NR_VIAGEM_ARMADOR'
      FixedChar = True
      Size = 15
    end
    object qry_viagens_detalhe_impDT_PREVISTA: TDateTimeField
      FieldName = 'DT_PREVISTA'
    end
    object qry_viagens_detalhe_impDT_CHEGADA: TDateTimeField
      FieldName = 'DT_CHEGADA'
    end
    object qry_viagens_detalhe_impNR_MANIFESTO: TStringField
      FieldName = 'NR_MANIFESTO'
      FixedChar = True
      Size = 15
    end
    object qry_viagens_detalhe_impAP_EMPRESA: TStringField
      FieldName = 'AP_EMPRESA'
      FixedChar = True
      Size = 10
    end
    object qry_viagens_detalhe_impNM_ARMAZEM: TStringField
      FieldName = 'NM_ARMAZEM'
      FixedChar = True
      Size = 50
    end
    object qry_viagens_detalhe_impNM_LOCAL_DESEMBARQUE: TStringField
      FieldName = 'NM_LOCAL_DESEMBARQUE'
      FixedChar = True
      Size = 50
    end
  end
  object BDE_viagens_detalhe_imp: TppBDEPipeline
    DataSource = ds_viagens_detalhe_imp
    SkipWhenNoRecords = False
    UserName = 'BDE_viagens_detalhe_imp'
    Left = 311
    Top = 386
    MasterDataPipelineName = 'BDE_viagens_imp'
  end
  object rptViagens_Imp: TppReport
    AutoStop = False
    DataPipeline = BDE_viagens_detalhe_imp
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'ppsRelDemEst'
    PrinterSetup.Orientation = poLandscape
    ...
    PrinterSetup.mmPaperWidth = 297000
    PrinterSetup.PaperSize = 9
    Template.FileName = 'C:\DDBROKER\RelListaViagens_imp.rtm'
    Units = utPrinterPixels
    DeviceType = 'Screen'
    OutlineSettings.CreateNode = True
    OutlineSettings.CreatePageNodes = True
    ...
    Version = '7.02'
    mmColumnWidth = 0
    DataPipelineName = 'BDE_viagens_detalhe_imp'
    ...
    object ppdbProcesso: TppDetailBand
      PrintHeight = phDynamic
      mmBottomOffset = 0
      mmHeight = 2381
      mmPrintPosition = 0
      object ppdbtxtAP_EMPRESA: TppDBText
        UserName = 'dbtxtAP_EMPRESA'
        DataField = 'AP_EMPRESA'
        DataPipeline = BDE_viagens_detalhe_imp
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object ppdbtxtNM_ARMAZEM: TppDBText
        UserName = 'dbtxtNM_ARMAZEM'
        DataField = 'NM_ARMAZEM'
        DataPipeline = BDE_viagens_detalhe_imp
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object ppdbtxtNR_PROCESSO: TppDBText
        UserName = 'DBText4'
      ...
      object ppdbtxtNM_LOCAL_EMBARQUE: TppDBText
        UserName = 'DBText10'
    ...
    object ppGroup5: TppGroup
      ...
      object ppGroupHeaderBand5: TppGroupHeaderBand
        ...
        object ppdbtxtCD_UNID_NEG: TppDBText
          UserName = 'DBText1'
          DataField = 'CD_UNID_NEG'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
        ...
        object ppdbtxtNM_UNID_NEG: TppDBText
          UserName = 'DBText8'
          DataField = 'NM_UNID_NEG'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupHeaderBand1: TppGroupHeaderBand
        ...
        mmHeight = 5821
        mmPrintPosition = 0
        object ppdbtxtCD_EMBARCACAO: TppDBText
          UserName = 'DBText3'
          DataField = 'CD_EMBARCACAO'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
        ...
        object ppdbtxtNM_EMBARCACAO: TppDBText
          UserName = 'DBText5'
          DataField = 'NM_EMBARCACAO'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        mmHeight = 7938
        mmPrintPosition = 0
        object ppshpEmbarcacao: TppShape
          UserName = 'shpEmbarcacao'
          Brush.Color = 13882323
          Pen.Color = 13882323
          mmHeight = 3440
          mmLeft = 19315
        ...
        object ppdbtxtNR_VIAGEM: TppDBText
          UserName = 'DBText2'
          DataField = 'NR_VIAGEM'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
        ...
        object pplDataPrevista: TppLabel
          UserName = 'Label15'
          Caption = 'Dt.Esperada'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object ppdbtxtDT_PREVISTA: TppDBText
          UserName = 'DBText14'
        ...
        object pplDataChegada: TppLabel
          UserName = 'Label13'
          Caption = 'Dt. Chegada'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object ppdbtxtDT_CHEGADA: TppDBText
          UserName = 'DBText22'
        ...
        object pplViagemArmador: TppLabel
          UserName = 'Label14'
          Caption = 'Viagem Armador'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object ppdbtxtNR_VIAGEM_ARMADOR: TppDBText
          UserName = 'DBText20'
          DataField = 'NR_VIAGEM_ARMADOR'
          DataPipeline = BDE_viagens_detalhe_imp
          Font.Charset = DEFAULT_CHARSET
        ...
        object ppdbtxtNR_MANIFESTO: TppDBText
          UserName = 'dbtxtNR_MANIFESTO'
        ...
        object pplArmazemAtracacao: TppLabel
          UserName = 'Label6'
        ...
        object pplPortoDesembarque: TppLabel
          UserName = 'Label3'
          Caption = 'Porto Desembarque'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Name = 'Arial'
          Font.Size = 6
    ...
    object ppGroup7: TppGroup
      ...
      mmNewPageThreshold = 0
      DataPipelineName = 'BDE_viagens_detalhe_imp'
      object ppghbProcesso: TppGroupHeaderBand
        mmBottomOffset = 0
        mmHeight = 0
        mmPrintPosition = 0
      end
      object ppgfbProcesso: TppGroupFooterBand
        mmBottomOffset = 0
        mmHeight = 0
        mmPrintPosition = 0
      end
