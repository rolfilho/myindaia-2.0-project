object frm_evento_inspec: Tfrm_evento_inspec
  Left = 135
  Top = 53
  Width = 640
  Height = 480
  BorderIcons = [biSystemMenu]
  Caption = 'Inspeção por Evento'
  ...
  object dbg_processos: TDBGrid
    ...
    Width = 629
    Height = 256
    DataSource = datm_evento_inspec.ds_tfollowup
  ...
  object pnl_selecao: TPanel
    ...
    object msk_dt_inspecao: TMaskEdit
      Left = 218
      Top = 52
      Width = 65
      Height = 21
      ...
      TabOrder = 3
      Text = '  /  /    '
      OnEnter = msk_dt_inspecaoEnter
      OnExit = msk_dt_inspecaoExit
    ...
    object dbedt_cd_cliente: TDBEdit
      ...
      DataSource = datm_evento_inspec.ds_processo
      ReadOnly = True
      TabOrder = 9
    end
    ...
    object ckbx_conforme: TCheckBox
      Left = 423
      Top = 52
      Width = 81
      Height = 17
