object frm_feriado: Tfrm_feriado
  Left = 91
  Top = 50
  Width = 750
  Height = 550
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgctrl_feriado: TPageControl
    Left = 0
    Top = 47
    Width = 742
    Height = 457
    ...
    Align = alClient
    TabOrder = 0
    OnChange = pgctrl_feriadoChange
    OnChanging = pgctrl_feriadoChanging
    object ts_lista: TTabSheet
      ...
      object dbg_cadastro: TDBGrid
        ...
        Align = alClient
        Color = clWhite
        DataSource = datm_feriado.ds_feriado
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object dbedt_nm_feriado: TDBEdit
          Left = 15
          Top = 77
          Width = 474
          Height = 21
          DataField = 'NM_FERIADO'
          DataSource = datm_feriado.ds_feriado
          MaxLength = 50
          TabOrder = 1
          OnChange = dbedt_nm_feriadoChange
        end
        object dbedt_dt_feriado: TDBEdit
          Left = 16
          Top = 30
          Width = 113
          Height = 21
          ...
          MaxLength = 2
          TabOrder = 0
          OnChange = dbedt_dt_feriadoChange
        end
      end
    end
  end
