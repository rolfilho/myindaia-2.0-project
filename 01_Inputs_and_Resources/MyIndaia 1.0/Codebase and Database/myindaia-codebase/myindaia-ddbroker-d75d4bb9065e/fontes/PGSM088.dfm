object frm_emb: Tfrm_emb
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgctrl_emb: TPageControl
    Left = 0
    Top = 47
    Width = 742
    Height = 457
    ...
    Align = alClient
    TabOrder = 0
    OnChange = pgctrl_embChange
    OnChanging = pgctrl_embChanging
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object TPanel
        ...
        object btn_co_bandeira: TSpeedButton
          Left = 425
          Top = 95
          Width = 25
          Height = 21
        ...
        object dbedt_nm_emb: TDBEdit
          ...
          DataSource = datm_emb.ds_emb
          TabOrder = 0
          OnChange = dbedt_nm_embChange
        end
        object dblckp_ativo: TDBLookupComboBox
          Left = 425
          Top = 55
          Width = 52
          Height = 21
          ...
          DataSource = datm_emb.ds_emb
          TabOrder = 1
          OnClick = dbedt_nm_embChange
        end
        object dblckp_roro: TDBLookupComboBox
          Left = 23
          Top = 137
          Width = 52
          Height = 21
        ...
        object dbedt_cd_embarcacao: TDBEdit
          ...
          Width = 40
          Height = 21
          DataField = 'CD_BANDEIRA'
          DataSource = datm_emb.ds_emb
          TabOrder = 2
          OnChange = dbedt_nm_embChange
          OnExit = dbedt_cd_embarcacaoExit
          OnKeyDown = dbedt_cd_embarcacaoKeyDown
        end
