object frm_acesso_externo: Tfrm_acesso_externo
  Left = 480
  Top = 89
  Width = 646
  Height = 491
  ...
  object pgctrl_acesso_externo: TPageControl
    Left = 1
    Top = 48
    Width = 629
    Height = 385
    ActivePage = ts_lista
    TabOrder = 2
    OnChange = pgctrl_acesso_externoChange
    OnChanging = pgctrl_acesso_externoChanging
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object lbl_emails: TLabel
          Left = 395
          Top = 14
          Width = 87
          Height = 13
          Caption = 'Grupo e-mails *'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object lbl_txt_obrigatorios: TLabel
          Left = 7
          Top = 328
          Width = 114
          Height = 13
        ...
        object dbedt_emails: TDBMemo
          Left = 395
          Top = 31
          Width = 200
          Height = 306
          DataField = 'NM_GRUPO_EMAIL'
          DataSource = datm_acesso_externo.ds_acesso_externo
          TabOrder = 9
          OnChange = dbedt_siteChange
        end
