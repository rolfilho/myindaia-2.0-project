object datm_lembrete_po: Tdatm_lembrete_po
  OldCreateOrder = True
  Left = 644
  Top = 327
  Height = 323
  Width = 344
  object ppBDEAviso: TppDBPipeline
    DataSource = ds_aviso
    UserName = 'BDEAviso'
    Left = 40
    Top = 78
    object ppBDEAvisoppField1: TppField
    ...
    object ppBDEAvisoppField2: TppField
      FieldAlias = 'CD_EVENTO'
      FieldName = 'CD_EVENTO'
      FieldLength = 3
      DisplayWidth = 3
      Position = 1
    end
    object ppBDEAvisoppField3: TppField
      FieldAlias = 'NM_EVENTO'
      FieldName = 'NM_EVENTO'
      FieldLength = 50
      DisplayWidth = 50
      Position = 2
    end
    object ppBDEAvisoppField4: TppField
      FieldAlias = 'DT_LIMITE'
      FieldName = 'DT_LIMITE'
      FieldLength = 0
      DataType = dtDateTime
      DisplayWidth = 10
    ...
    object ppBDEAvisoppField5: TppField
  ...
  object ds_aviso: TDataSource
    DataSet = qry_aviso_
    Left = 40
    Top = 128
  end
  object qry_aviso_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      
        'SELECT F.NR_PROCESSO, F.CD_EVENTO, E.NM_EVENTO, F.DT_LIMITE, EN.' +
        'NM_EMPRESA'
      'FROM   TFLP_PO F, TPO P, TUSUARIO U, TEVENTO E, TEMPRESA_NAC EN'
      'WHERE  F.NR_PROCESSO = P.NR_PROCESSO AND'
      '       P.CD_USUARIO = U.CD_USUARIO AND'
      '       F.CD_EVENTO = E.CD_EVENTO AND'
      '       P.CD_IMPORTADOR = EN.CD_EMPRESA AND'
      '       U.IN_AVISO_PO = '#39'1'#39' AND'
      '       P.CD_USUARIO = :CD_USUARIO AND'
      '       F.CD_STATUS IN ( '#39'0'#39', '#39'1'#39' ) AND'
      '       ISNULL( F.DT_REALIZACAO, '#39#39' ) = '#39#39)
    Left = 40
    Top = 24
    ParamData = <
      item
    ...
    object qry_aviso_NR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Size = 18
    end
    object qry_aviso_CD_EVENTO: TStringField
      FieldName = 'CD_EVENTO'
      Size = 3
    end
    object qry_aviso_NM_EVENTO: TStringField
      FieldName = 'NM_EVENTO'
      Size = 50
    end
    object qry_aviso_DT_LIMITE: TDateTimeField
      FieldName = 'DT_LIMITE'
    end
    object qry_aviso_NM_EMPRESA: TStringField
      FieldName = 'NM_EMPRESA'
      Size = 50
    end
  end
  ...
  object ppRepLembrete_po: TppReport
    AutoStop = False
    DataPipeline = ppBDEAviso
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'RepLembrete_po'
    ...
    Template.FileName = 'C:\DDBROKER\RBPO001.rtm'
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        mmHeight = 8202
        mmPrintPosition = 0
        object ppSubMerc: TppSubReport
          UserName = 'SubMerc'
          ExpandAll = False
          NewPrintJob = False
          OutlineSettings.CreateNode = True
          TraverseAllData = False
          DataPipelineName = 'ppBDEpo_merc'
          mmHeight = 4233
          mmLeft = 0
          mmTop = 3969
          mmWidth = 197300
  ...
  object tmr_lembrete_po: TTimer
    Enabled = False
    Interval = 5000
    OnTimer = tmr_lembrete_poTimer
    Left = 240
    Top = 24
  end
  object ppBDEpo_merc: TppDBPipeline
    DataSource = ds_po_merc
    UserName = 'BDEpo_merc'
    Left = 140
    Top = 78
  end
  object ds_po_merc: TDataSource
    DataSet = qry_po_merc_
    Left = 140
    Top = 128
  end
  object qry_po_merc_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_aviso
    SQL.Strings = (
      
        'SELECT P.NR_PROCESSO, I.CD_MERCADORIA, M.AP_MERCADORIA, I.QT_INI' +
        'CIAL'
      'FROM   TPO P, TPO_ITEM I, TMERCADORIA M'
    ...
    object qry_po_merc_NR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'TPO.NR_PROCESSO'
      Size = 18
    end
    object qry_po_merc_CD_MERCADORIA: TStringField
      FieldName = 'CD_MERCADORIA'
      Origin = 'TPO_ITEM.CD_MERCADORIA'
      Size = 30
    end
    object qry_po_merc_AP_MERCADORIA: TStringField
      FieldName = 'AP_MERCADORIA'
      Origin = 'TMERCADORIA.AP_MERCADORIA'
      Size = 25
    end
    object qry_po_merc_QT_INICIAL: TFloatField
