object frm_autoriza_pagto1: Tfrm_autoriza_pagto1
  Left = 184
  Top = 111
  Width = 640
  Height = 480
  ...
  Caption = 'Autorização de Movimentos Administrativos'
  ...
  object pnl_cadastro: TPanel
    ...
    object dbnvg: TDBNavigator
      ...
      Width = 104
      Height = 25
      DataSource = datm_autoriza_pagto.ds_solic_pagto
  ...
  object pgctrl_monta_pagto: TPageControl
    ...
    Width = 631
    Height = 378
    ActivePage = ts_destino
    HotTrack = True
    TabOrder = 1
    OnChange = pgctrl_monta_pagtoChange
    object ts_destino: TTabSheet
      ...
      object edt_nm_favorecido: TEdit
        ...
        ReadOnly = True
        TabOrder = 3
        Text = 'edt_nm_favorecido'
      end
      object dbgrdMontaDest: TDBGrid
        Left = 0
        Top = 42
        Width = 624
        Height = 199
        DataSource = datm_autoriza_pagto.ds_grd_dest
      ...
      object pnl_por_destino: TPanel
        ...
        object dbedt_vl_pagto2: TDBEdit
          Left = 286
          Top = 16
          Width = 101
          Height = 21
          DataField = 'VL_PAGTO'
          DataSource = datm_autoriza_pagto.ds_solic_dest
          TabOrder = 1
    ...
    object ts_ref: TTabSheet
      ...
      object dbgrdRef: TDBGrid
        ...
        Width = 624
        Height = 94
        DataSource = datm_autoriza_pagto.ds_ref
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object dbgrdRefItens: TDBGrid
        ...
        Width = 624
        Height = 207
        DataSource = datm_autoriza_pagto.ds_ref_itens
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
