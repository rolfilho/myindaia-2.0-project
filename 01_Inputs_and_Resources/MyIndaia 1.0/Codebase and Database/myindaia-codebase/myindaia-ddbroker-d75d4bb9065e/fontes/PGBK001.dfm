object frm_LI_capa: Tfrm_LI_capa
  ...
  object pgctrl_capa_li: TPageControl
    ...
    object tbsht_basicas_TL01: TTabSheet
      ...
      object dbedt_cd_moeda_fob: TDBEdit
        Left = 95
        Top = 319
        Width = 37
        Height = 21
      ...
      object dbedt_nm_moeda_fob: TDBEdit
        Left = 139
        Top = 319
        Width = 229
        Height = 21
    ...
    object tbsht_Negociacao_TL02: TTabSheet
      ...
      object gbox_reg_trib: TGroupBox
        ...
        object btn_co_agencia_secex: TSpeedButton
          Left = 301
          Top = 81
          Width = 25
          Height = 21
          Glyph.Data = {
            ...
            5555555555555555555555555555555555555555555555555555}
          NumGlyphs = 2
          OnClick = btn_co_agencia_secexClick
        end
        ...
        object dbedt_cd_agencia_secex: TDBEdit
          Left = 84
          Top = 81
          Width = 42
          Height = 21
          ...
          MaxLength = 4
          TabOrder = 2
          OnExit = dbedt_cd_agencia_secexExit
          OnKeyDown = dbedt_cd_importadorKeyDown
        end
        ...
        object dbedt_nm_reg_trib: TDBEdit
          ...
          TabStop = False
          Color = clMenu
          DataField = 'LookRegTrib'
          DataSource = datm_LI_Capa.ds_li
          ReadOnly = True
          TabOrder = 5
        end
        object dbedt_nm_agencia_secex: TDBEdit
          Left = 130
          Top = 81
          Width = 168
          Height = 21
      ...
      object gbox_acordo_tar: TGroupBox
        ...
        object dbedt_nm_acordo_aladi: TDBEdit
          Left = 289
          Top = 18
          Width = 221
          Height = 21
      ...
      object gbox_cobertura_cambial: TGroupBox
        ...
        object dbedt_nm_modalidade_pag: TDBEdit
          Left = 157
          Top = 51
          Width = 321
          Height = 21
          TabStop = False
          Color = clMenu
          DataField = 'LookModPagto'
          DataSource = datm_LI_Capa.ds_li
          ReadOnly = True
          TabOrder = 5
        end
        object dbedt_nm_mot_sem_cobert: TDBEdit
          Left = 157
          Top = 110
          Width = 321
          Height = 21
          TabStop = False
          Color = clMenu
          DataField = 'LookMotivo'
          DataSource = datm_LI_Capa.ds_li
          ReadOnly = True
          TabOrder = 6
        end
        object dbedt_nm_instituicao_financ: TDBEdit
          Left = 270
          Top = 80
          Width = 208
          Height = 21
    ...
    object tbsht_totais_TL03: TTabSheet
      ...
      object Label17: TLabel
        ...
        Width = 107
        Height = 26
        Caption = 'Quantidade na Medida Estatística'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object grpbox_1: TGroupBox
        ...
        object dbedt_vl_moeda_desconto: TDBEdit
          Left = 256
          Top = 73
          Width = 121
          Height = 21
      ...
      object dbedt_vl_numero_comunicado: TDBEdit
        Left = 256
        Top = 208
        Width = 111
        Height = 21
      ...
      object dbrdgrp_cond_merc: TDBRadioGroup
        Left = 10
        Top = 171
        Width = 233
        Height = 62
        Caption = 'Condição Mercadoria'
