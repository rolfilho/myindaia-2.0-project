object frm_hist_padrao: Tfrm_hist_padrao
  Left = 87
  Top = 70
  Width = 750
  Height = 550
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgctrl_hist_padrao: TPageControl
    Left = 0
    Top = 47
    Width = 742
    Height = 457
    ...
    Align = alClient
    TabOrder = 0
    OnChange = pgctrl_hist_padraoChange
    OnChanging = pgctrl_hist_padraoChanging
    object ts_lista: TTabSheet
      ...
      object dbg_cadastro: TDBGrid
        ...
        Align = alClient
        Color = clWhite
        DataSource = datm_hist_padrao.ds_hist_lista
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        ShowHint = True
        TabOrder = 0
        object lbl_nm_historico: TLabel
          Left = 11
          Top = 56
          Width = 58
          Height = 13
        ...
        object lbl_cd_historico: TLabel
          Left = 11
          Top = 15
          Width = 40
          Height = 13
        ...
        object dbedt_nm_historico: TDBEdit
          ...
          DataSource = datm_hist_padrao.ds_hist_padrao
          MaxLength = 30
          TabOrder = 1
          OnChange = dbedt_nm_historicoChange
        end
