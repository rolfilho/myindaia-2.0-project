object datm_nf_serv: Tdatm_nf_serv
  OldCreateOrder = True
  Left = 257
  Top = 146
  Height = 589
  ...
  object qry_ult_nf_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT ISNULL( NR_ULT_NF_SERV, '#39'000000'#39' ) AS NR_ULT_NF_SERV'
    ...
    object qry_ult_nf_NR_ULT_NF_SERV: TStringField
  ...
  object qry_grd_sol_: TQuery
    ...
    SQL.Strings = (
        ...
        'F.IN_PREVIEW'
      'FROM   TS_FATURA F (NOLOCK), TYES_NO Y (NOLOCK)'
      'WHERE'
      
        '  (SELECT COUNT(FP.CD_ITEM) FROM TS_FATURA_PROCESSO_ITEM FP (NOL' +
        'OCK) '
      
        '  WHERE F.CD_UNID_NEG = FP.CD_UNID_NEG AND F.CD_PRODUTO = FP.CD_' +
        'PRODUTO AND F.NR_SOLICITACAO = FP.NR_SOLICITACAO'
      
        '  AND FP.CD_ITEM IN (SELECT CD_ITEM FROM TITEM (NOLOCK) WHERE IN' +
        '_TRIBUTAVEL = '#39'1'#39') ) > 0 AND'
      ...
      '       ( F.DT_FATURA = :DT_FATURA OR :DT_FATURA IS NULL ) AND'
        ...
        'ACAO = '#39#39' ) ) AND'
      '       ( ( F.NR_NF_SERV = :NR_NF ) OR ( :NR_NF = '#39#39' ) ) AND'
    ...
    object qry_grd_sol_IN_PREVIEW: TStringField
  ...
  object qry_grd_adm_: TQuery
    ...
    SQL.Strings = (
        ...
        'VL_NOTA, A.CD_UNID_NEG, A.DT_PAGTO, A.IN_IMP_NF_SERV'
      ...
      '       A.CD_STATUS_ADM = '#39'18'#39
        ...
        'GROUP BY A.CD_UNID_NEG, A.DT_PAGTO, A.IN_IMP_NF_SERV, Y.TX_YESNO' +
        ', A.NR_DOCTO, A.NR_NF_SERV, A.CD_FAVORECIDO, F.NM_FAVORECIDO')
    Left = 151
    Top = 112
    ParamData = <
      item
    ...
    object qry_grd_adm_IN_IMP_NF_SERV: TStringField
      FieldName = 'IN_IMP_NF_SERV'
      Size = 1
    end
  end
  ...
  object qry_obs_adm_: TQuery
    ...
    SQL.Strings = (
      ...
      '       IN_IMP_NF_SERV = :IN_IMP_NF_SERV AND'
      '       CD_FAVORECIDO = :CD_FAVORECIDO AND'
      '       NR_NF_SERV = :NR_NF_SERV'
      '')
    Left = 271
    Top = 324
    ParamData = <
    ...
    object qry_obs_adm_TX_OBS: TMemoField
      FieldName = 'TX_OBS'
      Origin = 'TADM.TX_OBS'
      BlobType = ftMemo
    end
  end
  object sp_nf_serv_adm: TStoredProc
    DatabaseName = 'DBBROKER'
    StoredProcName = 'dbo.sp_nf_serv_adm'
    Left = 151
    Top = 219
    ParamData = <
      item
  ...
  object qry_ajuste_impressao_: TQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM   TAJUSTE_IMPRESSAO_NF_SERV_INDAIA (NOLOCK)'
      'WHERE  CD_UNID_NEG = :CD_UNID_NEG')
    Left = 271
    Top = 59
    ParamData = <
    ...
    object qry_ajuste_impressao_L_DESTAQUE: TStringField
      FieldName = 'L_DESTAQUE'
      Origin = 'TAJUSTE_IMPRESSAO_NF_SERV_INDAIA.CD_UNID_NEG'
      Size = 3
    end
    object qry_ajuste_impressao_C_DESTAQUE: TStringField
      FieldName = 'C_DESTAQUE'
      Origin = 'TAJUSTE_IMPRESSAO_NF_SERV_INDAIA.L_EMISSAO'
      Size = 3
    end
    object qry_ajuste_impressao_L_RETENCAO: TStringField
      FieldName = 'L_RETENCAO'
      Origin = 'TAJUSTE_IMPRESSAO_NF_SERV_INDAIA.C_EMISSAO'
      Size = 3
    end
    object qry_ajuste_impressao_C_RETENCAO: TStringField
      FieldName = 'C_RETENCAO'
      Origin = 'TAJUSTE_IMPRESSAO_NF_SERV_INDAIA.C_VENCIMENTO'
      Size = 3
    end
  ...
  object rp_nf: TRAWPrinter
    LinhasPorPagina = 67
    Impressora = Epson
    Left = 398
    Top = 6
  end
  object qry_nf_serv_op_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT N.*,'
      
        '       E.NM_EMPRESA, E.END_EMPRESA, E.END_NUMERO, E.END_CIDADE, ' +
        'E.END_BAIRRO,'
      '       E.END_UF, E.END_CEP, E.CGC_EMPRESA, E.IE_EMPRESA,'
      
        '       CASE H.IN_EXP_NF WHEN '#39'1'#39' THEN ES.NM_EMPRESA ELSE A.NM_AR' +
        'EA END AS NM_AREA,'
      '       C.NM_CONTATO AS NM_ANALISTA,'
      '       T.NM_VIA_TRANSP,'
      '       SUBSTRING( ORIGEM.DESCRICAO, 1, 19 ) AS NM_LOCAL_ORIGEM,'
      
        '       SUBSTRING( DESTINO.DESCRICAO, 1, 16 ) AS NM_LOCAL_DESTINO' +
        ','
      '       EMB.DESCRICAO AS NM_EMBALAGEM'
      
        'FROM   TNF_SERV_OP N (NOLOCK), TEMPRESA_NAC E (NOLOCK), TAREA A ' +
        '(NOLOCK), TCLIENTE_CONTATO C (NOLOCK), TVIA_TRANSP_BROKER T (NOL' +
        'OCK),'
      
        '       TLOCAL_EMBARQUE ORIGEM (NOLOCK), TLOCAL_EMBARQUE DESTINO ' +
        '(NOLOCK), TTP_EMBALAGEM EMB (NOLOCK), TCLIENTE_HABILITACAO H (NO' +
        'LOCK),'
      '       TEMPRESA_EST ES (NOLOCK)'
      'WHERE  N.CD_UNID_NEG      =  :CD_UNID_NEG    AND'
      '       N.CD_PRODUTO       =  :CD_PRODUTO     AND'
      '       N.NR_SOLICITACAO   =  :NR_SOLICITACAO AND'
      '       N.CD_CLIENTE       =  E.CD_EMPRESA    AND'
      '       N.CD_AREA          *= A.CD_AREA       AND'
      '       N.CD_UNID_NEG      *= C.CD_UNID_NEG   AND'
      '       N.CD_PRODUTO       *= C.CD_PRODUTO    AND'
      '       N.CD_CLIENTE       *= C.CD_CLIENTE    AND'
      '       N.CD_ANALISTA      *= C.CD_CONTATO    AND'
      '       N.CD_VIA_TRANSP    *= T.CD_VIA_TRANSP AND'
      '       N.CD_LOCAL_ORIGEM  *= ORIGEM.CODIGO   AND'
      '       N.CD_LOCAL_DESTINO *= DESTINO.CODIGO  AND'
      '       N.CD_EMBALAGEM     *= EMB.CODIGO      AND'
      '       N.CD_UNID_NEG      *= H.CD_UNID_NEG   AND'
      '       N.CD_PRODUTO       *= H.CD_PRODUTO    AND'
      '       N.CD_CLIENTE       *= H.CD_CLIENTE    AND'
      '       N.CD_EMP_EST       *= ES.CD_EMPRESA'
      '')
    Left = 271
    Top = 219
    ParamData = <
    ...
    object qry_nf_serv_op_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TNF_SERV_OP.CD_UNID_NEG'
      Size = 2
    end
    object qry_nf_serv_op_CD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      Origin = 'TNF_SERV_OP.CD_PRODUTO'
      Size = 2
    end
    object qry_nf_serv_op_NR_SOLICITACAO: TStringField
      FieldName = 'NR_SOLICITACAO'
      Origin = 'TNF_SERV_OP.NR_SOLICITACAO'
      Size = 6
    end
    object qry_nf_serv_op_NR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'TNF_SERV_OP.NR_PROCESSO'
      Size = 18
    end
    object qry_nf_serv_op_DT_EMISSAO: TDateTimeField
      FieldName = 'DT_EMISSAO'
      Origin = 'TNF_SERV_OP.DT_EMISSAO'
    end
    object qry_nf_serv_op_DT_VENCIMENTO: TDateTimeField
      FieldName = 'DT_VENCIMENTO'
      Origin = 'TNF_SERV_OP.DT_VENCIMENTO'
    end
    object qry_nf_serv_op_NR_RELATORIO: TStringField
      FieldName = 'NR_RELATORIO'
      Origin = 'TNF_SERV_OP.NR_RELATORIO'
      Size = 3
    end
    object qry_nf_serv_op_NR_ANO: TStringField
      FieldName = 'NR_ANO'
      Origin = 'TNF_SERV_OP.NR_ANO'
      Size = 4
    end
    object qry_nf_serv_op_CD_CLIENTE: TStringField
      FieldName = 'CD_CLIENTE'
      Origin = 'TNF_SERV_OP.CD_CLIENTE'
      Size = 5
    end
    object qry_nf_serv_op_CD_AREA: TStringField
      FieldName = 'CD_AREA'
      Origin = 'TNF_SERV_OP.CD_AREA'
      Size = 2
    end
    object qry_nf_serv_op_CD_ANALISTA: TStringField
      FieldName = 'CD_ANALISTA'
      Origin = 'TNF_SERV_OP.CD_ANALISTA'
      Size = 3
    end
    object qry_nf_serv_op_NM_REFERENCIA: TStringField
      FieldName = 'NM_REFERENCIA'
      Origin = 'TNF_SERV_OP.NM_REFERENCIA'
      Size = 200
    end
    object qry_nf_serv_op_NM_NAT_DESPACHO: TStringField
      FieldName = 'NM_NAT_DESPACHO'
      Origin = 'TNF_SERV_OP.NM_NAT_DESPACHO'
      Size = 15
    end
    object qry_nf_serv_op_CD_VIA_TRANSP: TStringField
      FieldName = 'CD_VIA_TRANSP'
      Origin = 'TNF_SERV_OP.CD_VIA_TRANSP'
      Size = 2
    end
    object qry_nf_serv_op_NM_VEICULO: TStringField
      FieldName = 'NM_VEICULO'
      Origin = 'TNF_SERV_OP.NM_VEICULO'
      Size = 40
    end
    object qry_nf_serv_op_CD_LOCAL_ORIGEM: TStringField
      FieldName = 'CD_LOCAL_ORIGEM'
      Origin = 'TNF_SERV_OP.CD_LOCAL_ORIGEM'
      Size = 4
    end
    object qry_nf_serv_op_CD_LOCAL_DESTINO: TStringField
      FieldName = 'CD_LOCAL_DESTINO'
      Origin = 'TNF_SERV_OP.CD_LOCAL_DESTINO'
      Size = 4
    end
    object qry_nf_serv_op_QT_EMBALAGEM: TIntegerField
      FieldName = 'QT_EMBALAGEM'
      Origin = 'TNF_SERV_OP.QT_EMBALAGEM'
    end
    object qry_nf_serv_op_CD_EMBALAGEM: TStringField
      FieldName = 'CD_EMBALAGEM'
      Origin = 'TNF_SERV_OP.CD_EMBALAGEM'
      Size = 2
    end
    object qry_nf_serv_op_VL_PESO_BRUTO: TFloatField
      FieldName = 'VL_PESO_BRUTO'
      Origin = 'TNF_SERV_OP.VL_PESO_BRUTO'
    end
    object qry_nf_serv_op_VL_PESO_LIQUIDO: TFloatField
      FieldName = 'VL_PESO_LIQUIDO'
      Origin = 'TNF_SERV_OP.VL_PESO_LIQUIDO'
    end
    object qry_nf_serv_op_VL_FOB: TFloatField
      FieldName = 'VL_FOB'
      Origin = 'TNF_SERV_OP.VL_FOB'
    end
    object qry_nf_serv_op_VL_CIF: TFloatField
      FieldName = 'VL_CIF'
      Origin = 'TNF_SERV_OP.VL_CIF'
    end
    object qry_nf_serv_op_NR_DI: TStringField
      FieldName = 'NR_DI'
      Origin = 'TNF_SERV_OP.NR_DI'
      Size = 15
    end
    object qry_nf_serv_op_VL_TOT_NUM: TFloatField
      FieldName = 'VL_TOT_NUM'
      Origin = 'TNF_SERV_OP.VL_TOT_NUM'
    end
    object qry_nf_serv_op_VL_TOT_NAO_TRIBUTAVEL: TFloatField
      FieldName = 'VL_TOT_NAO_TRIBUTAVEL'
      Origin = 'TNF_SERV_OP.VL_TOT_NAO_TRIBUTAVEL'
    end
    object qry_nf_serv_op_VL_SUB_TOT_TRIBUTAVEL: TFloatField
      FieldName = 'VL_SUB_TOT_TRIBUTAVEL'
      Origin = 'TNF_SERV_OP.VL_SUB_TOT_TRIBUTAVEL'
    end
    object qry_nf_serv_op_VL_COMISSAO: TFloatField
      FieldName = 'VL_COMISSAO'
      Origin = 'TNF_SERV_OP.VL_COMISSAO'
    end
    object qry_nf_serv_op_VL_TOT_GERAL: TFloatField
      FieldName = 'VL_TOT_GERAL'
      Origin = 'TNF_SERV_OP.VL_TOT_GERAL'
    end
    object qry_nf_serv_op_VL_TOT_TRIBUTAVEL: TFloatField
      FieldName = 'VL_TOT_TRIBUTAVEL'
      Origin = 'TNF_SERV_OP.VL_TOT_TRIBUTAVEL'
    end
    object qry_nf_serv_op_NM_IR: TStringField
      FieldName = 'NM_IR'
      Origin = 'TNF_SERV_OP.NM_IR'
      Size = 25
    end
    object qry_nf_serv_op_VL_IR: TFloatField
      FieldName = 'VL_IR'
      Origin = 'TNF_SERV_OP.VL_IR'
    end
    object qry_nf_serv_op_VL_ISS: TFloatField
      FieldName = 'VL_ISS'
      Origin = 'TNF_SERV_OP.VL_ISS'
    end
    object qry_nf_serv_op_NM_SALDO: TStringField
      FieldName = 'NM_SALDO'
      Origin = 'TNF_SERV_OP.NM_SALDO'
      Size = 10
    end
    object qry_nf_serv_op_VL_SALDO: TFloatField
      FieldName = 'VL_SALDO'
      Origin = 'TNF_SERV_OP.VL_SALDO'
    end
    object qry_nf_serv_op_CD_EMISSOR: TStringField
      FieldName = 'CD_EMISSOR'
      Origin = 'TNF_SERV_OP.CD_EMISSOR'
      Size = 4
    end
    object qry_nf_serv_op_IN_QUADRO_TOTAL: TStringField
      FieldName = 'IN_QUADRO_TOTAL'
      Origin = 'TNF_SERV_OP.IN_QUADRO_TOTAL'
      Size = 1
    end
    object qry_nf_serv_op_NM_AREA: TStringField
      FieldName = 'NM_AREA'
      Size = 60
    end
    object qry_nf_serv_op_NM_EMPRESA: TStringField
      FieldName = 'NM_EMPRESA'
      Origin = 'TNF_SERV_OP.CD_UNID_NEG'
      Size = 50
    end
    object qry_nf_serv_op_END_EMPRESA: TStringField
      FieldName = 'END_EMPRESA'
      Origin = 'TNF_SERV_OP.CD_PRODUTO'
      Size = 50
    end
    object qry_nf_serv_op_END_NUMERO: TStringField
      FieldName = 'END_NUMERO'
      Origin = 'TNF_SERV_OP.NR_SOLICITACAO'
      Size = 6
    end
    object qry_nf_serv_op_END_CIDADE: TStringField
      FieldName = 'END_CIDADE'
      Origin = 'TNF_SERV_OP.NR_PROCESSO'
      Size = 30
    end
    object qry_nf_serv_op_END_BAIRRO: TStringField
      FieldName = 'END_BAIRRO'
      Origin = 'TNF_SERV_OP.DT_EMISSAO'
      Size = 30
    end
    object qry_nf_serv_op_END_UF: TStringField
      FieldName = 'END_UF'
      Origin = 'TNF_SERV_OP.DT_VENCIMENTO'
      Size = 2
    end
    object qry_nf_serv_op_END_CEP: TStringField
      FieldName = 'END_CEP'
      Origin = 'TNF_SERV_OP.NR_RELATORIO'
      Size = 8
    end
    object qry_nf_serv_op_CGC_EMPRESA: TStringField
      FieldName = 'CGC_EMPRESA'
      Origin = 'TNF_SERV_OP.NR_ANO'
      Size = 14
    end
    object qry_nf_serv_op_IE_EMPRESA: TStringField
      FieldName = 'IE_EMPRESA'
      Origin = 'TNF_SERV_OP.CD_CLIENTE'
    end
    object qry_nf_serv_op_NM_VIA_TRANSP: TStringField
      FieldName = 'NM_VIA_TRANSP'
    end
    object qry_nf_serv_op_NM_EMBALAGEM: TStringField
      FieldName = 'NM_EMBALAGEM'
      Size = 120
    end
    object qry_nf_serv_op_NM_ANALISTA: TStringField
      FieldName = 'NM_ANALISTA'
      Size = 50
    end
    object qry_nf_serv_op_NM_LOCAL_ORIGEM: TStringField
      FieldName = 'NM_LOCAL_ORIGEM'
      Size = 19
    end
    object qry_nf_serv_op_NM_LOCAL_DESTINO: TStringField
      FieldName = 'NM_LOCAL_DESTINO'
      Size = 16
    end
    object qry_nf_serv_op_TX_HISTORICO: TMemoField
      FieldName = 'TX_HISTORICO'
      BlobType = ftMemo
    end
    object qry_nf_serv_op_NM_ESPECIE: TStringField
      FieldName = 'NM_ESPECIE'
      Size = 100
    end
    object qry_nf_serv_op_TX_OBS: TMemoField
      FieldName = 'TX_OBS'
      BlobType = ftMemo
    end
    object qry_nf_serv_op_CD_EMP_EST: TStringField
      FieldName = 'CD_EMP_EST'
      Size = 5
    end
    object qry_nf_serv_op_VL_RETENCAO: TFloatField
      FieldName = 'VL_RETENCAO'
    end
    object qry_nf_serv_op_NM_RETENCAO: TStringField
      FieldName = 'NM_RETENCAO'
      Size = 30
    end
  end
  object qry_nf_serv_op_item_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_nf_serv_op
    SQL.Strings = (
      
        'SELECT CD_UNID_NEG, CD_PRODUTO, NR_SOLICITACAO, CD_ITEM, NM_ITEM' +
        ','
      
        'VL_ITEM, IN_COLUNA, ISNULL( NR_ORDEM_FAT, 0) as NR_ORDEM_FAT, CD' +
        '_ITEM_NAO_FAT '
      'FROM   TNF_SERV_OP_ITEM (NOLOCK)'
      'WHERE  CD_UNID_NEG    = :CD_UNID_NEG AND'
      '       CD_PRODUTO     = :CD_PRODUTO AND'
      '       NR_SOLICITACAO = :NR_SOLICITACAO'
      'ORDER BY NR_ORDEM_FAT')
    Left = 398
    Top = 429
    ParamData = <
      item
    ...
    object qry_nf_serv_op_item_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TNF_SERV_OP_ITEM.CD_UNID_NEG'
      Size = 2
    end
    object qry_nf_serv_op_item_CD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      Origin = 'TNF_SERV_OP_ITEM.CD_PRODUTO'
      Size = 2
    end
    object qry_nf_serv_op_item_NR_SOLICITACAO: TStringField
      FieldName = 'NR_SOLICITACAO'
      Origin = 'TNF_SERV_OP_ITEM.NR_SOLICITACAO'
      Size = 6
    end
    object qry_nf_serv_op_item_CD_ITEM: TStringField
      FieldName = 'CD_ITEM'
      Origin = 'TNF_SERV_OP_ITEM.CD_ITEM'
      Size = 3
    end
    object qry_nf_serv_op_item_NM_ITEM: TStringField
      FieldName = 'NM_ITEM'
      Origin = 'TNF_SERV_OP_ITEM.NM_ITEM'
      Size = 50
    end
    object qry_nf_serv_op_item_VL_ITEM: TFloatField
      FieldName = 'VL_ITEM'
      Origin = 'TNF_SERV_OP_ITEM.VL_ITEM'
    end
    object qry_nf_serv_op_item_IN_COLUNA: TStringField
      FieldName = 'IN_COLUNA'
      Origin = 'TNF_SERV_OP_ITEM.IN_COLUNA'
      Size = 1
    end
    object qry_nf_serv_op_item_NR_ORDEM_FAT: TIntegerField
      FieldName = 'NR_ORDEM_FAT'
      Origin = 'TNF_SERV_OP_ITEM.NR_ORDEM_FAT'
    end
  end
  object ds_nf_serv_op: TDataSource
    DataSet = qry_nf_serv_op_
    Left = 43
    Top = 375
  end
  object qry_nf_serv_op_num_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_nf_serv_op
    SQL.Strings = (
      'SELECT *'
      'FROM   TNF_SERV_OP_NUM (NOLOCK)'
      'WHERE  CD_UNID_NEG    = :CD_UNID_NEG AND'
      '       CD_PRODUTO     = :CD_PRODUTO AND'
      '       NR_SOLICITACAO = :NR_SOLICITACAO')
    Left = 398
    ...
    object qry_nf_serv_op_num_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TNF_SERV_OP_NUM.CD_UNID_NEG'
      Size = 2
    end
    object qry_nf_serv_op_num_CD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      Origin = 'TNF_SERV_OP_NUM.CD_PRODUTO'
      Size = 2
    end
    object qry_nf_serv_op_num_NR_SOLICITACAO: TStringField
      FieldName = 'NR_SOLICITACAO'
      Origin = 'TNF_SERV_OP_NUM.NR_SOLICITACAO'
      Size = 6
    end
    object qry_nf_serv_op_num_DT_NUM: TDateTimeField
      FieldName = 'DT_NUM'
      Origin = 'TNF_SERV_OP_NUM.DT_NUM'
    end
    object qry_nf_serv_op_num_VL_NUM: TFloatField
      FieldName = 'VL_NUM'
      Origin = 'TNF_SERV_OP_NUM.VL_NUM'
    end
    object qry_nf_serv_op_num_NR_FP: TStringField
      FieldName = 'NR_FP'
      Origin = 'TNF_SERV_OP_NUM.NR_FP'
      Size = 10
    end
  end
  object qry_nf_serv_adm_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT N.*,'
      
        '       F.NM_FAVORECIDO, F.END_FAVORECIDO, F.END_NUMERO, F.END_CI' +
        'DADE, F.END_BAIRRO,'
      '       F.END_UF, F.END_CEP, F.CGC_EMPRESA, F.IE_EMPRESA'
      'FROM   TNF_SERV_ADM N (NOLOCK), TFAVORECIDO F (NOLOCK)'
      'WHERE  N.CD_UNID_NEG   =  :CD_UNID_NEG    AND'
      '       N.NR_DOCTO      =  :NR_DOCTO       AND'
      '       N.CD_FAVORECIDO *= F.CD_FAVORECIDO')
    Left = 151
    Top = 272
    ParamData = <
      item
    ...
    object qry_nf_serv_adm_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TNF_SERV_ADM.CD_UNID_NEG'
      Size = 2
    end
    object qry_nf_serv_adm_NR_DOCTO: TStringField
      FieldName = 'NR_DOCTO'
      Origin = 'TNF_SERV_ADM.NR_DOCTO'
      Size = 6
    end
    object qry_nf_serv_adm_DT_EMISSAO: TDateTimeField
      FieldName = 'DT_EMISSAO'
      Origin = 'TNF_SERV_ADM.DT_EMISSAO'
    end
    object qry_nf_serv_adm_DT_VENCIMENTO: TDateTimeField
      FieldName = 'DT_VENCIMENTO'
      Origin = 'TNF_SERV_ADM.DT_VENCIMENTO'
    end
    object qry_nf_serv_adm_NR_RELATORIO: TStringField
      FieldName = 'NR_RELATORIO'
      Origin = 'TNF_SERV_ADM.NR_RELATORIO'
      Size = 3
    end
    object qry_nf_serv_adm_NR_ANO: TStringField
      FieldName = 'NR_ANO'
      Origin = 'TNF_SERV_ADM.NR_ANO'
      Size = 4
    end
    object qry_nf_serv_adm_CD_FAVORECIDO: TStringField
      FieldName = 'CD_FAVORECIDO'
      Origin = 'TNF_SERV_ADM.CD_FAVORECIDO'
      Size = 5
    end
    object qry_nf_serv_adm_TX_OBS: TMemoField
      FieldName = 'TX_OBS'
      Origin = 'TNF_SERV_ADM.TX_OBS'
      BlobType = ftMemo
    end
    object qry_nf_serv_adm_VL_TOT_NAO_TRIBUTAVEL: TFloatField
      FieldName = 'VL_TOT_NAO_TRIBUTAVEL'
      Origin = 'TNF_SERV_ADM.VL_TOT_NAO_TRIBUTAVEL'
    end
    object qry_nf_serv_adm_VL_TOT_GERAL: TFloatField
      FieldName = 'VL_TOT_GERAL'
      Origin = 'TNF_SERV_ADM.VL_TOT_GERAL'
    end
    object qry_nf_serv_adm_VL_TOT_TRIBUTAVEL: TFloatField
      FieldName = 'VL_TOT_TRIBUTAVEL'
      Origin = 'TNF_SERV_ADM.VL_TOT_TRIBUTAVEL'
    end
    object qry_nf_serv_adm_VL_ISS: TFloatField
      FieldName = 'VL_ISS'
      Origin = 'TNF_SERV_ADM.VL_ISS'
    end
    object qry_nf_serv_adm_VL_IR: TFloatField
      FieldName = 'VL_IR'
      Origin = 'TNF_SERV_ADM.VL_IR'
    end
    object qry_nf_serv_adm_CD_EMISSOR: TStringField
      FieldName = 'CD_EMISSOR'
      Origin = 'TNF_SERV_ADM.CD_EMISSOR'
      Size = 4
    end
    object qry_nf_serv_adm_NM_FAVORECIDO: TStringField
      FieldName = 'NM_FAVORECIDO'
      Size = 50
    end
    object qry_nf_serv_adm_END_FAVORECIDO: TStringField
      FieldName = 'END_FAVORECIDO'
      Size = 50
    end
    object qry_nf_serv_adm_END_NUMERO: TStringField
      FieldName = 'END_NUMERO'
      Size = 6
    end
    object qry_nf_serv_adm_END_CIDADE: TStringField
      FieldName = 'END_CIDADE'
      Size = 30
    end
    object qry_nf_serv_adm_END_BAIRRO: TStringField
      FieldName = 'END_BAIRRO'
      Size = 30
    end
    object qry_nf_serv_adm_END_UF: TStringField
      FieldName = 'END_UF'
      Size = 2
    end
    object qry_nf_serv_adm_END_CEP: TStringField
      FieldName = 'END_CEP'
      Size = 8
    end
    object qry_nf_serv_adm_CGC_EMPRESA: TStringField
      FieldName = 'CGC_EMPRESA'
      Size = 14
    end
    object qry_nf_serv_adm_IE_EMPRESA: TStringField
      FieldName = 'IE_EMPRESA'
    end
  end
  object qry_nf_serv_adm_item_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_nf_serv_adm
    SQL.Strings = (
      'SELECT *'
      'FROM   TNF_SERV_ADM_ITEM (NOLOCK)'
      'WHERE  CD_UNID_NEG = :CD_UNID_NEG AND'
      '       NR_DOCTO    = :NR_DOCTO')
    Left = 398
    Top = 375
    ...
    object qry_nf_serv_adm_item_CD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TNF_SERV_ADM_ITEM.CD_UNID_NEG'
      Size = 2
    end
    object qry_nf_serv_adm_item_NR_DOCTO: TStringField
      FieldName = 'NR_DOCTO'
      Origin = 'TNF_SERV_ADM_ITEM.NR_DOCTO'
      Size = 6
    end
    object qry_nf_serv_adm_item_CD_CT_CONTABIL: TStringField
      FieldName = 'CD_CT_CONTABIL'
      Origin = 'TNF_SERV_ADM_ITEM.CD_CT_CONTABIL'
      Size = 10
    end
    object qry_nf_serv_adm_item_TX_HISTORICO: TMemoField
      FieldName = 'TX_HISTORICO'
      Origin = 'TNF_SERV_ADM_ITEM.TX_HISTORICO'
      BlobType = ftMemo
    end
    object qry_nf_serv_adm_item_VL_ITEM: TFloatField
      FieldName = 'VL_ITEM'
      Origin = 'TNF_SERV_ADM_ITEM.VL_ITEM'
    end
    object qry_nf_serv_adm_item_IN_COLUNA: TStringField
      FieldName = 'IN_COLUNA'
      Origin = 'TNF_SERV_ADM_ITEM.IN_COLUNA'
      Size = 1
    end
  end
  object ds_nf_serv_adm: TDataSource
    DataSet = qry_nf_serv_adm_
    Left = 271
    Top = 272
  end
  object qry_obs_ts_fatura_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_grd_sol
    RequestLive = True
    SQL.Strings = (
    ...
    object qry_obs_ts_fatura_TX_OBS: TMemoField
      FieldName = 'TX_OBS'
      Origin = 'TS_FATURA.TX_OBS'
      BlobType = ftMemo
    end
  end
  object qry_fat_calculo_rateio_despesas_: TQuery
    ...
    object qry_fat_calculo_rateio_despesas_CD_USUARIO: TStringField
      ...
      Origin = 'TFAT_CALCULO_RATEIO_DESP.NR_IDENTIFICADOR'
      Size = 4
    end
  ...
  object qry_sum_fat_calc_rat_desp_: TQuery
    ...
    SQL.Strings = (
      ...
      'FROM   TFAT_CALCULO_RATEIO_DESP (NOLOCK)'
  ...
  object qry_nota_retencao_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_grd_sol
    RequestLive = True
    SQL.Strings = (
    ...
    object qry_nota_retencao_NR_NOTA: TStringField
      FieldName = 'NR_NOTA'
      Origin = 'DBBROKER.TNF_RETENCAO.NR_NOTA'
      FixedChar = True
      Size = 6
    end
  end
  object qry_nota_retencao_acum_: TQuery
    DatabaseName = 'DBBROKER'
    DataSource = ds_grd_sol
    RequestLive = True
    SQL.Strings = (
      'SELECT NR_NOTA_ACUMULADA'
      'FROM   TNF_RETENCAO'
      'WHERE  CD_UNID_NEG_ACUMULADA = :CD_UNID_NEG AND'
      '       CD_PRODUTO_ACUMULADA = :CD_PRODUTO AND'
      '       NR_SOLICITACAO_ACUMULADA = :NR_SOLICITACAO')
    Left = 202
    Top = 428
    ParamData = <
      item
    ...
    object qry_nota_retencao_acum_NR_NOTA_ACUMULADA: TStringField
      FieldName = 'NR_NOTA_ACUMULADA'
      Origin = 'DBBROKER.TNF_RETENCAO.NR_NOTA_ACUMULADA'
      FixedChar = True
      Size = 6
    end
  end
  ...
  object qry_tot_tributavel_: TQuery
    ...
    SQL.Strings = (
      ...
      '       F.NR_SOLICITACAO = :NR_SOLICITACAO AND'
        ...
        '       F.CD_ITEM NOT IN ( SELECT CD_ITEM_ISS       FROM TPARAMET' +
        'ROS (NOLOCK) )'
      '')
    Left = 44
    Top = 433
  ...
  object qry_comissao_proc: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT VL_INFORMADO AS VL_COMISSAO'
      'FROM   TS_FATURA_PROCESSO_ITEM (NOLOCK)'
