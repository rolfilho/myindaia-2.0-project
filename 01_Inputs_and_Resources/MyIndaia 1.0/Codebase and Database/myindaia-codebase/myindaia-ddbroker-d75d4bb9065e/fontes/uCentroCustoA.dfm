object frm_centro_custoA: Tfrm_centro_custoA
  Left = 85
  Top = 170
  Width = 750
  Height = 544
  Caption = 'Cadastro de Contas Custo'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgctrl_ct_custo: TPageControl
    Left = 0
    Top = 47
    Width = 742
    Height = 451
    ...
    Align = alClient
    TabOrder = 0
    OnChange = pgctrl_ct_custoChange
    OnChanging = pgctrl_ct_custoChanging
    object ts_lista: TTabSheet
      ...
      object dbg_cadastro: TDBGrid
        ...
        Align = alClient
        Color = clWhite
        DataSource = datm_centro_custo.ds_centro_custo
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object dbedt_nm_centro_custo: TDBEdit
          Left = 16
          Top = 122
          Width = 366
          Height = 21
          DataField = 'NM_CT_CUSTO'
          DataSource = datm_centro_custo.ds_centro_custo
          TabOrder = 2
          OnChange = dbedt_nm_centro_custoChange
        end
        ...
        object dbedt_cd_centro_custo: TDBEdit
          Left = 16
          Top = 75
          Width = 56
          Height = 21
  ...
  object pnl_cadastro: TPanel
    ...
    object dbnvg: TDBNavigator
      ...
      Width = 104
      Height = 25
      DataSource = datm_ct_custo.ds_ct_custo
