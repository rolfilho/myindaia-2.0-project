object frm_cliente_transp: Tfrm_cliente_transp
  Left = 169
  Top = 146
  Width = 640
  Height = 480
  Caption = 'Cliente X Transportador'
  ...
  object pnl_cadastro: TPanel
    ...
    object dbnvg: TDBNavigator
      ...
      Width = 104
      Height = 25
      DataSource = datm_cliente_transp.ds_cliente_transp
  ...
  object pgctrl_cliente_transp: TPageControl
    Left = 1
    Top = 48
    Width = 629
    Height = 385
    ActivePage = ts_lista
    TabOrder = 2
    OnChange = pgctrl_cliente_transpChange
    OnChanging = pgctrl_cliente_transpChanging
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object lbl_taxa_transp_rod: TLabel
          Left = 23
          Top = 171
          Width = 29
          Height = 13
        ...
        object btn_co_transp_rod: TSpeedButton
          Left = 391
          Top = 148
          Width = 25
          Height = 21
          Glyph.Data = {
            ...
            5555555555555555555555555555555555555555555555555555}
          NumGlyphs = 2
          OnClick = btn_co_transp_rodClick
        end
        object lbl_transp_rod: TLabel
          ...
          Width = 145
          Height = 13
          Caption = 'Transportador Rodoviário'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object dblkpcbox_ativo: TDBLookupComboBox
          ...
          KeyField = 'CD_YESNO'
          ListField = 'TX_YESNO'
          ListSource = datm_cliente_transp.ds_yesno
          TabOrder = 2
          OnClick = dbedt_cd_transp_rodChange
        end
        ...
        object dbedt_cd_taxa: TDBEdit
          ...
          MaxLength = 3
          TabOrder = 1
          OnChange = dbedt_cd_transp_rodChange
          OnExit = dbedt_cd_taxaExit
          OnKeyDown = dbedt_cd_transp_rodKeyDown
        end
        ...
        object dbedt_cd_transp_rod: TDBEdit
          ...
          TabOrder = 0
          OnChange = dbedt_cd_transp_rodChange
          OnExit = dbedt_cd_transp_rodExit
          OnKeyDown = dbedt_cd_transp_rodKeyDown
        end
