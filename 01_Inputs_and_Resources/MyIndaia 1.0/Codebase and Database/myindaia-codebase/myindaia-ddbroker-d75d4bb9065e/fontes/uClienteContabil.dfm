object frm_cliente_contabil: Tfrm_cliente_contabil
  Left = 220
  Top = 152
  Width = 640
  Height = 480
  Caption = 'Cliente - Conta Cont'#225'bil'
  Color = clBtnFace
  ...
  object pgctrl_cliente_contabil: TPageControl
    Left = 3
    Top = 59
    Width = 625
    Height = 371
    ...
    TabOrder = 2
    OnChange = pgctrl_cliente_contabilChange
    OnChanging = pgctrl_cliente_contabilChanging
    object ts_lista: TTabSheet
      ...
      object dbg_doctos: TDBGrid
        ...
        Width = 586
        Height = 218
        DataSource = datm_cliente_contabil.ds_lista
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object btn_co_conta: TSpeedButton
          Left = 375
          Top = 132
          Width = 25
          Height = 21
        ...
        object dbedt_cd_cliente2: TDBEdit
          ...
          Color = clMenu
          DataField = 'CD_CLIENTE'
          DataSource = datm_cliente_contabil.ds_cliente_contabil_
          ReadOnly = True
          TabOrder = 1
        end
        ...
        object dbedt_cd_conta: TDBEdit
          ...
          DataSource = datm_cliente_contabil.ds_cliente_contabil_
          TabOrder = 0
          OnChange = btn_co_contaClick
          OnExit = dbedt_cd_contaExit
          OnKeyDown = dbedt_cd_contaKeyDown
        end
