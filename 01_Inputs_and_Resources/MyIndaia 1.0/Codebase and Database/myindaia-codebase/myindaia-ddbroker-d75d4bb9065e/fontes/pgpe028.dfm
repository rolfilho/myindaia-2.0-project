object datm_exp_impressao: Tdatm_exp_impressao
  Left = 200
  Top = 108
  Height = 373
  Width = 278
  ...
  object qry_processo_: TQuery
    ...
    SQL.Strings = (
      'SELECT NR_PROCESSO, CD_EXPORTADOR'
        ...
        'FROM TPROCESSO_EXP WHERE SubString(NR_PROCESSO,1,2) =  :CD_UNID_' +
        'NEG '
      '')
    ...
    object qry_processo_CalcNrProc: TStringField
      FieldName = 'CalcNrProc'
      Size = 18
      Calculated = True
    end
