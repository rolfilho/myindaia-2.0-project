object frm_prop_merc: Tfrm_prop_merc
  Left = 192
  Top = 99
  Width = 750
  Height = 550
  Caption = 'Cadastro de Propriet'#225'rios de Mercadoria'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgctrl_prop_merc: TPageControl
    Left = 0
    Top = 47
    Width = 742
    Height = 457
    ...
    Align = alClient
    TabOrder = 0
    OnChange = pgctrl_prop_mercChange
    OnChanging = pgctrl_prop_mercChanging
    object ts_lista: TTabSheet
      ...
      object dbg_cadastro: TDBGrid
        ...
        Align = alClient
        Color = clWhite
        DataSource = datm_prop_merc.ds_prop_merc
    ...
    object ts_dados_basicos: TTabSheet
      ...
      object pnl_entrada_de_dados: TPanel
        ...
        object dbedt_nm_prop_merc: TDBEdit
          Left = 24
          Top = 86
          Width = 355
          Height = 21
          ...
          MaxLength = 50
          TabOrder = 1
          OnChange = dbedt_nm_prop_mercChange
        end
        object dbedt_cd_prop_merc: TDBEdit
          Left = 24
          Top = 46
          Width = 56
          Height = 21
