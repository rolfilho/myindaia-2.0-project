unit uConsultaIntegracaoSAPCargilCtx;
...
type
  ...
  TfmConsultaIntegracaoSAPCargilCtx = class(TForm)
...
{ TfmConsultaIntegracaoSAPCtx }

class function TfmConsultaIntegracaoSAPCargilCtx.Executa(Opcoes: TOpcoesCtx): Boolean;
var
  Form: TfmConsultaIntegracaoSAPCargilCtx;
  I: Integer;
begin
  Form := TfmConsultaIntegracaoSAPCargilCtx.Create(nil);
  try
...
procedure TfmConsultaIntegracaoSAPCargilCtx.BitBtn1Click(Sender: TObject);
begin
...
procedure TfmConsultaIntegracaoSAPCargilCtx.BitBtn2Click(Sender: TObject);
begin
  Close;
  ModalResult := mrCancel;
end;

procedure TfmConsultaIntegracaoSAPCargilCtx.btn_co_unid_negClick(Sender: TObject);
begin
...
procedure TfmConsultaIntegracaoSAPCargilCtx.FormActivate(Sender: TObject);
begin
  msk_cd_unid_neg.Text := str_cd_unid_neg;
  btn_co_unid_negClick(Sender);
end;

procedure TfmConsultaIntegracaoSAPCargilCtx.msk_cd_unid_negExit(Sender: TObject);
begin
  ValCodEdt( msk_cd_unid_neg );
end;

procedure TfmConsultaIntegracaoSAPCargilCtx.btn_nr_processoClick(Sender: TObject);
var
