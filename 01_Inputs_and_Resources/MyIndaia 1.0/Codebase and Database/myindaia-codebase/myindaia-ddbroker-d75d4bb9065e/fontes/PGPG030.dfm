object datm_imp_adm_gera_ted: Tdatm_imp_adm_gera_ted
  OldCreateOrder = True
  Left = 285
  Top = 165
  Height = 388
  ...
  object qry_ct_contabil_: TQuery
    ...
    SQL.Strings = (
      'SELECT DISTINCT CD_CT_CONTABIL, NM_CT_CONTABIL'
      'FROM TCT_CONTABIL')
    Left = 228
    Top = 29
  ...
  object qry_lib_adm_item_: TQuery
    ...
    SQL.Strings = (
      ...
      '       TUNID_NEG UN'
        ...
        'WHERE  S.CD_CT_CONTABIL *= C.CD_CT_CONTABIL AND year(S.DT_LANCTO' +
        ') = C.ANO_CONTA AND'
