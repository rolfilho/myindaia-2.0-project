object frm_DARF: Tfrm_DARF
  Left = 83
  Top = 35
  Width = 640
  Height = 480
  Caption = 'Taxas do DARF'
  ...
  object pgctrl_DARF: TPageControl
    Left = 0
    Top = 48
    Width = 629
    Height = 385
    ActivePage = ts_lista
    TabOrder = 1
    OnChange = pgctrl_DARFChange
    OnChanging = pgctrl_DARFChanging
