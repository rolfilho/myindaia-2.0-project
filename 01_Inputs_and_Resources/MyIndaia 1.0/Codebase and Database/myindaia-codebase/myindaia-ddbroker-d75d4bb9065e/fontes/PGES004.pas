...
type
  Tdatm_tot_gastos_porto = class(TDataModule)
    ...
    sp_gastos_armazenagem: TStoredProc;
    qry_del_gastos_armazenagem: TQuery;
  private
...
var
  datm_tot_gastos_porto: Tdatm_tot_gastos_porto;
