object frm_imp_pagtos: Tfrm_imp_pagtos
  Left = 155
  Top = 124
  Width = 750
  Height = 550
  ...
  object pnl_cadastro: TPanel
    ...
    object dbnvg: TDBNavigator
      ...
      Width = 104
      Height = 25
      DataSource = datm_imp_pagtos.ds_lib_pagto
  ...
  object dbgrdItensPendentes: TDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = datm_imp_pagtos.ds_lib_pagto_item
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object tmr_cheque: TTimer
    Enabled = False
    Interval = 60000
    OnTimer = tmr_chequeTimer
    Left = 656
    Top = 168
  end
end
