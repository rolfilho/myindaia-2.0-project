object datm_pesq_proc: Tdatm_pesq_proc
  OldCreateOrder = True
  Left = 262
  Top = 211
  Height = 532
  ...
  object qry_empresa_nac_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT CD_EMPRESA, NM_EMPRESA, IN_ATIVO '
  ...
  object qry_servico_: TQuery
    ...
    SQL.Strings = (
      ...
      'FROM TSERVICO_NOVO (NOLOCK)'
      'WHERE CONVERT(VARCHAR, CD_SERVICO) = :CD_SERVICO'
  ...
  object qry_pais_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT CODIGO AS CD_PAIS, DESCRICAO AS NM_PAIS'
      'FROM TPAIS (NOLOCK)'
      'WHERE CODIGO = :CD_PAIS')
    Left = 526
    Top = 67
    ParamData = <
      item
  ...
  object qry_pesq_: TQuery
    ...
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT P.NR_PROCESSO, P.CD_UNID_NEG,  U.NM_UNID_NEG, '
      '       P.CD_PRODUTO, PR.NM_PRODUTO, '
      '       P.CD_CLIENTE, E.AP_EMPRESA,'
      '       P.CD_SERVICO, S.NM_SERVICO, P.IN_CANCELADO'
    ...
    object qry_pesq_IN_CANCELADO: TStringField
  ...
  object qry_transp_rod_: TQuery
    ...
    SQL.Strings = (
      ...
      'WHERE  CD_TRANSP_ROD = :CD_TRANSP_ROD AND'
      '       IN_ATIVO = '#39'1'#39
      '')
    Left = 223
    Top = 237
  ...
  object qry_amz_: TQuery
    ...
    SQL.Strings = (
      ...
      'WHERE  CD_ARMAZEM = :CD_ARMAZEM AND'
      '       IN_ATIVO = '#39'1'#39
      '')
    Left = 223
    Top = 292
  ...
  object qry_atz_rel_proc_mod1_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT NR_PROCESSO'
  ...
  object qry_rel_proc_mod1_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT MAX( NR_IDENTIFICADOR ) NR_IDENTIFICADOR'
      'FROM   TREL_PROCESSO_MOD1 (NOLOCK)')
    Left = 417
    Top = 180
  end
  ...
  object qry_mercadoria_exp_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT CD_MERCADORIA, AP_MERCADORIA'
  ...
  object qry_transportador_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT CODIGO, DESCRICAO'
      'FROM   TTRANSPORTADOR_ITL (NOLOCK)'
      'WHERE  CODIGO = :CD_TRANSPORTADOR')
    Left = 417
    Top = 237
    ParamData = <
      item
  ...
  object qry_cliente_habilitacao: TQuery
    DatabaseName = 'DBBROKER'
    RequestLive = True
    SQL.Strings = (
      'SELECT CD_CLIENTE, CD_UNID_NEG, CD_PRODUTO, DT_VALID_CRED_RF,'
      
        '       DT_CAPTACAO, IN_ATIVO, TX_NUMERARIO_OBS, CD_TAB_SDA, CD_E' +
        'QUIPE,'
      
        '       CD_FOLLOW_UP, CD_NUMERARIO, CD_TP_FOLLOW_UP, IN_SD_FAT_ZE' +
        'RO,'
      
        '       IN_SD_NOTA_ZERO, IN_COBRAR_CPMF, IN_COBRAR_ISS, CD_RESPON' +
        'SAVEL, IN_BOLETO,'
      
        '       NR_DIAS_VENCTO_FATURA, IN_COMP_SDA, CD_IR_FAT, IN_DIVERSO' +
        'S,'
      
        '       IN_QUADRO_TOTAL_FAT, IN_CC_NUM, IN_OBS_UNICA, IN_OBS_POR_' +
        'DATA,'
      '       IN_DIA_UTIL_EMISSAO_FAT, TP_PORTADOR, CD_BANCO_PORTADOR,'
      
        '       IN_CPMF_SALDO_CREDOR, IN_CALCULA_IRRF_VL_MIN, TP_TAB_SDA,' +
        ' IN_CPMF_TOTAL,'
      
        '       IN_NOTA_LIQ, IN_FAT_REC, IN_EXP_NF, NR_CONTRATO_SEGURO, N' +
        'R_ALT_LINHA_FAT_EXP,'
      '       NR_PROT_MERCANTE, VL_MIN_DI'
      'FROM   TCLIENTE_HABILITACAO (NOLOCK)'
    ...
    object qry_cliente_habilitacaoCD_CLIENTE: TStringField
      FieldName = 'CD_CLIENTE'
      Origin = 'TCLIENTE_HABILITACAO.CD_CLIENTE'
      Size = 5
    end
    object qry_cliente_habilitacaoCD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TCLIENTE_HABILITACAO.CD_UNID_NEG'
      Size = 2
    end
    object qry_cliente_habilitacaoCD_PRODUTO: TStringField
      FieldName = 'CD_PRODUTO'
      Origin = 'TCLIENTE_HABILITACAO.CD_PRODUTO'
      Size = 2
    end
    object qry_cliente_habilitacaoDT_VALID_CRED_RF: TDateTimeField
      FieldName = 'DT_VALID_CRED_RF'
      Origin = 'TCLIENTE_HABILITACAO.DT_VALID_CRED_RF'
    end
    object qry_cliente_habilitacaoDT_CAPTACAO: TDateTimeField
      FieldName = 'DT_CAPTACAO'
      Origin = 'TCLIENTE_HABILITACAO.DT_CAPTACAO'
    end
    object qry_cliente_habilitacaoIN_ATIVO: TStringField
      FieldName = 'IN_ATIVO'
      Origin = 'TCLIENTE_HABILITACAO.IN_ATIVO'
      Size = 1
    end
    object qry_cliente_habilitacaoTX_NUMERARIO_OBS: TMemoField
      FieldName = 'TX_NUMERARIO_OBS'
      Origin = 'TCLIENTE_HABILITACAO.TX_NUMERARIO_OBS'
      BlobType = ftMemo
    end
    object qry_cliente_habilitacaoCD_TAB_SDA: TStringField
      FieldName = 'CD_TAB_SDA'
      Origin = 'TCLIENTE_HABILITACAO.CD_TAB_SDA'
      Size = 3
    end
    object qry_cliente_habilitacaoCD_FOLLOW_UP: TStringField
      FieldName = 'CD_FOLLOW_UP'
      Origin = 'TCLIENTE_HABILITACAO.CD_FOLLOW_UP'
      Size = 2
    end
    object qry_cliente_habilitacaoCD_NUMERARIO: TStringField
      FieldName = 'CD_NUMERARIO'
      Origin = 'TCLIENTE_HABILITACAO.CD_NUMERARIO'
      Size = 2
    end
    object qry_cliente_habilitacaoCD_TP_FOLLOW_UP: TStringField
      FieldName = 'CD_TP_FOLLOW_UP'
      Origin = 'TCLIENTE_HABILITACAO.CD_TP_FOLLOW_UP'
      Size = 2
    end
    object qry_cliente_habilitacaoIN_SD_FAT_ZERO: TStringField
      FieldName = 'IN_SD_FAT_ZERO'
      Origin = 'TCLIENTE_HABILITACAO.IN_SD_FAT_ZERO'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_SD_NOTA_ZERO: TStringField
      FieldName = 'IN_SD_NOTA_ZERO'
      Origin = 'TCLIENTE_HABILITACAO.IN_SD_NOTA_ZERO'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_COBRAR_CPMF: TStringField
      FieldName = 'IN_COBRAR_CPMF'
      Origin = 'TCLIENTE_HABILITACAO.IN_COBRAR_CPMF'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_COBRAR_ISS: TStringField
      FieldName = 'IN_COBRAR_ISS'
      Origin = 'TCLIENTE_HABILITACAO.IN_COBRAR_ISS'
      Size = 1
    end
    object qry_cliente_habilitacaoCD_RESPONSAVEL: TStringField
      FieldName = 'CD_RESPONSAVEL'
      Origin = 'TCLIENTE_HABILITACAO.CD_RESPONSAVEL'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_BOLETO: TStringField
      FieldName = 'IN_BOLETO'
      Origin = 'TCLIENTE_HABILITACAO.IN_BOLETO'
      Size = 1
    end
    object qry_cliente_habilitacaoNR_DIAS_VENCTO_FATURA: TIntegerField
      FieldName = 'NR_DIAS_VENCTO_FATURA'
      Origin = 'TCLIENTE_HABILITACAO.NR_DIAS_VENCTO_FATURA'
    end
    object qry_cliente_habilitacaoIN_COMP_SDA: TStringField
      FieldName = 'IN_COMP_SDA'
      Origin = 'TCLIENTE_HABILITACAO.IN_COMP_SDA'
      Size = 1
    end
    object qry_cliente_habilitacaoCD_IR_FAT: TStringField
      FieldName = 'CD_IR_FAT'
      Origin = 'TCLIENTE_HABILITACAO.CD_IR_FAT'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_DIVERSOS: TStringField
      FieldName = 'IN_DIVERSOS'
      Origin = 'TCLIENTE_HABILITACAO.IN_DIVERSOS'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_QUADRO_TOTAL_FAT: TStringField
      FieldName = 'IN_QUADRO_TOTAL_FAT'
      Origin = 'TCLIENTE_HABILITACAO.IN_QUADRO_TOTAL_FAT'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_CC_NUM: TStringField
      FieldName = 'IN_CC_NUM'
      Origin = 'TCLIENTE_HABILITACAO.IN_CC_NUM'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_OBS_UNICA: TStringField
      FieldName = 'IN_OBS_UNICA'
      Origin = 'TCLIENTE_HABILITACAO.IN_OBS_UNICA'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_OBS_POR_DATA: TStringField
      FieldName = 'IN_OBS_POR_DATA'
      Origin = 'TCLIENTE_HABILITACAO.IN_OBS_POR_DATA'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_DIA_UTIL_EMISSAO_FAT: TStringField
      FieldName = 'IN_DIA_UTIL_EMISSAO_FAT'
      Origin = 'TCLIENTE_HABILITACAO.IN_DIA_UTIL_EMISSAO_FAT'
      Size = 1
    end
    object qry_cliente_habilitacaoTP_PORTADOR: TStringField
      FieldName = 'TP_PORTADOR'
      Origin = 'TCLIENTE_HABILITACAO.TP_PORTADOR'
      Size = 1
    end
    object qry_cliente_habilitacaoCD_BANCO_PORTADOR: TStringField
      FieldName = 'CD_BANCO_PORTADOR'
      Origin = 'TCLIENTE_HABILITACAO.CD_BANCO_PORTADOR'
      Size = 3
    end
    object qry_cliente_habilitacaoIN_CPMF_SALDO_CREDOR: TStringField
      FieldName = 'IN_CPMF_SALDO_CREDOR'
      Origin = 'TCLIENTE_HABILITACAO.IN_CPMF_SALDO_CREDOR'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_CALCULA_IRRF_VL_MIN: TStringField
      FieldName = 'IN_CALCULA_IRRF_VL_MIN'
      Origin = 'TCLIENTE_HABILITACAO.IN_CALCULA_IRRF_VL_MIN'
      Size = 1
    end
    object qry_cliente_habilitacaoTP_TAB_SDA: TStringField
      FieldName = 'TP_TAB_SDA'
      Origin = 'TCLIENTE_HABILITACAO.TP_TAB_SDA'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_CPMF_TOTAL: TStringField
      FieldName = 'IN_CPMF_TOTAL'
      Origin = 'TCLIENTE_HABILITACAO.IN_CPMF_TOTAL'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_NOTA_LIQ: TStringField
      FieldName = 'IN_NOTA_LIQ'
      Origin = 'TCLIENTE_HABILITACAO.IN_NOTA_LIQ'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_FAT_REC: TStringField
      FieldName = 'IN_FAT_REC'
      Origin = 'TCLIENTE_HABILITACAO.IN_FAT_REC'
      Size = 1
    end
    object qry_cliente_habilitacaoIN_EXP_NF: TStringField
      FieldName = 'IN_EXP_NF'
      Origin = 'TCLIENTE_HABILITACAO.IN_EXP_NF'
      Size = 1
    end
    object qry_cliente_habilitacaoNR_CONTRATO_SEGURO: TStringField
      FieldName = 'NR_CONTRATO_SEGURO'
      Origin = 'TCLIENTE_HABILITACAO.NR_CONTRATO_SEGURO'
      Size = 10
    end
    object qry_cliente_habilitacaoNR_ALT_LINHA_FAT_EXP: TIntegerField
      FieldName = 'NR_ALT_LINHA_FAT_EXP'
      Origin = 'TCLIENTE_HABILITACAO.NR_ALT_LINHA_FAT_EXP'
    end
    object qry_cliente_habilitacaoNR_PROT_MERCANTE: TStringField
      FieldName = 'NR_PROT_MERCANTE'
      Origin = 'TCLIENTE_HABILITACAO.NR_PROT_MERCANTE'
      Size = 10
    end
    object qry_cliente_habilitacaoVL_MIN_DI: TFloatField
      FieldName = 'VL_MIN_DI'
      Origin = 'TCLIENTE_HABILITACAO.VL_MIN_DI'
    end
  end
  object qry_unid_neg: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
    ...
    Left = 526
    Top = 126
    object qry_unid_negCD_UNID_NEG: TStringField
      FieldName = 'CD_UNID_NEG'
      Origin = 'TUNID_NEG.CD_UNID_NEG'
      Size = 2
    end
    object qry_unid_negNM_UNID_NEG: TStringField
      FieldName = 'NM_UNID_NEG'
  ...
  object qry_tp_lead_time_: TQuery
    ...
    SQL.Strings = (
      ...
      'FROM   TTP_LEAD_TIME (NOLOCK)'
      'ORDER BY TP_LEAD_TIME')
    Left = 35
    Top = 237
    object qry_tp_lead_time_TP_LEAD_TIME: TStringField
      FieldName = 'TP_LEAD_TIME'
      Origin = 'TTP_LEAD_TIME.TP_LEAD_TIME'
      Size = 1
    end
    object qry_tp_lead_time_NM_TP_LEAD_TIME: TStringField
      FieldName = 'NM_TP_LEAD_TIME'
      Origin = 'TTP_LEAD_TIME.NM_TP_LEAD_TIME'
      Size = 5
    end
  end
  object ds_tp_lead_time: TDataSource
    DataSet = qry_tp_lead_time_
    Left = 35
    Top = 292
  end
  object ppBDERelLeadTime: TppBDEPipeline
    UserName = 'BDERelLeadTime'
    Left = 626
    Top = 292
  end
  ...
  object ppSelUnidProdEmb: TppReport
    AutoStop = False
    DataPipeline = ppBDERelLeadTime
    ...
    Template.FileName = 'C:\DDBroker\RBIMP003.rtm'
    ...
    Version = '7.02'
    mmColumnWidth = 0
    DataPipelineName = 'ppBDERelLeadTime'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppTitulo: TppLabel
        UserName = 'Titulo'
        Caption = 'Relat'#243'rio Lead Time'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'TIMES NEW ROMAN'
        Font.Size = 14
  ...
  object qry_tp_referencia_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'select * from ttp_referencia (NOLOCK) '
      'order by cd_referencia'
      '')
    Left = 126
    Top = 13
    object qry_tp_referencia_CD_REFERENCIA: TStringField
      FieldName = 'CD_REFERENCIA'
      Origin = 'TTP_REFERENCIA.CD_REFERENCIA'
      Size = 2
    end
    object qry_tp_referencia_NM_REFERENCIA: TStringField
      FieldName = 'NM_REFERENCIA'
      Origin = 'TTP_REFERENCIA.NM_REFERENCIA'
    end
  end
  object ds_tp_referencia: TDataSource
    DataSet = qry_tp_referencia_
    Left = 126
    Top = 67
  end
  object ds_requerimento: TDataSource
    DataSet = qry_requerimento_
    Left = 126
    Top = 292
  end
  object qry_requerimento_: TQuery
    DatabaseName = 'DBBROKER'
    SQL.Strings = (
      'SELECT NR_PROCESSO'
      'FROM TPROCESSO_REQUERIMENTO (NOLOCK)'
      'WHERE NR_REQUERIMENTO =:NR_REQUERIMENTO')
    Left = 126
    Top = 237
    ParamData = <
      item
        DataType = ftString
        Name = 'NR_REQUERIMENTO'
        ParamType = ptUnknown
      end>
    object qry_requerimento_NR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'TPROCESSO_REQUERIMENTO.NR_PROCESSO'
      Size = 18
    end
  end
