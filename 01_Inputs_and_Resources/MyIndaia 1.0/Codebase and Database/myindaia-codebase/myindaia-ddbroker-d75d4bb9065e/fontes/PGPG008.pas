...
PROGRAMA: PGPG008.PAS - Data Module - Emissão de Cheques Operacionais
DATA: 09/10/2001
Manutenção: 
*************************************************************************************************)
unit PGPG008;
...
type
  Tdatm_imp_pagtos = class(TDataModule)
    ds_item: TDataSource;
    qry_item_: TQuery;
...
var
  datm_imp_pagtos: Tdatm_imp_pagtos;
...
procedure Tdatm_imp_pagtos.qry_itens_solic_ch_VL_ITEMValidate(Sender: TField);
begin
...
procedure Tdatm_imp_pagtos.qry_lib_pagto_item_CalcFields(DataSet: TDataSet);
begin
...
procedure Tdatm_imp_pagtos.qry_banco_AfterPost(DataSet: TDataSet);
begin
  qry_banco_.ApplyUpdates;
end;

procedure Tdatm_imp_pagtos.qry_banco_AfterDelete(DataSet: TDataSet);
begin
  qry_banco_.ApplyUpdates;
end;
