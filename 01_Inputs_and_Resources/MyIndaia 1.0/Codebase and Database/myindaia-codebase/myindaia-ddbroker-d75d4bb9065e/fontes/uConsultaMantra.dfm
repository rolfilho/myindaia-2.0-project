object frmConsultaMantra: TfrmConsultaMantra
  Left = 308
  Top = 161
  Width = 750
  Height = 551
  Caption = 'Consulta ao Mantra'
  Color = clBtnFace
  ...
  object pnl2: TPanel
    ...
    object pnl1: TPanel
      ...
      object dbmmoTelaSituacao: TDBMemo
        Left = 0
        Top = 105
        Width = 598
        Height = 350
    ...
    object medt_cd_unid_neg: TMaskEdit
      ...
      OnKeyDown = medt_cd_unid_negKeyDown
    end
    ...
    object pnlProcesso: TPanel
      ...
      ParentCtl3D = False
      TabOrder = 6
      object dbtxtProcessoSombra: TDBText
        Left = 13
        Top = 10
        Width = 205
        Height = 24
  ...
  object qryProcesso: TQuery
    ...
    SQL.Strings = (
      'SELECT PM.NR_PROCESSO'
      '  FROM TPROCESSO_MANTRA PM'
      ' GROUP BY PM.NR_PROCESSO')
    Left = 290
    Top = 32
    object qryProcessoNR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.NR_PROCESSO'
      FixedChar = True
      Size = 18
    end
  ...
  object qryConsulta: TQuery
    AfterScroll = qryConsultaAfterScroll
    DatabaseName = 'DBBROKER'
    DataSource = dsProcesso
    SQL.Strings = (
      'SELECT *, SUBSTRING(NR_PROCESSO, 5, 14) AS NR_PROCESSO_SIMPLES'
      'FROM TPROCESSO_MANTRA'
      'WHERE NR_PROCESSO = :NR_PROCESSO'
      'ORDER BY NR_CONSULTA DESC')
    Left = 322
    Top = 29
    ParamData = <
      item
    ...
    object qryConsultaNR_PROCESSO: TStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.NR_PROCESSO'
      FixedChar = True
      Size = 18
    end
    object qryConsultaNR_CONSULTA: TAutoIncField
      FieldName = 'NR_CONSULTA'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.NR_CONSULTA'
    end
    object qryConsultaDT_CONSULTA: TDateTimeField
      FieldName = 'DT_CONSULTA'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.DT_CONSULTA'
    end
    object qryConsultaTX_SITUACAO: TStringField
      FieldName = 'TX_SITUACAO'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.TX_SITUACAO'
      FixedChar = True
      Size = 50
    end
    object qryConsultaDT_SITUACAO: TDateTimeField
      FieldName = 'DT_SITUACAO'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.DT_SITUACAO'
    end
    object qryConsultaTX_TELA_SITUACAO: TMemoField
      FieldName = 'TX_TELA_SITUACAO'
      Origin = 'DBBROKER.TPROCESSO_MANTRA.TX_TELA_SITUACAO'
      BlobType = ftMemo
    end
    object qryConsultaNR_QTDE_PAGINAS: TIntegerField
      FieldName = 'NR_QTDE_PAGINAS'
    end
    object qryConsultaNR_PROCESSO_SIMPLES: TStringField
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\DDBroker\RelMantra.rtm'
  ...
  object qryRel: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT P.NR_PROCESSO, SUBSTRING(P.NR_PROCESSO, 5, 10) AS NR_PROC' +
        ','
      
        '      (SELECT NM_EMPRESA FROM TEMPRESA_NAC WHERE CD_EMPRESA = CD' +
        '_CLIENTE) AS IMPORTADOR,'
      '       P.NR_VOO, P.NR_MANIFESTO,'
      '       PM.TX_SITUACAO, PM.TX_TELA_SITUACAO'
      ' FROM TPROCESSO_MANTRA PM (NOLOCK)'
      
        'INNER JOIN TPROCESSO P (NOLOCK) ON P.NR_PROCESSO = PM.NR_PROCESS' +
        'O'
      'WHERE PM.NR_PROCESSO = :NR_PROCESSO'
      '  AND PM.NR_CONSULTA = :NR_CONSULTA'
      '')
    Left = 383
    Top = 80
    ParamData = <
    ...
    object qryRelIMPORTADOR: TStringField
      FieldName = 'IMPORTADOR'
      FixedChar = True
      Size = 50
    end
    object qryRelNR_VOO: TStringField
      FieldName = 'NR_VOO'
      FixedChar = True
      Size = 18
    end
    object qryRelNR_MANIFESTO: TStringField
      FieldName = 'NR_MANIFESTO'
      FixedChar = True
      Size = 15
    end
    object qryRelTX_SITUACAO: TStringField
      FieldName = 'TX_SITUACAO'
      FixedChar = True
      Size = 50
    end
    object qryRelTX_TELA_SITUACAO: TMemoField
      FieldName = 'TX_TELA_SITUACAO'
      BlobType = ftMemo
    end
  end
  object dsRelRef: TDataSource
    DataSet = qryRelRef
    Left = 414
    Top = 113
  end
  object qryRelRef: TQuery
    AfterScroll = qryConsultaAfterScroll
    DatabaseName = 'DBBROKER'
    DataSource = dsRel
    SQL.Strings = (
      
        'SELECT RTRIM(LTRIM(RC.CD_REFERENCIA)) + '#39'/'#39' +  RTRIM(LTRIM(RC.NR' +
        '_ITEM_PO)) AS REF,'
      '       RC.CD_REFERENCIA, RC.NR_ITEM_PO'
    ...
    object qryRelRefREF: TStringField
      FieldName = 'REF'
      FixedChar = True
    end
    object qryRelRefCD_REFERENCIA: TStringField
      FieldName = 'CD_REFERENCIA'
      FixedChar = True
      Size = 15
    end
    object qryRelRefNR_ITEM_PO: TStringField
      FieldName = 'NR_ITEM_PO'
      FixedChar = True
      Size = 4
    end
  end
  object ppRel: TppBDEPipeline
    DataSource = dsRel
    UserName = 'Rel'
    Left = 380
    Top = 48
  ...
  object ppRelRef: TppBDEPipeline
    DataSource = dsRelRef
    UserName = 'RelRef'
    Left = 412
    Top = 48
    MasterDataPipelineName = 'ppRel'
    object ppRelRefppField1: TppField
      FieldAlias = 'REF'
      FieldName = 'REF'
      FieldLength = 0
      DisplayWidth = 0
    ...
    object ppRelRefppField2: TppField
    ...
    object ppRelRefppField3: TppField
      FieldAlias = 'NR_ITEM_PO'
      FieldName = 'NR_ITEM_PO'
      FieldLength = 4
      DisplayWidth = 4
      Position = 2
