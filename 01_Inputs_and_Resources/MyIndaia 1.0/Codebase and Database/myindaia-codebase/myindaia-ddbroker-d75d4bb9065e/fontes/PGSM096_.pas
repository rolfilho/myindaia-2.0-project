  ...
  begin
    ...
    begin
      ...
      begin
        with Cons_OnLine do
        begin
          if nCodigo in [8, 10, 14, 15, 16, 18, 21, 22, 23, 24, 25, 26, 32, 33, 36, 37, 38, 44, 45, 47, 54, 56, 57] then {Cons_OnLine_Texto}
          begin
            case nCodigo of
              8, 18, 25, 32, 37, 47:
                begin
                  try
                    ...
                    if nCodigo in [8]  then AsString := Tabela.Fields[1].AsString;
                  except
                    try
          ...
          begin
            ...
            begin
              try
                if Not( DataSet.State in [dsEdit, dsInsert] ) and ( st_modificar ) then
                   DataSet.Edit;
                if nCodigo in [1, 2, 6, 7, 17, 19, 20, 27, 30, 35, 36, 47, 55] then
