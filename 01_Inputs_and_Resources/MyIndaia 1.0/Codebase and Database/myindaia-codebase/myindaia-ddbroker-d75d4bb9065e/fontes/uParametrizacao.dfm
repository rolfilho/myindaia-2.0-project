object frm_parametrizacao: Tfrm_parametrizacao
  Left = 238
  Top = 120
  Width = 1059
  Height = 522
  Caption = 'Consulta de Parametriza'#231#227'o'
  Color = clBtnFace
  ...
  object pnl2: TPanel
    ...
    object dbgrd1: TDBGrid
      ...
      Color = clInfoBk
      Ctl3D = False
      DataSource = dsProcessoParametrizacao
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'calc_NR_DI'
          Title.Caption = 'N'#250'mero da DI'
          Width = 94
          Visible = True
        end>
    end
    ...
    object pnl6: TPanel
      ...
      object lbl16: TLabel
        ...
        Height = 13
        Caption = 
          '* d'#234' um duplo-clique nesse grid para exibir detalhes e o print d' +
          'e tela da situa'#231#227'o'
        Transparent = True
      end
    end
  end
  object pnl3: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 126
      Height = 13
      Caption = 'Per'#237'odo ( data de registro )'
    end
  ...
  object pnlImagem: TPanel
    ...
    object pnl1: TPanel
      ...
      BevelOuter = bvNone
      Caption = ' Detalhes da Parametriza'#231#227'o'
    ...
    object nbGuias: TNotebook
      ...
      object TPage
        ...
        object lbl20: TLabel
          ...
          Width = 79
          Height = 13
          Caption = 'Para Retifica'#231#227'o'
          FocusControl = dbedt8
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
  ...
  object qryProcessoParametrizacao: TQuery
    OnCalcFields = qryProcessoParametrizacaoCalcFields
    DatabaseName = 'DBBROKER'
    Left = 608
    Top = 147
    object qryProcessoParametrizacaoNR_DI: TStringField
      FieldName = 'NR_DI'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.NR_DI'
      FixedChar = True
      Size = 10
    end
    object qryProcessoParametrizacaonr_processo: TStringField
      FieldName = 'nr_processo'
      FixedChar = True
      Size = 18
    end
    object qryProcessoParametrizacaocalc_NR_DI: TStringField
  ...
  object dsProcessoParametrizacao: TDataSource
    DataSet = qryProcessoParametrizacao
    Left = 584
    Top = 131
  end
  object qryParametrizacao: TQuery
    AfterScroll = qryParametrizacaoAfterScroll
    OnCalcFields = qryParametrizacaoCalcFields
    DatabaseName = 'DBBROKER'
    DataSource = dsProcessoParametrizacao
    SQL.Strings = (
      'SELECT * '
      'FROM TPROCESSO_PARAMETRIZACAO'
      'WHERE NR_DI = :NR_DI'
    ...
    object qryParametrizacaoDATA_CONSULTA: TDateTimeField
      FieldName = 'DATA_CONSULTA'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.DATA_CONSULTA'
    end
    object qryParametrizacaoHORA_CONSULTA: TStringField
      DisplayWidth = 4
      FieldName = 'HORA_CONSULTA'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.HORA_CONSULTA'
      FixedChar = True
      Size = 4
    end
    object qryParametrizacaoCD_CANAL: TStringField
      FieldName = 'CD_CANAL'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.CD_CANAL'
      FixedChar = True
      Size = 1
    end
    object qryParametrizacaoTX_ETAPA: TStringField
      FieldName = 'TX_ETAPA'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_ETAPA'
      FixedChar = True
      Size = 60
    end
    object qryParametrizacaoTX_FISCAL: TStringField
      FieldName = 'TX_FISCAL'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_FISCAL'
      FixedChar = True
    end
    object qryParametrizacaoDATA_SITUACAO: TDateTimeField
      FieldName = 'DATA_SITUACAO'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.DATA_SITUACAO'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object qryParametrizacaoTX_SITUACAO: TStringField
      FieldName = 'TX_SITUACAO'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_SITUACAO'
      FixedChar = True
      Size = 65
    end
    object qryParametrizacaoTX_AFRMM: TStringField
      FieldName = 'TX_AFRMM'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_AFRMM'
      FixedChar = True
      Size = 123
    end
    object qryParametrizacaoTX_ICMS: TStringField
      FieldName = 'TX_ICMS'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_ICMS'
      FixedChar = True
      Size = 123
    end
    object qryParametrizacaocalc_CANAL: TStringField
      FieldKind = fkCalculated
      FieldName = 'calc_CANAL'
      Size = 1
      Calculated = True
    ...
    object qryParametrizacaoCD_PORTO: TStringField
      FieldName = 'CD_PORTO'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.CD_PORTO'
      FixedChar = True
      Size = 6
    end
    object qryParametrizacaoTX_DIR_IMAGEM: TStringField
      FieldName = 'TX_DIR_IMAGEM'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_DIR_IMAGEM'
      FixedChar = True
      Size = 50
    end
    object qryParametrizacaocalc_HORA_CONSULTA: TStringField
      FieldKind = fkCalculated
      FieldName = 'calc_HORA_CONSULTA'
      Size = 5
      Calculated = True
    end
    object qryParametrizacaoDATA_EXAME: TDateTimeField
      FieldName = 'DATA_EXAME'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.DATA_EXAME'
    end
    object qryParametrizacaoDATA_RETIFICA: TDateTimeField
      FieldName = 'DATA_RETIFICA'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.DATA_RETIFICA'
    end
    object qryParametrizacaoTX_EXAME: TMemoField
      FieldName = 'TX_EXAME'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_EXAME'
      BlobType = ftMemo
    end
    object qryParametrizacaoTX_RETIFICA: TMemoField
      FieldName = 'TX_RETIFICA'
      Origin = 'DBBROKER.TPROCESSO_PARAMETRIZACAO.TX_RETIFICA'
      BlobType = ftMemo
    end
  end
  object dsParametrizacao: TDataSource
