...
type
  Tfrm_imp_adm_gera_ted_old = class(TForm)
    pnl_cadastro: TPanel;
...
var
  frm_imp_adm_gera_ted_old : Tfrm_imp_adm_gera_ted_old;
...
procedure Tfrm_imp_adm_gera_ted_old.btn_sairClick(Sender: TObject);
begin
  Close;
end;

procedure Tfrm_imp_adm_gera_ted_old.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  with datm_imp_adm_gera_ted_old do
  begin
...
procedure Tfrm_imp_adm_gera_ted_old.FormCreate(Sender: TObject);
begin
  ...
  Application.CreateForm(Tdatm_imp_adm_gera_ted_old, datm_imp_adm_gera_ted_old );
...
procedure Tfrm_imp_adm_gera_ted_old.btn_cancelarClick(Sender: TObject);
begin
  if Solicitando then CancelaOperacao := True;
  btn_desmarca_todasClick(nil);
end;

procedure Tfrm_imp_adm_gera_ted_old.Abre_Adm;
begin
  with datm_imp_adm_gera_ted_old do
  begin
...
procedure Tfrm_imp_adm_gera_ted_old.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #27 then Close;
end;

procedure Tfrm_imp_adm_gera_ted_old.btn_marca_todasClick(Sender: TObject);
var
  i : Integer;
begin
  ...
  datm_imp_adm_gera_ted_old.qry_lib_adm_.First;
  for i := 0 to datm_imp_adm_gera_ted_old.qry_lib_adm_.RecordCount - 1 do
  begin
    dbgrdAdm.SelectedRows.CurrentRowSelected := True;
    datm_imp_adm_gera_ted_old.qry_lib_adm_.Next;
  end;
end;

procedure Tfrm_imp_adm_gera_ted_old.btn_desmarca_todasClick(Sender: TObject);
var
  i : Integer;
begin
...
procedure Tfrm_imp_adm_gera_ted_old.msk_dt_baseEnter(Sender: TObject);
begin
  dt_pagamento := msk_dt_base.Text;
end;

procedure Tfrm_imp_adm_gera_ted_old.msk_dt_baseExit(Sender: TObject);
begin
  if msk_dt_base.Text = dt_pagamento then Exit;
  Abre_Adm;
end;

procedure Tfrm_imp_adm_gera_ted_old.btn_imprimirClick(Sender: TObject);
begin
...
procedure Tfrm_imp_adm_gera_ted_old.msk_cd_bancoExit(Sender: TObject);
begin
...
procedure Tfrm_imp_adm_gera_ted_old.msk_cd_bancoKeyDown(Sender: TObject;
...
procedure Tfrm_imp_adm_gera_ted_old.btn_co_bancoClick(Sender: TObject);
begin
  with datm_imp_adm_gera_ted_old Do
  begin
...
procedure Tfrm_imp_adm_gera_ted_old.Dados(Copia : Boolean);
begin
  try
    with datm_imp_adm_gera_ted_old do
    begin
...
//cheque
    ...
    datm_imp_adm_gera_ted_old.qry_solic_adm_.Close;
    CloseFile( Txt );
    Exit
  end;
end;

procedure Tfrm_imp_adm_gera_ted_old.btn_canc_lancClick(Sender: TObject);
var i : Integer;
...
procedure Tfrm_imp_adm_gera_ted_old.msk_cd_unid_negExit(Sender: TObject);
begin
...
procedure Tfrm_imp_adm_gera_ted_old.FormShow(Sender: TObject);
begin
//NOTA
...
procedure Tfrm_imp_adm_gera_ted_old.rdgrp_tp_naturezaClick(Sender: TObject);
begin
  if rdgrp_tp_natureza.ItemIndex = 0 then
...
procedure Tfrm_imp_adm_gera_ted_old.GeraTed;
var
  cd_banco: String[3];
  i : Integer;
begin
...
procedure Tfrm_imp_adm_gera_ted_old.rdgrp_tp_lancamentoClick(Sender: TObject);
begin
  if rdgrp_tp_lancamento.ItemIndex = 0 then
  begin
...
procedure Tfrm_imp_adm_gera_ted_old.msk_nr_remessaExit(Sender: TObject);
begin
  if Trim( msk_nr_remessa.Text ) <> '' then
     msk_nr_remessa.Text := StrZero( StrToInt( msk_nr_remessa.Text ), 6 );
end;

procedure Tfrm_imp_adm_gera_ted_old.msk_dt_pagtoExit(Sender: TObject);
begin
  with datm_imp_adm_gera_ted_old do
  begin
    qry_caixa_ctrl_.Close;
...
procedure Tfrm_imp_adm_gera_ted_old.btn_co_unid_negClick(Sender: TObject);
begin
  with datm_imp_adm_gera_ted_old do
  begin
...
procedure Tfrm_imp_adm_gera_ted_old.Header;
begin
...
procedure Tfrm_imp_adm_gera_ted_old.Trailler;
begin
    num_seq := num_seq + 1;
    Linha := '9' + Space(123);
    Write( Txt, Linha );
...
function Tfrm_imp_adm_gera_ted_old.Consiste : Boolean;
var
  i : Integer;
begin
  Consiste := True;
