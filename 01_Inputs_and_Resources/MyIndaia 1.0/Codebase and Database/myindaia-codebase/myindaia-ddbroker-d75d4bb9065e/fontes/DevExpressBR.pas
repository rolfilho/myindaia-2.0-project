...
uses cxClasses, cxGridStrs, dxPSRes, cxFilterControlStrs, cxFilterConsts,
  cxSSRes, dxExtCtrlsStrs;
...
begin
{
  ...
  cxSetResourceString(@sdxPrintDialogInPrintingState = 'Printer is currently printing.' + #13#10 +
    'Please wait.');
  ...
  cxSetResourceString(@sdxDTFormatsChangeDefaultForm,
  ...
  cxSetResourceString(@sdxPNFormatsChangeDefaultForm,
  ...
  cxSetResourceString(@sdxDataToPrintDoesNotExis,
