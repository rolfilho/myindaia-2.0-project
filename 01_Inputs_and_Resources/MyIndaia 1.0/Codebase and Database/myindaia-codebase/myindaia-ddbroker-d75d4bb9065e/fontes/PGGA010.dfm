object datm_evento_inspec: Tdatm_evento_inspec
  Left = 141
  Top = 196
  Height = 190
  Width = 616
  ...
  object qry_tfollowup_: TQuery
    ...
    SQL.Strings = (
      'SELECT NR_PROCESSO, CD_SERVICO, CD_EVENTO, DT_INSPECAO, '
        ...
        '       CD_RESP_INSPECAO, NR_RNC, DT_REALIZACAO, CD_RESULT_INSPEC' +
        'AO'
      'FROM TFOLLOWUP'
      'WHERE ( DT_INSPECAO = :DT_INSPECAO ) and'
      '      ( CD_EVENTO = :CD_EVENTO )'
      'ORDER BY NR_ORDEM')
    Params.Data = {
      010002000B44545F494E53504543414F000904005A950A0000000943445F4556
      454E544F0001020030000000}
    Left = 288
    Top = 12
    ...
    object qry_tfollowup_Look_nm_empresa: TStringField
    ...
    object qry_tfollowup_nr_processo_calc: TStringField
      DisplayWidth = 14
      FieldName = 'nr_processo_calc'
      Size = 14
      Calculated = True
    end
    object qry_tfollowup_cd_result_inspec_calc: TStringField
      FieldName = 'cd_result_inspec_calc'
      Calculated = True
    end
    object qry_tfollowup_Look_cd_cliente: TStringField
    ...
    object qry_tfollowup_Look_Servico: TStringField
  ...
  object qry_tfollowup_1_: TQuery
    ...
    object qry_tfollowup_1_NR_RNC: TStringField
      FieldName = 'NR_RNC'
      Origin = 'TFOLLOWUP.NR_RNC'
      Size = 8
    end
