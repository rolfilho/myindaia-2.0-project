object frmAtributosFundamento: TfrmAtributosFundamento
  Left = 0
  Top = 0
  ...
  object qryAtributosFundamentoItem: TFDQuery
    ...
    object qryAtributosFundamentoItemNR_ITEM: TStringField
    ...
    object qryAtributosFundamentoItemCD_MERCADORIA: TStringField
      DisplayLabel = 'C'#243'd. Mercadoria'
      FieldName = 'CD_MERCADORIA'
      Origin = 'CD_MERCADORIA'
      Size = 30
    end
    object qryAtributosFundamentoItemTX_DESC_DET_MERC: TStringField
  ...
  object dsAtributosFundamentoItem: TDataSource
    DataSet = qryAtributosFundamentoItem
    Left = 976
    Top = 305
  end
end
