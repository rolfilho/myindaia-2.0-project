...
begin
  ...
  frmMyParametrizacao.UsuarioFechou := true;
end;
...
begin
  ...
  else if (QtdTentativasFindFile < 100) then
    Inc(QtdTentativasFindFile)
  else if (QtdTentativasFindFile >= 100) then
  begin
    tmrVerificaDownload.Enabled := False;
    MessageDlg('O download do arquivo não foi feito na pasta correta.', mtError, [mbOk], 0);
    close;
  end;
