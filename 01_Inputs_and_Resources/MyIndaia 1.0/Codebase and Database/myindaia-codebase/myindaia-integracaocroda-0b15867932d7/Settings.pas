...
type
  ...
  private
    ...
    FUnidade: string;
    FProduto: string;
    FPathFTPDownload: string;
    FPathLocal: string;
    FPathFTPUpload: string;
    FEmailErro: string;
  published
    ...
    property URLFTP: string read FURLFTP write FURLFTP;
    ...
    property EmailErro: string read FEmailErro write FEmailErro;
    property PathFTPDownload: string read FPathFTPDownload write FPathFTPDownload;
    property PathFTPUpload: string read FPathFTPUpload write FPathFTPUpload;
