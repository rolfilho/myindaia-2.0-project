...
begin
  ...
  queryID.SQL.Clear;
  queryID.SQL.Text :=
    ' INSERT INTO TINSTRUCAO_DESEMBARACO (ID_CODIGO, CD_USUARIO, DT_CRIACAO, IN_AUTORIZADO, CD_CLIENTE, CD_RESPONSAVEL, CD_EMPRESA, CD_MODAL)' +
    ' VALUES (:ID_CODIGO, :CD_USUARIO, :DT_CRIACAO, :IN_AUTORIZADO, :CD_CLIENTE, :CD_RESPONSAVEL, :CD_EMPRESA, :CD_MODAL)';
  ...
  queryID.ParamByName('IN_AUTORIZADO').Value          := '0';
...
begin
  ...
  queryProcesso.ParamByName('CD_GRUPO').Value              := '083';
  ...
  queryProcesso.ParamByName('CD_SERVICO').Value            := '390';
...
begin
  ...
  queryPO.ParamByName('CD_SERVICO').Value           := '390';
...
begin
  ...
  queryAuxiliar.ParamByName('CD_MERCADORIA').Value := Item.CdMercadoria;
  queryAuxiliar.Open;
...
begin
  ...
  queryPOItem.ParamByName('CD_MERCADORIA').Value             := Item.CdMercadoria;
