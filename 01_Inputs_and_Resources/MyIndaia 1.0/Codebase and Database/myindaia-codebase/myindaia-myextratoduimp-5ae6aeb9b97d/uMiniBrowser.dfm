object MiniBrowserFrm: TMiniBrowserFrm
  ...
  object tmrClickGrid: TTimer
    Enabled = False
    Interval = 3000
    OnTimer = tmrClickGridTimer
    Left = 160
    Top = 278
  end
  ...
  object tmrClickExtrato: TTimer
    Enabled = False
    Interval = 3000
    OnTimer = tmrClickExtratoTimer
    Left = 240
    Top = 278
  end
  object tmrExtratoDialog: TTimer
    Enabled = False
    Interval = 3000
    OnTimer = tmrExtratoDialogTimer
    Left = 328
    Top = 278
  end
end
