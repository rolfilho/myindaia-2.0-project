...
type
  ...
  private
    ...
    FIntervaloIntegracao   : Integer;

    FGeraArquivoRJ         : Boolean;
    FTransmiteArquivoRJ    : Boolean;
    FProcessarBrokerRJ     : Boolean;
    FBaixarGuiaRJ          : Boolean;
    FGeraArquivoSTS        : Boolean;
    FTransmiteArquivoSTS   : Boolean;
    FProcessarBrokerSTS    : Boolean;
    FBaixarGuiaSTS         : Boolean;
  ...
  published
    ...
    property IntervaloIntegracao  :  Integer    read FIntervaloIntegracao  write FIntervaloIntegracao;

    property GeraArquivoRJ        :  Boolean    read FGeraArquivoRJ        write FGeraArquivoRJ;
    property TransmiteArquivoRJ   :  Boolean    read FTransmiteArquivoRJ   write FTransmiteArquivoRJ;
    property BaixarGuiaRJ         :  Boolean    read FBaixarGuiaRJ         write FBaixarGuiaRJ;
    property ProcessarBrokerRJ    :  Boolean    read FProcessarBrokerRJ    write FProcessarBrokerRJ;

    property GeraArquivoSTS       :  Boolean    read FGeraArquivoSTS       write FGeraArquivoSTS;
    property TransmiteArquivoSTS  :  Boolean    read FTransmiteArquivoSTS  write FTransmiteArquivoSTS;
    property BaixarGuiaSTS        :  Boolean    read FBaixarGuiaSTS        write FBaixarGuiaSTS;
    property ProcessarBrokerSTS   :  Boolean    read FProcessarBrokerSTS   write FProcessarBrokerSTS;
