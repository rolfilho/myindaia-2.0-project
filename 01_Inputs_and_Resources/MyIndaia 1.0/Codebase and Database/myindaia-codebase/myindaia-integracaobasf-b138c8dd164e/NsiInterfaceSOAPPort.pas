...
function GetNsiInterfaceSOAPTeste(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): NsiInterfaceSOAP;
...
function GetNsiInterfaceSOAPTeste(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): NsiInterfaceSOAP;
const
