...
caminho = Server.MapPath("/DOCS_QLD/MANUAL_SGQ")
		...
		<td width="100%" valign="top"><!-- :::::::::: INICIO DO CORPO CENTRAL :::::::::: -->
			<div id="dv_corpo" class="divMainQld">
				<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                    <td colspan="3"><br /><b>MANUAL DO SGQ (<%= objrs.Fields.Item("M08_NM_DOCTO").Value%>)</b><br><img src="/imagens/30/barra_tracking<%=barra_tracking %>.gif"  width="565" border="0"><br /><br /></td>
                    </tr>
					<tr height="16">
...
%>
					<tr height="16">
						<td align="left">&nbsp;<a href="/DOCS_QLD/MANUAL_SGQ/<%= arquivo.Name%>" target="_blank"><%= arquivo.Name%></a></td>
