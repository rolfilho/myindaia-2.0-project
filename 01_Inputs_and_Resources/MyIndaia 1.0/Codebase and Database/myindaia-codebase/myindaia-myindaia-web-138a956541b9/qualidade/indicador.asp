...
caminho = Server.MapPath("/DOCS_QLD/INDICADORES_SGQ/"& objrs.Fields.Item("M08_AP_DOCTO").Value)
	...
	<tr>
		...
		<td width="100%" valign="top"><!-- :::::::::: INICIO DO CORPO CENTRAL :::::::::: -->
			<div id="dv_corpo" class="divMainQld">
                ...
                <tr>
                    <td colspan="3"><br /><b>INDICADORES DO SGQ (<%= objrs.Fields.Item("M08_NM_DOCTO").Value%>)</b><br><img src="/imagens/30/barra_tracking<%=barra_tracking %>.gif"  width="565" border="0"><br /><br /></td>
                    </tr>
					<tr height="16">
...
%>
					<tr height="16">
						<td align="left">&nbsp;<a href="/DOCS_QLD/INDICADORES_SGQ/<%= objrs.Fields.Item("M08_AP_DOCTO").Value &"/"& arquivo.Name%>" target="_blank"><%= arquivo.Name%></a></td>
