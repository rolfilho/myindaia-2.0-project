...
caminho = Server.MapPath("/DOCS_QLD/INSTRUCAO/"& objrs.Fields.Item("M08_AP_DOCTO").Value)
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" background="<%= fcn_TrocaFundo()%>" class="table">
	...
	<tr>
		...
		<td height="50" align="center"><font size="2"><b>..::: INSTRUÇÃO DE TRABALHO :::..</b></font><br></td>
	</tr>
	<tr>
...
%>
					<tr height="16">
						<td align="left">&nbsp;<a href="/DOCS_QLD/INSTRUCAO/<%= objrs.Fields.Item("M08_AP_DOCTO").Value &"/"& arquivo.Name%>" target="_blank"><%= arquivo.Name%></a></td>
