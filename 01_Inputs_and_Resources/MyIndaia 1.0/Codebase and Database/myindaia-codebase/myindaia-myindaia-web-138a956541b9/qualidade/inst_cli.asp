...
caminho = Server.MapPath("/DOCS_QLD/INSTRUCOES_TRABALHO/CLIENTE/"& objrs.Fields.Item("M08_AP_DOCTO").Value)
		...
		<td width="100%" valign="top"><!-- :::::::::: INICIO DO CORPO CENTRAL :::::::::: -->
			<div id="dv_corpo" class="divMainQld">
				<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr height="16">
                    <td colspan="3"><br /><b>INSTRUÇÕES DE TRABALHO - CLIENTE (<%= objrs.Fields.Item("M08_NM_DOCTO").Value%>)</b><br><img src="/imagens/30/barra_tracking<%=barra_tracking %>.gif"  width="565" border="0"><br /><br /></td>
                    </tr>
					<tr height="16">
						<td width="380" align="left">&nbsp;<b>Nome</b></td>
						<td width="70" align="left">&nbsp;<b>Tamanho</b></td>
...
%>
					<tr height="16">
						<td align="left">&nbsp;<a href="/DOCS_QLD/INSTRUCOES_TRABALHO/CLIENTE/<%= objrs.Fields.Item("M08_AP_DOCTO").Value &"/"& arquivo.Name%>" target="_blank"><%= arquivo.Name%></a></td>
