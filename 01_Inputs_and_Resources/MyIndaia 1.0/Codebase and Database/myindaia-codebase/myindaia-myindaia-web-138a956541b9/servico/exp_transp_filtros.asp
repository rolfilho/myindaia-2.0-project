...
function abreIntegra() {	
	...
	window.open('exp_transp_integra.asp?cd_menu=<%= cd_menu%>&cd_subm=<%= cd_subm%>&cd_usuario=<%= Session("cd_usuario")%>',"integra",features);	
...
%>
                    ...
                    <img border=0 src="/imagens/30/cancelar2<%If cd_lang=1 Then%>e<%End If%>.gif" align="middle" onClick="javascript:document.location='/default.asp';" style="cursor:pointer;"> 
                     <img border=0 src="/imagens/30/integrar2<%If cd_lang=1 Then%>e<%End If%>.gif" align="middle" onClick="javascript:abreIntegra();" style="cursor:pointer;"> 
