...
If in_dt_null or fnc_TestaVar(cd_evento) Then
  ...
  If Not fnc_TestaVar(cd_evento) Then cd_evento = "088" 'desembaraço
	...
	If Not fnc_TestaVar(nr_dias) Then nr_dias = 90
...
With objcmd
	.CommandTimeOut = 9999
	.CommandText    = "sp_rel_serv_transp_prog"
...
If nr_result > 0 Then
  ...
  str = "/servico/prog_transp_result.asp?cd_menu="& cd_menu &"&cd_subm="& cd_subm &"&cd_view="& cd_view &"&nr_ident="& nr_ident &"&"& tx_usado
Else
  tx_erro = tx_lang_A00002(cd_lang) &": "& tx_lang_A00029(cd_lang) &".\n"& tx_usado
  'escreve a url para redirecionamento
  str = "/servico/prog_transp_filtros.asp?cd_menu="& cd_menu &"&cd_subm="& cd_subm &"&cd_view="& cd_view &"&tx_erro="& Server.URLEncode(tx_erro)
End If
