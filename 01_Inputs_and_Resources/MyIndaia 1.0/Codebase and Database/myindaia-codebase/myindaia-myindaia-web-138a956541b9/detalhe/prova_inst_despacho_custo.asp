...
Dim vlInss, vlDesp, vlDif,EnviaEmbalagem

in_show = False
cd_tela = "DET011"

nr_processo = CStr(Request.QueryString("nr_processo"))
EnviaEmbalagem= Request("EnviaEmbalagem")
'Response.Redirect("../IMPORT/teste.asp?var1="&CStr(Request.QueryString("Envia"))&"")
...
'		vlDesp = objrs("VL_DESPESA_INDAIA")-objrs("VL_RECUPERADO")-objrs("VL_TOTAL_II")-objrs("VL_FRETE_INDAIA")-objrs("VL_CAPATAZIA")
		vlDesp = Request("vl_tot_geral")-objrs("VL_RECUPERADO")-objrs("VL_TOTAL_II")-objrs("VL_FRETE_INDAIA")-objrs("VL_CAPATAZIA")
...
<table border="0" cellpadding="1" cellspacing="1">
	...
	<tr>
	  <td class="azulClaro">EMBALAGEM</td>
	  <td class="cinzaClaro"><div align="right"><%=EnviaEmbalagem%></div></td>
	  </tr>
	<tr>
		<td class="branco">&nbsp;</td>
		<td class="branco">&nbsp;</td>
	...
	<tr>
		...
		<td class="cinza"><div align="right"><%= FormatNumber(vlDesp+vlInss+vlDif-EnviaEmbalagem, 2)%>&nbsp;</div></td>
	</tr>
</table>
<%
	end if  
