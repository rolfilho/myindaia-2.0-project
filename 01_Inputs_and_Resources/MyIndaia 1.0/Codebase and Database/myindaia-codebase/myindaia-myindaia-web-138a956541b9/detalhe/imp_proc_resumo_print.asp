...
If objrs.State = adStateOpen Then objrs.Close					
			...
			"INNER JOIN TPROCESSO_PENDENCIAS_LOG PL ON (P.CD_PENDENCIA = PL.CD_PENDENCIA AND P.NR_PROCESSO = PL.NR_PROCESSO) "&_
