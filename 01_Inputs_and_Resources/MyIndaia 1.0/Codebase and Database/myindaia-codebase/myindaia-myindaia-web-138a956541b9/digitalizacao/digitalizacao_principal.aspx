...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Trim(Request("retorno")) <> "" And Session("in_interno") = "0" Then
            ...
            If contador_permissao = 0 Then
                Response.Redirect("digitalizacao_principal.aspx?&produto=" & Session("produto") & "&usuario=" + Session("usuario") + "&pg=1")
            End If
        End If
    ...
    Sub EnviarArquivo(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If PrefixoArquivo <> "" Then
            ...
            If Arq.Exists Then
                ...
                CnnAux.Close()
                Page.DataBind()
                Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "script", "location.href='digitalizacao_principal.aspx?produto=" + Session("produto") + "&usuario=" + Session("usuario") + "&pg=3&retorno=" & NrProcesso & "';", True)
            Else
                Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "script", "alert('ATENÇÃO: Erro ao tentar enviar o arquivo!');location.href='digitalizacao_principal.aspx?produto=" + Session("produto") + "&usuario=" + Session("usuario") + "&pg=3&retorno=" & NrProcesso & "';", True)
            End If
        Else
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "script", "alert('ATENÇÃO: Erro ao tentar enviar o arquivo!');location.href='digitalizacao_principal.aspx?produto=" + Session("produto") + "&usuario=" + Session("usuario") + "&pg=3&retorno=" & NrProcesso & "';", True)
        End If
    ...
    Sub EnviarEmail(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Page.DataBind()
        Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "script", "location.href='digitalizacao_principal.aspx?produto=" + Session("produto") + "&usuario=" + Session("usuario") + "&pg=2&retorno=" & NrProcesso & "';", True)
    End Sub
...
<script type="text/javascript">
        ...
        if (document.getElementById) {
            ...
            if (Left(vCod, 1) != ' ' && vCod != '' && vCod != undefined) {
                ...
                if (vCod.length > 0 && vCod != 0) {
                    ...
                    ajax.onreadystatechange = function () {
                        ...
                        if (ajax.readyState == 4) { //agora exibe o que interessa
                            if (ajax.status == 200) {
                                ...
                                alert('Ocorreu um erro desconhecido, entre em contato com ti@myindaia.com.br!');
                                vDesc.value = "";
                            }
                        }
                    }
                    ...
                    alert('Ocorreu um erro de envio de dados, entre em contato com ti@myindaia.com.br!');
                    vDesc.value = ""
                }
            }
        }
        ...
        ajax.onreadystatechange = function () {
            if (ajax.readyState == 4) {
                if (ajax.status == 200) {
                    ...
                    vResult = vResult.replace(/\+/g, " ");
                    vResult = unescape(vResult);
                    document.location = 'digitalizacao_principal.aspx?produto=<%=Session("produto")%>&usuario=<%=Session("usuario")%>&pg=2&retorno=' + vResult;
                }
            }
        }
        ajax.send(null);                  
            ...
            ajax.onreadystatechange = function () {
                if (ajax.readyState == 4) {
                    if (ajax.status == 200) {
                        ...
                        //alert(vResult);
                        if (vResult == "2") {
                            alert("ATENÇÃO: Pedido/Processo/ID inválido(a)!");
                            document.getElementById(campo).focus();
                        } else {
                            if (vResult == "1") {
                                ...
                                if (tipo == '1') {
                                    ...
                                    document.location = 'digitalizacao_principal.aspx?produto=<%=Session("produto")%>&usuario=<%=Session("usuario")%>&pg=2&retorno=' + retorno;
                                }
                                if (tipo == '2') {
                                    retorno = pedido;
                                    document.location = 'digitalizacao_principal.aspx?produto=<%=Session("produto")%>&usuario=<%=Session("usuario")%>&pg=2&retorno=' + retorno;
    ...
    function mostraEmail(arquivo) {
        if (arquivo != '' && document.getElementById('frmDigitalizacaoPrincipal_txtAnexoSelecionado').value != "") {
            alert("ATENÇÃO: Utilize a opção 'Enviar arquivo(s) selecionado(s) por e-mail'!");
        }else{
...
<body class="body" style="text-align:center;background-color:#f0f1f6;margin:0px 0px 0px 0px;width:100%" onload="if('<%= Request("pg")%>'==1){carregaTelas('divDigitalizacao','divArquivos','divUpload');}if('<%= Request("pg")%>'==2){carregaTelas('divArquivos','divDigitalizacao','divUpload');}if('<%= Request("pg")%>'==3){carregaTelas('divUpload','divArquivos','divDigitalizacao');}">
    ...
    <form ID="frmDigitalizacao" runat="server" style="background-color:#f0f1f6;text-align:center;width:100%;text-align:center;margin-left:200px">
    ...
    <div id="divInfoCorpoEmail" class="divDetalhes3" style="padding-left:20px;"> 
      ...
      <img id="imgEmail" src="../../imagens/icones/16x16/btn_folder.gif" alt="Buscar" align="middle" style="cursor:pointer;" onclick="ExibeDetalhes('Favoritos','divInfoCorpo','divInfo','divInfoRodape','codigo=NM_EMAIL_FAVORITO&nome=NM_EMAIL_FAVORITO&tabela=TEMAIL_FAVORITOS&usuario=<%=Session("usuario")%>&campo=frmDigitalizacaoPrincipal_txtEmail','digitalizacao_consulta', 270, 100, -113,105);"/><br />
      <asp:Label ID="lblAssunto" runat="server" Text="Assunto" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="68px" CssClass="lbl"/>&nbsp;
      <asp:TextBox ID="txtAssunto" runat="server" CssClass="textbox" Width="290px"/><br />
      <asp:Label ID="lblMensagem" runat="server" Text="Mensagem" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="68px" CssClass="lbl"/>&nbsp;
      ...
      <span class="lbl" style="font-size:8pt;cursor:pointer;">Use ";" para separar os e-mails</span>
      </div>
      <div style="width:50px;bottom:0;">
    ...
    <div id="divDigitalizacaoPrincipal" style="display:block;">
      ...
      <div style="width:600px;text-align:left;"><br />
        <asp:RadioButton runat="server" Checked="true" onclick="selecionaOpcao(this);" ID="chkProcesso"/><asp:Label ID="lblProcessoCheck" runat="server" Text="Processo" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="100px" CssClass="lbl" style="vertical-align:middle;"/>&nbsp;<br /><br />
      </div>
      <asp:Label ID="lblUnidade" runat="server" Text="Unidade" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="100px" CssClass="lbl"/>&nbsp;
      ...
      <img id="imgUnidade" src="../../imagens/icones/16x16/btn_folder.gif" alt="Buscar" align="middle" style="cursor:pointer;" onclick="ExibeDetalhes('Unidades','divInfoCorpo','divInfo','divInfoRodape','codigo=CD_UNID_NEG&nome=AP_UNID_NEG&tabela=TUNID_NEG&usuario=<%=Session("usuario")%>&campo=frmDigitalizacaoPrincipal_txtCdUnidade','digitalizacao_consulta', 431, 205, 31,0);"/><br /><br />
      <asp:Label ID="lblProcesso" runat="server" Text="Processo" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="100px" CssClass="lbl"/>&nbsp;
      ...
      <div style="width:600px;text-align:left;">
        <asp:RadioButton runat="server" Checked="false" onclick="selecionaOpcao(this);" ID="chkPedido"/><asp:Label ID="lblPedidoCheck" runat="server" Text="Pedido" Font-Names="Verdana" Font-Size="9pt" Font-Bold="false" Width="100px" CssClass="lbl" style="vertical-align:middle;" />&nbsp;<br /><br />
      </div>
    ...
    <div id="divArquivosPrincipal" style="display:none;">
      <asp:UpdatePanel ID="upArquivosPrincipal" runat="server">    
        ...
        <div style="height: 20px;width:660px;overflow:hidden;border-color:#f8a310;border-style:solid;border-width:1px;text-align:center;">
          ...
          <td style="width:260px">Descrição</td>
          <td style="width:180px">Criador do Registro</td>
          <td style="width:170px">Data de Criação</td>
          </tr></table>
        </div>
        <div id="divgrdArquivos" style="height:300px;width:660px;overflow:auto;border-color:#f8a310;border-style:solid;border-width:1px;">
          <asp:GridView ID="grdArquivos" runat="server" DataSourceID="SqlArquivos"
            ...
            <EmptyDataTemplate>       
            <asp:Image ID="imgLogoEmpty" runat="server" ImageUrl="../../imagens/alerta_32.gif" style="vertical-align:middle;" ImageAlign="AbsMiddle"/><asp:Label ID="lblEmptyLista" runat="server" Text="Sem arquivos" style="font-family:Verdana;font-size:9pt"/>
             </EmptyDataTemplate>     
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText=" " ItemStyle-Width="40px">
                  <ItemTemplate>
                     <asp:HyperLink ID="ibVisualizaArquivo" runat="server" style="cursor:pointer;" ToolTip="Visualizar" Target="_blank" NavigateUrl='<%# Eval("CODIGO", "..\..\redireciona_doc.asp?cod={0}")%>'><img id="imgVisualiza" src="../../imagens/30/view_doctos.gif" alt="Visualizar" align="absmiddle" style="cursor:pointer;border:0;" /></asp:HyperLink>&nbsp;
        ...
        <div style="width:640px;text-align:right;">       
          <img id="imgEmailDoctos" src="../../imagens/30/mail_doctos.gif" align="middle"/>&nbsp;<span onclick="mostraEmail('');" class="lbl" style="font-size:9pt;cursor:pointer;">Enviar arquivo(s) selecionado(s) por e-mail</span>
        </div>
        </ContentTemplate>
      </asp:UpdatePanel>
    </div>
