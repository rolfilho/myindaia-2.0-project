...
Select Case cd_lang
	Case 1
		...
		tipo_referencia = Array("ORDER","ORDER","DELIVERY","OTHERS","BOOKING","SEEK","SAP USA","EASY","COURRIER","DRAWBACK", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAP")
	...
	Case 2
		...
		tipo_referencia = Array("PEDIDO","ORDEM","REMESSA","OUTROS","BOOKING","SEEK","SAP USA","EASY","COURRIER","DRAWBACK", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAPA")
	...
	Case Else
		...
		tipo_periodo    = Array("Dias","Meses")
		nm_tp_quebra    = Array("Grupo de Empresas","Empresa","Modalidade","Área","Empresa Estrangeira","Exportador/Fornecedor")
		tipo_referencia = Array("PEDIDO","ORDEM","REMESSA","OUTROS","BOOKING","SEEK","SAP USA","CLIENTE","COURRIER","ATO CONCESSORIO", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAP")
		sim_nao         = Array("Não","Sim")
		tipo_local_doc  = Array("Indaiá","Cliente","Outros")
...
tipo_cntr     = Array("PIER","CNTR 20'DRY","CNTR 40'DRY","TANK 20'","TANK 40'","REFFER","20'REEFER","40'REEFER","20'OPEN TOP","40'OPEN TOP","40'HC","40'HC REEFER","FR 40","FR 20","40'OH","20´OTC","20´OTS")
