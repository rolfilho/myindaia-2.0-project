...
Select Case cd_lang
	Case 1
		...
		tipo_referencia = Array("ORDER","ORDER","DELIVERY","OTHERS","BOOKING","SEEK","SAP USA","EASY","COURRIER","DRAWBACK", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAP","PROTOCOLO BB","RECOPI","PROTOCOLO FORM A","MAIN LEG.","CORREIOS","FATURA","CARTA DE CRÉDITO","PEDIDO DE EMBARQUE","SAT","OIC","CONJUGADO","CERTIFICADO CONFORMIDADE","CORREIOS","CORREIOS FRONTEIRA","GSDB FABRICANTE","COURIER HEALTH","NCM","PROTOCOLO","EXPORTADOR","QUALITY CERTIFICATE","EMBARCAR QTDE", "EMBARCAR SALDO")
	...
	Case 2
		...
		tipo_referencia = Array("PEDIDO","ORDEM","REMESSA","OUTROS","BOOKING","SEEK","SAP USA","EASY","COURRIER","DRAWBACK", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAPA","PROTOCOLO BB","RECOPI","PROTOCOLO FORM A","MAIN LEG.","CORREIOS","FATURA","CARTA DE CRÉDITO","PEDIDO DE EMBARQUE","SAT","OIC","CONJUGADO","CERTIFICADO CONFORMIDADE","CORREIOS","CORREIOS FRONTEIRA","GSDB FABRICANTE","COURIER HEALTH","NCM","PROTOCOLO","EXPORTADOR","QUALITY CERTIFICATE","EMBARCAR QTDE", "EMBARCAR SALDO")
	...
	Case Else
		...
		tipo_periodo    = Array("Dias","Meses")
		nm_tp_quebra    = Array("Grupo de Empresas","Empresa","Modalidade","Área","Empresa Estrangeira","Exportador/Fornecedor")
		tipo_referencia = Array("PEDIDO","ORDEM","REMESSA","OUTROS","BOOKING","SEEK","SAP USA","CLIENTE","COURRIER","ATO CONCESSORIO", "SAP TM","COTAÇÃO","NÚMERO DO LOTE","BOOKING CO-LOADER","MAP","PROTOCOLO BB","RECOPI","PROTOCOLO FORM A","MAIN LEG.","CORREIOS","FATURA","CARTA DE CRÉDITO","PEDIDO DE EMBARQUE","SAT","OIC","CONJUGADO","CERTIFICADO CONFORMIDADE","CORREIOS","CORREIOS FRONTEIRA","GSDB FABRICANTE","COURIER HEALTH","NCM","PROTOCOLO","EXPORTADOR","QUALITY CERTIFICATE","EMBARCAR QTDE", "EMBARCAR SALDO")
		sim_nao         = Array("Não","Sim")
		tipo_local_doc  = Array("Indaiá","Cliente","Outros")
