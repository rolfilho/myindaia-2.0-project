...
<%
'---------------------------------------------------------------------------
'Sistema MyIndaiá WEB - Financeiro / Volumes
...
%>
							...
							<%
		Case "0009","0010","0011","0012","0013","0017","0044","0049","0058","0062","0068","0069","0085","0136","0177","0182","0290","0296","0297" 'Outros Selects
%>
							<td align="right"><input type="checkbox" name="filtro" id="<%= objrsv("M10_AP_FILTRO")%>X" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
