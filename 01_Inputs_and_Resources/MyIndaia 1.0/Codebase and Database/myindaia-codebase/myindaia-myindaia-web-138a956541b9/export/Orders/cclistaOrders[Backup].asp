...
dim  sql_o,Customer,Embarque
dim vNrOrder,TX_ORDER_NUMBER,NR_1ST_WEEK,NR_REVISED_WEEK,TX_PO_CUSTOMER
...
'SELECT ANTIGO
sql_s = "SELECT NR_1ST_WEEK,CD_CUSTOMER,NR_REVISED_WEEK,TX_PO_CUSTOMER,TX_ORDER_NUMBER,TX_INVOICE,CD_CUSTOMER,CD_PORT_OF_DESTINATION "
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#336699" style="padding: 2px 2px 0px 2px;">
	<tr height="18">
		<td width="38" class="gridtit"><span class="style17">1 ST</span></td>
	  <td width="53" class="gridtit"><span class="style17">Revised</span></td>
	  <td width="103" class="gridtit"> <span class="style17">PO Customer</span></td>
	  <td width="183" class="gridtit"> <span class="style17">Order Number</span></td>
	  <td width="163" class="gridtit" ><span class="style17">Invoice Number</span></td>
	  <td width="232" class="gridtit style9 style18"><span class="style5">Customer</span>&nbsp;</td>
	  <td width="100" class="gridtit style9 style18"><span class="style5">Destination</span>&nbsp;</td>
	  <td width="50" valign="top" class="gridtit style18 style9">Duplicar</td>
	  <td width="50" class="gridtit style9 style18"><div align="center"><span class="style19">Excluir</span>&nbsp;</div></td>
	</tr>
	<%end if
...
%>
	<tr height="15" bgcolor="<%= bgcolor%>" align="center" valign="top">
		...
		<td align="left"><div align="left"><a href="alteraOrders.asp?TX_PO_CUSTOMER=<%=objrs.Fields.Item("TX_PO_CUSTOMER").Value%>&vTpacao=Exibir"><strong><%=objrs.Fields.Item("TX_PO_CUSTOMER").Value%></strong></a></div></td>
