...
sql = "SELECT CD_RAP, CD_RAP_ANO, CD_STATUS, CD_USUARIO_CANC, CD_USUARIO_FIM, CD_USUARIO_CRIADOR, DT_INSERCAO, DT_CANCELADO, DT_FINALIZADO,CD_CLIENTE,CD_EMBARCADOR,CD_DEP_COLETA,CD_FABRICANTE,CD_EXPORTADOR, "&_
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<td align="right" style="font-size:8px">Abertura: <%= fnc_Mascara(objrs.Fields.Item("DT_INSERCAO").Value, 5)&" "&Left(fnc_Mascara(objrs.Fields.Item("DT_INSERCAO").Value, 7), 5)%><br>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="1">
			...
			<tr height="<%= vl_heigth%>">
				...
				<td class="c2"> <%= objrs.Fields.Item("CD_CLIENTE").Value%> - <%= objrs.Fields.Item("NM_CLIENTE").Value%></td>
				<td class="c1"><b>Fabricante:</b></td>
				<td class="c2">	<%IF sim_nao(objrs.Fields.Item("IN_FABR_EXPO").Value)="Sim" then%> <%=objrs.Fields.Item("CD_EXPORTADOR").Value%> - <%=objrs.Fields.Item("NM_EXPORTADOR").Value%><%else%>
				<%= objrs.Fields.Item("CD_FABRICANTE").Value%> - <%= objrs.Fields.Item("NM_FABRICANTE").Value%> <%end if%>			</td>
			</tr>
			<tr height="<%= vl_heigth%>">
			...
			<tr height="<%= vl_heigth%>">
			  <td colspan="4" class="c1"><table width="837" border="0">
                <tr>
                  <td class="c1" width="170" style="font-size:8px" align="left"><b>Nr. Fornecimento:</b></td>
                  <td width="657" style="font-size:8px" align="left"><%= Replace(Trim(objrs.Fields.Item("NR_FORNECIMENTO").Value),";","; ")%></td>
                </tr>
              </table></td>
		  </tr>
			<tr height="<%= vl_heigth%>">
...
Response.Write(str)%></td>
			...
			<tr height="<%= vl_heigth%>">
				...
				<td class="c2"><%= objrs.Fields.Item("CD_DEP_COLETA").Value%> - <%= objrs.Fields.Item("NM_DEP_COLETA").Value%></td>
				<td class="c1">&nbsp;</td>
				<td class="c2">&nbsp;</td>
			</tr>
			<tr height="<%= vl_heigth%>">
				...
				<td class="c2"><%= objrs.Fields.Item("CD_EMBARCADOR").Value%> - <%= objrs.Fields.Item("NM_EMBARCADOR").Value%></td>
			</tr>
			<tr height="<%= vl_heigth%>">
			...
			<tr height="<%= vl_heigth%>">
				...
				<td class="c2"><%= objrs.Fields.Item("CD_NOTIFY").Value%> - <%= fncTipoPessoaExp(objrs.Fields.Item("CD_NOTIFY").Value, objrs.Fields.Item("TP_NOTIFY").Value)%></td>
				<td class="c1"><b>Consignee:</b></td>
				<td class="c2"><%= objrs.Fields.Item("CD_CONSIGNATARIO").Value%> - <%= fncTipoPessoaExp(objrs.Fields.Item("CD_CONSIGNATARIO").Value, objrs.Fields.Item("TP_CONSIGNEE").Value)%></td>
			</tr>
			<tr height="<%= vl_heigth%>">
			...
			<tr height="<%= vl_heigth%>">
			  <td colspan="4" class="c1"><fieldset><legend>Instru&ccedil;&atilde;o Geral:</legend><br>
...
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr height="35">
						<td colspan="7" style="font-size:8px">Fornecimentos Integrados:</td>
					</tr>
					<tr height="18">
						<td class="pgridtit" style="font-size:8px">Nr. Fornec.</td>
						<td class="pgridtit" style="font-size:8px">Item</td>
						<td class="pgridtit" style="font-size:8px">C&oacute;d. Merc.</td>
						<td class="pgridtit" style="font-size:8px">NCM</td>
						<td class="pgridtit" style="font-size:8px">NALADI</td>
						<td class="pgridtit" style="font-size:8px">Descri&ccedil;&atilde;o</td>
						<td class="pgridtit" style="font-size:8px">Unid.</td>
						<td class="pgridtit" style="font-size:8px">Qtde.</td>
						<td class="pgridtit" style="font-size:8px">Valor Un.</td>
						<td class="pgridtit" style="font-size:8px">Proforma</td>
						<td class="pgridtit" style="font-size:8px">Volumes</td>
					</tr>
					<%
...
%>
					<tr height="16" style="text-align: center; vertical-align: top;">
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("CD_FORNECIMENTO").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px" ><nobr><%= objrs.Fields.Item("NR_ITEM_CLIENTE").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("CD_MERCADORIA").Value%></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("CD_NCM_SH").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("CD_NALADI_SH").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("NM_MERCADORIA").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("TX_UNID_MEDIDA").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("VL_QTDE").Value%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= FormatNumber(objrs.Fields.Item("VL_PRECO_UNIT").Value, 2)%></nobr></td>
						<td class="pgridsub" style="font-size:8px"><nobr><%= objrs.Fields.Item("NR_PROFORMA").Value%></nobr></td>
