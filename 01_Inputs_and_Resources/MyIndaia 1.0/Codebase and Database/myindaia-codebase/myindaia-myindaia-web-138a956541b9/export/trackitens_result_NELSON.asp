...
If Not fnc_TestaVar(Session("sql_exp_track_itens")) Then
  ...
  sql_s =  "SELECT DISTINCT                                               "&_
	       ...
	       "PR.CD_IMPORTADOR                  AS CD_IMPORTADOR,           "&_
  ...
  sql_f =           "   FROM TREL_EXP_TRACK                    R   (NOLOCK)                                                          "&_
                    ...
                    "  OUTER APPLY (SELECT TOP 1 NM_UNID_MEDIDA FROM TUNID_MEDIDA_BROKER UMB WHERE UMB.CD_UNID_MEDIDA = I.CD_UNID_MEDIDA) UNM "
...
End if 
		...
		'*=======================================================================================================
			...
			Select Case objrsv.Fields.Item("M10_TP_DADO").Value & objrsv.Fields.Item("M10_TP_CONSULTA") 
							...
							Select Case objrsv.Fields.Item("M10_CD_DADO").Value
										...
										Case "0621","0616","2345","2346","2347","2348","0681" 'Ítens - Cód. Mercadoria
								            sql_s = sql_s									
						  ...
						  '============================================================================================
							Case "20","30"'Decimal, Moeda
								Select Case objrsv.Fields.Item("M10_CD_DADO").Value
										Case "0063","0173","0617" 'Peso liquido/bruto
												sql_s = sql_s '&_
  ...
  sql_u_f =   "  FROM TREL_EXP_TRACK                    	R   (NOLOCK)                                           "&_           
              ...
              " OUTER APPLY (SELECT TOP 1 NM_UNID_MEDIDA FROM TUNID_MEDIDA_BROKER UMB WHERE UMB.NM_SIGLA = NFI.UN_COMERCIAL) UNM "
