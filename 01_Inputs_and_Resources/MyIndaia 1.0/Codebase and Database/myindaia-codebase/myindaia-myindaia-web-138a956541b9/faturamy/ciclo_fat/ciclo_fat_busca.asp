...
Response.Redirect("ciclo_fat_filtros.asp?cd_menu="& cd_menu & "&cd_subm="& cd_subm& "&in_pesquisa=1")
End If
...
With objcmd
	.CommandTimeOut = 9999
	.CommandText    = "sp_rel_fat_ciclo_money"
...
If nr_result > 0 Then
  ...
  str = "/faturamy/ciclo_fat/ciclo_fat_result.asp?cd_menu="& cd_menu &"&cd_subm="& cd_subm &"&cd_view="& cd_view &"&nr_ident="& nr_ident &"&vl_total_num="& vl_total_num &"&vl_total_des="& vl_total_des &"&vl_total_sld="& vl_total_sld &"&"& tx_usado
Else
  tx_erro = tx_lang_A00002(cd_lang) &": "& tx_lang_A00029(cd_lang) &".\n"& tx_usado
  'escreve a url para redirecionamento
  str = "/faturamy/ciclo_fat/ciclo_fat_filtros.asp?cd_menu="& cd_menu &"&cd_subm="& cd_subm &"&cd_view="& cd_view &"&tx_erro="& Server.URLEncode(tx_erro)
End If
