...
<script runat="server">   
    ...
    Protected Sub CriaGrafico(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim I, TotalMes, ContadorAux3, QtdeMesesGrafico, ContadorAux4 As Integer
        Dim in_decimal_aux, in_decimal_aux2, in_decimal_aux3, InDecimal, InGraficoProcessosAbertos, CdProduto, CdGrupo, NrMeta As String
        ...
        Dim UteisCorridos As Boolean
               
        SqlAux = "  SELECT R.NM_COMPLETO, R.NM_KPI, R.CD_KPI, R.CD_TP_KPI, R.NM_QUEBRAS, R.ID_KPI, I.IN_DECIMAL, I.IN_DESVIOS, ISNULL(CONVERT(VARCHAR, R.NR_META),'') AS NR_META, ISNULL(TP_AGRUPAMENTO, '1') AS TP_AGRUPAMENTO, " & _
        " I.IN_META, I.IN_LEGENDA_META, I.QTDE_MESES_GRAFICO, I.IN_GRAFICO_PROC_ABERTOS, I.CD_GRUPO, I.CD_PRODUTO, I.IN_UTEIS_CORRIDOS, " & _
        ...
        "    AND R.TP_KPI <> '3' " & _
        "  GROUP BY R.CD_MBF, R.CD_USUARIO, R.NM_COMPLETO, R.NM_KPI, R.CD_KPI, R.CD_TP_KPI, R.NM_QUEBRAS, R.ID_KPI, IN_DECIMAL, I.IN_DESVIOS, I.IN_META, I.IN_LEGENDA_META, I.QTDE_MESES_GRAFICO, I.CD_GRUPO, I.CD_PRODUTO, I.IN_GRAFICO_PROC_ABERTOS, R.NR_META, I.TP_AGRUPAMENTO, I.IN_UTEIS_CORRIDOS " & _
        "  ORDER BY R.ID_KPI, R.NM_COMPLETO "
        ...
        Do While RsAux.Read()
            ...
            InGraficoProcessosAbertos = RsAux("IN_GRAFICO_PROC_ABERTOS")
            CdGrupo = RsAux("CD_GRUPO")
            CdProduto = RsAux("CD_PRODUTO")
            InDecimal = RsAux("IN_DECIMAL")
            IdKPI = RsAux("ID_KPI")
            UteisCorridos = RsAux("IN_UTEIS_CORRIDOS")
                           
            If UteisCorridos Then
                Lbl1.Text = "Úteis"
                Lbl2.Text = "Corridos"
            End If
            ...
            Select Case TpAgrupamento
                Case "1"
                    ...
                    If Not UteisCorridos Then                    
                        ...
                        "                                 FROM TMBF_RESULTADO M1 (NOLOCK) " & _
                    ...
                    Else
                        ...
                        "                                  AND R1.ANO_RESULTADO = S.ANO_SELECIONADO" & _
                        "                                  AND R1.NM_COMPLETO = R.NM_COMPLETO) " & in_decimal_aux2 & " AS TOTAL," & _
                        "                                  " & in_decimal_aux & "SUM(R.DIAS_KPI_CORRIDOS) " & in_decimal_aux3 & "/(SELECT COUNT(R1.NR_PROCESSO) " & _
                        "                                FROM TMBF_RESULTADO R1 (NOLOCK) " & _
                        "                                WHERE R1.CD_MBF = R.CD_MBF" & _
                        "                                  AND R1.CD_USUARIO = R.CD_USUARIO" & _
                        "                                  AND R1.MES_RESULTADO = S.MES_SELECIONADO" & _
            ...
            If UteisCorridos Then
                chtGrafico1.Series.Item(0).Url = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 1, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',2);"
                chtGrafico1.Series.Item(0).LabelUrl = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 1, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',2);"
            Else
                chtGrafico1.Series.Item(0).Url = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 1, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',0);"
                chtGrafico1.Series.Item(0).LabelUrl = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 1, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',0);"
            End If
            
            If RsAux("IN_DESVIOS") = "1" Or UteisCorridos Then
                ...
                If UteisCorridos Then
                    chtGrafico1.Series("seGrafico2" + CStr(I)).Url = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',1);"
                    chtGrafico1.Series("seGrafico2" + CStr(I)).LabelUrl = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',1);"
                Else
                    chtGrafico1.Series("seGrafico2" + CStr(I)).Url = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',0);"
                    chtGrafico1.Series("seGrafico2" + CStr(I)).LabelUrl = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "',0);"
                End If
        ...
        SqlAux = "SELECT DISTINCT O.CD_GRAFICO, O.NM_GRAFICO AS NM_KPI, O.IN_MODAL, O.IN_CNPJ, O.IN_AREA, O.IN_ESTUFAGEM, O.IN_LI, O.IN_PAIS_ORIGEM, O.IN_PREFIXO, " & _
        " O.IN_TERMINAL, O.IN_CANAL, O.IN_SERVICO, O.IN_LOCAL_DES, I.IN_DECIMAL, I.IN_DESVIOS, ISNULL(I.TP_AGRUPAMENTO, '1') AS TP_AGRUPAMENTO, I.IN_LEGENDA_META, I.IN_GRAFICO_PROC_ABERTOS, I.CD_GRUPO, I.CD_PRODUTO," & _
        " I.QTDE_MESES_GRAFICO, O.ID_GRAFICO, R.NM_COMPLETO, R.NM_QUEBRAS, " & _
         " (SELECT TOP 1 NR_PROCESSO " & _
        "  FROM TMBF_RESULTADO R1 (NOLOCK) " & _
        "  WHERE R1.CD_MBF = R.CD_MBF " & _
        "  AND R1.CD_USUARIO = R.CD_USUARIO " & _
        "  AND R1.NM_COMPLETO = R.NM_COMPLETO" & _
        "  AND R1.NR_PROCESSO <> '9999XX-9999-99') AS PROCESSO " & _
        "   FROM TMBF_OUTROS O (NOLOCK)" & _
        "     INNER JOIN TMBF_INFO I (NOLOCK) ON I.CD_MBF = O.CD_MBF AND I.CD_USUARIO = O.CD_USUARIO" & _
        "     INNER JOIN TMBF_RESULTADO R (NOLOCK) ON R.CD_MBF = O.CD_MBF AND R.CD_USUARIO = O.CD_USUARIO AND R.CD_KPI = O.CD_GRAFICO AND R.ID_KPI = O.ID_GRAFICO " & _
         "  WHERE O.CD_MBF = " & Request("codigo") & " " & _
        "    AND O.CD_USUARIO = '" & Request("usuario") & "' " & _
        "    AND R.NR_PROCESSO <> '9999XX-9999-99'   " & _
        " ORDER BY ID_GRAFICO    "
        ...
        Do While RsAux.Read()
            ...
            If RsAux("IN_CANAL") = "1" And (RsAux("IN_MODAL") = "0" And RsAux("IN_CNPJ") = "0" And RsAux("IN_AREA") = "0" And RsAux("IN_ESTUFAGEM") = "0" And RsAux("IN_PAIS_ORIGEM") = "0" And RsAux("IN_PREFIXO") = "0" And RsAux("IN_SERVICO") = "0" And RsAux("IN_LOCAL_DES") = "0" And RsAux("IN_TERMINAL") = "0") Then
                Select Case TpAgrupamento
                    Case "1"
                        SqlAux2 = "SELECT COUNT(MES_SELECIONADO) AS TOTAL FROM (SELECT MES_SELECIONADO, " & _
                           " DENSE_RANK() OVER(ORDER BY ANO_SELECIONADO DESC, MES_SELECIONADO DESC) AS CONTADOR " & _
                        ...
                        " FROM TMBF_RESULTADO R3 (NOLOCK) " & _
                        ...
                        " FROM TMBF_RESULTADO R4 (NOLOCK) " & _
                        ...
                        " FROM TMBF_RESULTADO R5 (NOLOCK) " & _
                        ...
                        " FROM TMBF_RESULTADO R6 (NOLOCK) " & _
                        ...
                        " FROM TMBF_RESULTADO R7 (NOLOCK) " & _
                        ...
                        " AND ISNULL(R.CD_SERVICO, '') = ''" & _
                        " AND ISNULL(R.CD_LOCAL_DES, '') = ''" & _
            ...
            Else
                Select Case TpAgrupamento
                    ...
                    Case "2"
                        ...
                        SqlGraficoOutros.SelectCommand = " SELECT * FROM (SELECT MES, MES_AUX, CD_KPI, NM_COMPLETO, ANO_SELECIONADO, SUM(TOTAL) AS TOTAL, " & _
                        " DENSE_RANK() OVER(ORDER BY ANO_SELECIONADO DESC, MES_AUX DESC, NM_COMPLETO ) AS CONTADOR " & _
                        " FROM (SELECT DISTINCT " & _
                        " CASE WHEN S.MES_SELECIONADO IN (1, 2, 3) THEN 'Jan/Mar' " & _
                        " ELSE CASE WHEN S.MES_SELECIONADO IN (4, 5, 6) THEN 'Mai/Jun' " & _
        ...
        If InGraficoProcessosAbertos Then
            Dim SqlGraficoProcessosAbertos As SqlDataSource = New SqlDataSource
            SqlGraficoProcessosAbertos.ConnectionString = Cnn
            Select Case TpAgrupamento
                Case "1"
                    SqlAux2 = "SELECT COUNT(MES_SELECIONADO) AS TOTAL FROM (SELECT MES_SELECIONADO, " & _
                       " DENSE_RANK() OVER(ORDER BY ANO_SELECIONADO DESC, MES_SELECIONADO DESC) AS CONTADOR " & _
                    ...
                    SqlGraficoProcessosAbertos.SelectCommand = "SELECT MES, ANO_SELECIONADO, MES_SELECIONADO, CONTADOR," & _
                    "(SELECT COUNT(F.NR_PROCESSO) " & _
                    "FROM TFOLLOWUP F (NOLOCK)" & _
                    "  INNER JOIN TPROCESSO P (NOLOCK) ON P.NR_PROCESSO = F.NR_PROCESSO" & _
                    " WHERE YEAR(F.DT_REALIZACAO) = ANO_SELECIONADO " & _
                    "  AND MONTH(F.DT_REALIZACAO) = MES_SELECIONADO " & _
                    "  AND F.CD_EVENTO = '003'" & _
                    "  AND P.CD_GRUPO = '" & CdGrupo & "'" & _
                    "  AND P.CD_PRODUTO = '" & CdProduto & "') AS TOTAL" & _
                    " FROM (SELECT DISTINCT MASTER.DBO.FN_MONTHNAME_2(S.MES_SELECIONADO) + ' ('+ CONVERT(VARCHAR, S.ANO_SELECIONADO) + ')' AS MES, " & _
                    " S.ANO_SELECIONADO, S.MES_SELECIONADO,  " & _
                    " DENSE_RANK () OVER(ORDER BY S.ANO_SELECIONADO DESC, S.MES_SELECIONADO DESC) CONTADOR " & _
                    " FROM TMBF_SELECIONADO S (NOLOCK) " & _
                    " WHERE S.CD_USUARIO = '" & Request("usuario") & "' " & _
                    " AND S.CD_MBF = " & Request("codigo") & " " & _
                    " AND S.IN_GERADO = 1 " & _
                    " GROUP BY S.CD_MBF, S.CD_USUARIO, S.ANO_SELECIONADO, S.MES_SELECIONADO) AS TABELA " & _
                    " " & SqlAux3 & " " & _
                    "ORDER BY ANO_SELECIONADO, MES_SELECIONADO"
                ...
                Case "2"
                    ...
                    SqlGraficoProcessosAbertos.SelectCommand = " SELECT * FROM (SELECT MES, MES_AUX, ANO_SELECIONADO, SUM(TOTAL) AS TOTAL,  " & _
                    " DENSE_RANK() OVER(ORDER BY ANO_SELECIONADO DESC, MES_AUX DESC) AS CONTADOR " & _
                    " FROM (SELECT DISTINCT " & _
                    " CASE WHEN S.MES_SELECIONADO IN (1, 2, 3) THEN 'Jan/Mar' " & _
                    " ELSE CASE WHEN S.MES_SELECIONADO IN (4, 5, 6) THEN 'Mai/Jun' " & _
                    ...
                    " GROUP BY MES, MES_AUX, ANO_SELECIONADO) AS TABELA2 " & _
                    " " & SqlAux3 & " " & _
                    " ORDER BY ANO_SELECIONADO, MES_AUX "
                Case "3"
                    SqlAux2 = " SELECT COUNT(MES_SELECIONADO) AS TOTAL FROM (SELECT MES_SELECIONADO, " & _
                ...
                Case "0"
                    ...
                    SqlGraficoProcessosAbertos.SelectCommand = "SELECT MES, ANO_SELECIONADO, CONTADOR," & _
              " (SELECT COUNT(F.NR_PROCESSO) " & _
              " FROM TFOLLOWUP F (NOLOCK)" & _
              "  INNER JOIN TPROCESSO P (NOLOCK) ON P.NR_PROCESSO = F.NR_PROCESSO" & _
              " WHERE YEAR(F.DT_REALIZACAO) = ANO_SELECIONADO " & _
              ...
              "  AND P.CD_GRUPO = '" & CdGrupo & "'" & _
              "  AND P.CD_PRODUTO = '" & CdProduto & "') AS TOTAL" & _
              " FROM (SELECT DISTINCT S.ANO_SELECIONADO AS MES, " & _
              " S.ANO_SELECIONADO,  " & _
              " DENSE_RANK () OVER(ORDER BY S.ANO_SELECIONADO DESC) CONTADOR " & _
              " FROM TMBF_SELECIONADO S (NOLOCK) " & _
              " WHERE S.CD_USUARIO = '" & Request("usuario") & "' " & _
              " AND S.CD_MBF = " & Request("codigo") & " " & _
              " AND S.IN_GERADO = 1 " & _
              " GROUP BY S.CD_MBF, S.CD_USUARIO, S.ANO_SELECIONADO) AS TABELA " & _
               " " & SqlAux3 & " " & _
              " ORDER BY ANO_SELECIONADO"
            End Select
            
            'Response.Write(SqlGraficoProcessosAbertos.SelectCommand)
            'Response.End()
            
            Dim chtGrafico3 As Chart = New Chart
            chtGrafico3.Height = 350
            chtGrafico3.Width = 465
            chtGrafico3.Palette = ChartColorPalette.None
            chtGrafico3.DataSource = SqlGraficoProcessosAbertos
                                  
            'AREA DO GRAFICO
            chtGrafico3.ChartAreas.Add("caGraficoProcessosAbertos")
            chtGrafico3.ChartAreas.Item(0).AxisX.Interval = 1
            chtGrafico3.ChartAreas.Item(0).AxisX.Title = ""
            chtGrafico3.ChartAreas.Item(0).AxisX.IsLabelAutoFit = False
            chtGrafico3.ChartAreas.Item(0).AxisX.MajorGrid.Enabled = True
            chtGrafico3.ChartAreas.Item(0).AxisX.MajorGrid.Interval = 100
            chtGrafico3.ChartAreas.Item(0).AxisX.MajorTickMark.Enabled = True
            chtGrafico3.ChartAreas.Item(0).AxisX.MajorTickMark.Interval = 1
            chtGrafico3.ChartAreas.Item(0).AxisX.LabelStyle.Angle = "-30"
            chtGrafico3.ChartAreas.Item(0).AxisX.LabelStyle.Font = NewFont2
            chtGrafico3.ChartAreas.Item(0).AxisX.Maximum.ToString()
            
            'chtGrafico1.ChartAreas.Item(0).AxisY.Interval = 2
            'chtGrafico3.ChartAreas.Item(0).AxisY.Minimum = 0
            chtGrafico3.ChartAreas.Item(0).AxisY.IsMarksNextToAxis = False
            chtGrafico3.ChartAreas.Item(0).AxisY.LineColor = Drawing.Color.Transparent
            chtGrafico3.ChartAreas.Item(0).AxisY.LineDashStyle = ChartDashStyle.NotSet
            chtGrafico3.ChartAreas.Item(0).AxisY.LineWidth = 0
            chtGrafico3.ChartAreas.Item(0).AxisY.IsLabelAutoFit = True
            chtGrafico3.ChartAreas.Item(0).AxisY.LabelStyle.Font = NewFont2
            chtGrafico3.Series.Add("seGraficoProcessosAbertos")
            chtGrafico3.Series.Item(0).XValueMember = "MES"
            chtGrafico3.Series.Item(0).YValueMembers = "TOTAL"
            chtGrafico3.Series.Item(0).IsValueShownAsLabel = True
            'chtGrafico1.Series.Item(0).Legend = "legenda_apresentacao" + CStr(I)
            'chtGrafico1.Series.Item(0).LegendText = "Com desvios"
            chtGrafico3.Series.Item(0).LabelFormat = "0"
            chtGrafico3.Series.Item(0)("PointWidth") = "0.8"
            chtGrafico3.Series.Item(0)("BarLabelStyle") = "Outside"
            chtGrafico3.Series.Item(0).LabelBackColor = Drawing.Color.White
            chtGrafico3.Series.Item(0).LabelBorderColor = Drawing.Color.DarkGray            
            chtGrafico3.Series.Item(0).LabelToolTip = "#VALY"
            chtGrafico3.Series.Item(0).Palette = ChartColorPalette.None
            chtGrafico3.Series.Item(0).Color = Drawing.Color.DarkGray
            chtGrafico3.Series.Item(0).Font = NewFont2
            'chtGrafico3.Series("seGraficoProcessosAbertos").Url = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "');"
            'chtGrafico3.Series("seGraficoProcessosAbertos").LabelUrl = "javascript:ExibeDesvios('" + "#INDEX" + "', '" + CdKpi + "', 0, '" + TpAgrupamento + "', '" + NrProcesso + "', '" + ddlPaginacao.SelectedValue + "', '" & CdTpKpi & "', '" + CStr(QtdeMesesGrafico) + "', '" + CStr(IdKPI) + "');"
                
            chtGrafico3.Titles.Add("ttGraficoProcessosAbertos")
            chtGrafico3.Titles.Item(0).Text = "Processos Abertos"
            chtGrafico3.Titles.Item(0).Font = NewFont3
            pnlGrafico.Controls.Add(chtGrafico3)
        End If
...
<script type="text/javascript">
    ...
    function carrega_pagina() {
        ...
        divGrafico.style.height = altura - 205;            
    }
    ...
    function carregaTelaCheia(objeto) {
        ...
        var divGrafico = document.getElementById("divGraficoMBF")
        if (objeto.checked) {
            divGrafico.style.height = altura - 65;
        } else {
            divGrafico.style.height = altura - 205;      
        }
    }

    function ExibeDesvios(posicao, kpi, tipo, tp_agrupamento, processo, pagina, cd_tp_kpi, qtde_meses, id_kpi, tipo2) {
        if (document.getElementById) {
            fechaDesvios();
            ...
            var ajax = openAjax();
            ajax.open('POST', 'mbf_desvios.aspx?cd_mbf=' + cd_mbf + '&usuario=' + usuario + '&processo=' + processo + '&contador=' + posicao + '&tipo=' + tipo + '&agrupamento=' + tp_agrupamento + '&cd_kpi=' + kpi + '&produto=' + cd_produto + '&pagina=' + pagina + '&cd_tp_kpi=' + cd_tp_kpi + '&qtde_meses=' + qtde_meses + '&id_kpi=' + id_kpi + '&tipo2=' + tipo2, true);
            ajax.onreadystatechange = function () {
                if (ajax.readyState == 1) {
...
<body class="body" style="text-align:center;background-color:#f0f1f6;margin:0px 0px 0px 0px;width:100%;" onload="carrega_pagina();">
  ...
  <asp:ScriptManager ID="smMBF" runat="server"/>
    ...
    <div style="position:absolute;right:0;height:33px;top:0;"><img src="\imagens\30\logo_novo_mbf.jpg"/></div>
    <div id="divGrafico" style="border-width:0px;position:absolute;top:20px;text-align:left;">    
    ...
    <div id="divGraficoMBF" style="background-color:#FFFFFF;border-color:#cd1414;border-style:solid;border-width:1px;padding-left:15px;padding-top:15px;padding-bottom:15px;padding-right:15px;border-top-width:1px;width:99%;text-align:left;overflow-y:scroll;">
      ...
      <img src="/imagens/30/com_desvios.gif"/>&nbsp;<asp:Label ID="Lbl1" runat="server" Text="Com desvios"></asp:Label>&nbsp;&nbsp;
      <img src="/imagens/30/sem_desvios.gif"/>&nbsp;<asp:Label ID="Lbl2" runat="server" Text="Sem desvios"></asp:Label>&nbsp;&nbsp;
