...
'monta a instrução sql
	...
	sql = "UPDATE TUSUARIO SET CD_GRUPO_DETALHES = '" & exibe_detalhe_atual &  "' FROM TUSUARIO WHERE CD_USUARIO = '" & Session("cd_usuario") & "'"
	cnnBroker.Execute(sql)
	Session("GrupoDetalhe") = exibe_detalhe_atual
