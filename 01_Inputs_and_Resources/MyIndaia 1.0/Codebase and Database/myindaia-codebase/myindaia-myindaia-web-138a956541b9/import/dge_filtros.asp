...
<%
'---------------------------------------------------------------------------
'Sistema MyIndaiá - PAgamento de Demurrage Importação
'Arquivo de Script e HTML: Filtros da Busca
'
'Modificado por Alexandre Gonçalves Neto em 20/12/2005
'
'---------------------------------------------------------------------------
%>
