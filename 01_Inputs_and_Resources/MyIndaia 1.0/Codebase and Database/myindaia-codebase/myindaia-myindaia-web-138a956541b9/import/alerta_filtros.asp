...
<%
'---------------------------------------------------------------------------
'Sistema MyIndaiá WEB - Importação / Alerta
'Arquivo de Script e HTML: Filtros do Relatório
'
'Autor: Alexandre Gonçalves Neto
'Criado: 30/06/2005
'
'Manutenção: 06/06/2006
'---------------------------------------------------------------------------
%>
...
%>
							<td align="right"><input type="checkbox" name="filtro" id="Checkbox1" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
...
%>
                        ...
                        <tr align="left">
                        <td colspan="<%= CStr(vl_colspan) + 4%>"><br><font size="2"><b><%=tx_lang_004068(cd_lang) %></b></font><br><img src="/imagens/barra_tracking<%=barra_tracking %>.gif"  width="565" border="0"><br><br>
                        </td>
                        </tr>
                        ...
                        <td align="left" width="17"><a href="#" onClick="criaCombo('<%= CStr(vl_width_form)%>','ordenacao', this, '<%=bg_btn%>');"><img align="left" id="img_ordenacao" src='/imagens/icones/16x16/btn_mais20<%=bg_btn%>.gif' style='border:0;display:none' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><img align="left" id="img_ordenacao2" src='/imagens/icones/16x16/btn_mais20<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_ordencao" id="contador_ordenacao"><input type="text" style="display:none" value="0" name="contador_total_ordenacao" id="contador_total_ordenacao"></td>
						</tr> 
