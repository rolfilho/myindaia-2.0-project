...
<script>//alert("carregando menu...");</script>
		...
		<td width="100%" valign="top" background="<%= fcn_TrocaFundo2()%>"><!-- :::::::::: INICIO DO CORPO CENTRAL :::::::::: -->
			<div id="dv_corpo" class="divMainTop">
			  ...
			  <form name="frmbusca" method="post" action="/import/track_busca.asp" onSubmit="return validSubmit()">
						<tr>
                            ...
                            <font size="2"><br><b><%= tx_lang_A00020(cd_lang)%></b><font color="<%=color_texto %>"><%If cd_lang = 0 or cd_lang = 2 Then%><% If Session("cd_cargo") <> "088" Then%><span style="margin-left:20px;"><%Else%><span style="margin-left:150px;"><%End If%><%Else%><span style="margin-left:100px;"><%End If%><b><a href="/personaliza/cad_view.asp?in_acao=editar&cd_menu=<%= cd_menu%>&cd_subm=<%= cd_subm%>&cd_view=<%= cd_view%>" style="color:<%=color_texto %>;"><%= tx_lang_004004(cd_lang)%></a> / <a href="#" onClick="javascript:ExibeDetalhes('divInfo','divInfoCorpo', 'divInfoRodape',2);" style="color:<%=color_texto %>;"><%= tx_lang_TF001(cd_lang)%> </a>/ <a href="#" onClick="javascript:carregaPesquisa('<%=cd_view %>','track_filtros');" style="color:<%=color_texto %>;"><%= tx_lang_TF043(cd_lang)%></a><% If Session("cd_cargo") <> "088" Then%> / <a href="#" onClick="javascript:ExibeDetalhesCR();" style="color:<%=color_texto %>;"><%=tx_lang_TF044(cd_lang)%></a><%End If%></b></font></font></span><br>
...
<option value="1"><%=tx_lang_TF002(cd_lang)%></option>
							...
							<td width="320px"><nobr><input type="text" style="display:none" value="combo" name="controle_<%= objrsv("M10_AP_FILTRO")%>" id="controle_<%= objrsv("M10_AP_FILTRO")%>"><select class="select" style="width: <%= CStr(vl_width_form)%>px;display:block" name="<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);" <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}" <%End If%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>',document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),3)"> 
...
%>
			...
			End If
%>
								</select><input name="edt_<%= objrsv("M10_AP_FILTRO")%>" type="text" class="editbox" style="width: <%= CStr(vl_width_form)%>px; text-transform: uppercase;display:none" onFocus="enterInput(this);" <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}" <%End If%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>') ,2)"><input class="editbox" type="hidden" name="vazio_<%= objrsv("M10_AP_FILTRO")%>" <%If objrsv.Fields.Item("M11_IN_VAZIO").Value Then Response.write "value='V'" else Response.write "value='NV'" end if%> style="display:none"></nobr><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><div id="camposTexto_<%= objrsv("M10_AP_FILTRO")%>" style="display:none;"></div><%End If%></td>
                                
                                <td align="left" width="17"><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><a href="#" onClick="criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');"><img id="img_<%= objrsv("M10_AP_FILTRO")%>" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;display:none;' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><img align="left" id="img_<%= objrsv("M10_AP_FILTRO")%>2" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_<%= objrsv("M10_AP_FILTRO")%>" id="contador_<%= objrsv("M10_AP_FILTRO")%>"><input type="text" style="display:none" value="0" name="contador_total_<%= objrsv("M10_AP_FILTRO")%>" id="contador_total_<%= objrsv("M10_AP_FILTRO")%>"><%End If%></td>
							<%
...
%>
                                ...
                                <td align="left" width="17"><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><a href="#" onClick="criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');"><img id="img_<%= objrsv("M10_AP_FILTRO")%>" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;display:none;' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><img align="left" id="img_<%= objrsv("M10_AP_FILTRO")%>2" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_<%= objrsv("M10_AP_FILTRO")%>" id="contador_<%= objrsv("M10_AP_FILTRO")%>"><input type="text" style="display:none" value="0" name="contador_total_<%= objrsv("M10_AP_FILTRO")%>" id="contador_total_<%= objrsv("M10_AP_FILTRO")%>"><%End If%></td>
							<%
		Case "0009","0010","0011","0012","0013","0017","0044","0058","0062","0068","0069","0085","0136","0177","0182","0290","0296","0297","0576","0126","0612","0653","0655","0679","0686","0702","0709","0716","0049","0854"'Outros Selects
%>
							<td align="right"><input type="checkbox" name="filtro" id="<%= objrsv("M10_AP_FILTRO")%>X" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
							<td width="320px"><nobr><input type="text" style="display:none" value="<%= objrsv("M10_NM_DADO")%>" name="nome_<%= objrsv("M10_AP_FILTRO")%>" id="nome_<%= objrsv("M10_AP_FILTRO")%>"><label for="<%= objrsv("M10_AP_FILTRO")%>X" class="label"><%= objrsv("M10_NM_DADO")%>&nbsp;</label></nobr></td>
                            <td><select class="select" style="width:90px;" name="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);" id="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onChange="fnc_comboEdt('<%= objrsv("M10_AP_FILTRO")%>',this);">
<option value="1"><%=tx_lang_TF002(cd_lang)%></option>
			...
			Select Case objrsv.Fields.Item("M10_CD_DADO").Value
				...
				case "0012","0013","0854" %><!--#include virtual="/selects/option_local_embarque.txt"--><%'PORTO / AEROPORTO DE DESTINO / ORIGEM
...
%>
                       ...
                       <%
                       Case "1077" 'Select - tipo de pedido follow-up%>
                            <td height="22" align="right"><input type="checkbox" name="filtro" id="<%= objrsv("M10_AP_FILTRO")%>X" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
							<td width="320px"><nobr><input type="text" style="display:none" value="<%= objrsv("M10_NM_DADO")%>" name="nome_<%= objrsv("M10_AP_FILTRO")%>" id="nome_<%= objrsv("M10_AP_FILTRO")%>"><label for="<%= objrsv("M10_AP_FILTRO")%>X" class="label"><%= objrsv("M10_NM_DADO")%>&nbsp;</label></nobr></td>
                            <td><select class="select" style="width:90px;" name="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);" id="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onChange="fnc_comboEdt('<%= objrsv("M10_AP_FILTRO")%>', this);" >
                            <option value="1"><%=tx_lang_TF002(cd_lang)%></option>
			...
			sql = "SELECT 0 AS CODIGO, '' DESCRICAO "&_
                              " UNION SELECT 1 AS CODIGO, 'ON TIME' DESCRICAO "&_
                              " UNION SELECT 2 AS CODIGO, 'RISCO' DESCRICAO "
                              If objrsx.State = adStateOpen Then objrsx.Close()
				objrsx.Open sql, objcnn, adOpenStatic, adLockReadOnly, adCmdText
                        Do While Not objrsx.Eof
%>
...
%>
							...
							<td><nobr><input type="text" style="display:none" value="text" name="controle_<%= objrsv("M10_AP_FILTRO")%>" id="controle_<%= objrsv("M10_AP_FILTRO")%>"><input class="editbox" type="text" name="<%= objrsv("M10_AP_FILTRO")%>" style="width: <%= CStr(vl_width_form)%>px; text-transform: uppercase;display:<% If objrsv.Fields.Item("M10_CD_DADO").Value <> "0485" Then%>block<%Else%>none<%End If%>" onFocus="enterInput(this);"  <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaEdit('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}"<%End If%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),1)"><input name="edt_<%= objrsv("M10_AP_FILTRO")%>" class="editbox" style="width: <%= CStr(vl_width_form)%>px; text-transform: uppercase;display:<% If objrsv.Fields.Item("M10_CD_DADO").Value <> "0485" Then%>none<%Else%>block<%End If%>;" onFocus="enterInput(this);" <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaEdit('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}"<%End if%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),2)"><input class="editbox" type="hidden" name="vazio_<%= objrsv("M10_AP_FILTRO")%>" <%If objrsv.Fields.Item("M11_IN_VAZIO").Value Then Response.write "value='V'" else Response.write "value='NV'" end if%> style="display:none"></nobr><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><div id="camposTexto_<%= objrsv("M10_AP_FILTRO")%>" style="display:none;"></div><%End If%></td>
                            
                            <td align="left" width="17"><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><a href="#" onClick="criaEdit('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');"><img align="left" id="img_<%= objrsv("M10_AP_FILTRO")%>" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;display:none' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><img align="left" id="img_<%= objrsv("M10_AP_FILTRO")%>2" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_<%= objrsv("M10_AP_FILTRO")%>" id="contador_<%= objrsv("M10_AP_FILTRO")%>"><input type="text" style="display:none" value="0" name="contador_total_<%= objrsv("M10_AP_FILTRO")%>" id="contador_total_<%= objrsv("M10_AP_FILTRO")%>"><%End If%></td>
							<%
...
%>
							...
							<td><nobr>
                                ...
                                <a href="#" onClick="criaEdit();"><img src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><%End If%></td>
							<%
			End Select
	End Select
...
%>
                        ...
                        <td align="left" width="17"><a href="#" onClick="criaCombo('<%= CStr(vl_width_form)%>','ordenacao', this, '<%=bg_btn%>');"><img align="left" id="img_ordenacao" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;display:none' class='top' alt='<%=tx_lang_TF017(cd_lang)%>'></a><img align="left" id="img_ordenacao2" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_ordencao" id="contador_ordenacao"><input type="text" style="display:none" value="0" name="contador_total_ordenacao" id="contador_total_ordenacao"></td>
						</tr> 
