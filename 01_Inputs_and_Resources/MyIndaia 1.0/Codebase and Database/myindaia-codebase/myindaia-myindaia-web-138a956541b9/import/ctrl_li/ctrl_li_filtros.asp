...
%>
					...
					<%Case "2146","2147" 'Select - processo urgente, seguro/hermes%>
							<td height="22" align="right"><input type="checkbox" name="filtro" id="Checkbox1" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
							<td width="320px"><nobr><input type="text" style="display:none" value="<%= objrsv("M10_NM_DADO")%>" name="nome_<%= objrsv("M10_AP_FILTRO")%>" id="Text1"><label for="<%= objrsv("M10_AP_FILTRO")%>X" class="label"><%= objrsv("M10_NM_DADO")%>&nbsp;</label></nobr></td>
                            <td><select class="select" style="width:90px;" name="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);" id="Select1" onChange="fnc_comboEdt('<%= objrsv("M10_AP_FILTRO")%>', this);" >
<option value="1"><%=tx_lang_TF002(cd_lang)%></option>
                            <%If objrsv.Fields.Item("M11_IN_CONTEM").Value Then%>
                            <option value="2"><%=tx_lang_TF003(cd_lang)%></option>
                            <% 
                            ...
                            <%
							End if%>
                            </select><input type="text" style="display:none" value="0" name="aux_combo_aux_<%= objrsv("M10_AP_FILTRO")%>" id="Text2"><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><div id="Div1" style="display:none;" align="right"></div><%End If%></td>
							<td><nobr><input type="text" style="display:none" value="combo" name="controle_<%= objrsv("M10_AP_FILTRO")%>" id="Text3"><select class="select" style="width: 75px;display:block" name="<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);"<%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%> onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}"<%End If%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>',document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),3)">
                            <%If objrsv.Fields.Item("M11_IN_VAZIO").Value Then%>
                                    <option value="">(<%=tx_lang_TF016(cd_lang)%>)</option>
                                    <%
                                    End if%>
								...
								</select><input name="edt_<%= objrsv("M10_AP_FILTRO")%>" type="text" class="editbox" style="width: <%= CStr(vl_width_form)%>px; text-transform: uppercase;display:none" onFocus="enterInput(this);" <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');return false;}" <%End if%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>',document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),2)"><input class="editbox" type="hidden" name="vazio_<%= objrsv("M10_AP_FILTRO")%>" <%If objrsv.Fields.Item("M11_IN_VAZIO").Value Then Response.write "value='V'" else Response.write "value='NV'" end if%> style="display:none"></nobr><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><div id="Div2" style="display:none;"></div><%End If%></td>
                                <td align="left" width="17"><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><a href="#" onClick="criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),'<%=bg_btn%>');"><img id="img1" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;display:none;' class='top' alt='<%=tx_lang_TF017(cd_lang)%>' ></a><img align="left" id="img2" src='/imagens/30/btn_mais<%=bg_btn%>.gif' style='border:0;visibility:hidden' class='top'><input type="text" style="display:none" value="0" name="contador_<%= objrsv("M10_AP_FILTRO")%>" id="Text4"><input type="text" style="display:none" value="0" name="contador_total_<%= objrsv("M10_AP_FILTRO")%>" id="Text5"><%End If%></td>
							<%	                                                      
		Case "2148","2136","2137" 'Selects - Grupo, Clientes, Área e Sub-área
%>
							<td align="right"><input type="checkbox" name="filtro" id="<%= objrsv("M10_AP_FILTRO")%>X" value="<%= objrsv("M10_AP_FILTRO")%>" onClick="clickCheck(this)"<%= checked%>></td>
							<td width="320px"><nobr><input type="text" style="display:none" value="<%= objrsv("M10_NM_DADO")%>" name="nome_<%= objrsv("M10_AP_FILTRO")%>" id="nome_<%= objrsv("M10_AP_FILTRO")%>"><label for="<%= objrsv("M10_AP_FILTRO")%>X" class="label"><%= objrsv("M10_NM_DADO")%>&nbsp;</label></nobr></td>
                            <td><select class="select" style="width:90px;" name="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);" id="combo_aux_<%= objrsv("M10_AP_FILTRO")%>" onChange="fnc_comboEdt('<%= objrsv("M10_AP_FILTRO")%>',this);">
							...
							End if
							If objrsv.Fields.Item("M11_IN_DIF").Value Then
								If Not (objrsv.Fields.Item("M10_CD_DADO").Value = "2148" and Session("cargo_interno") <> "1") Then
							%>
                            <option value="5"><%=tx_lang_TF004(cd_lang)%></option>
                            <%
								End If
							...
							<td><nobr><input type="text" style="display:none" value="combo" name="controle_<%= objrsv("M10_AP_FILTRO")%>" id="controle_<%= objrsv("M10_AP_FILTRO")%>"><select class="select" style="width: <%= CStr(vl_width_form)%>px;display:block" name="<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);"<%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%> onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'));return false;}" <% End If%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>',document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),3)">
                                    ...
                                    End if%>
									<%
			If Not Session("cargo_interno") = "1" or InStr("2137",objrsv.Fields.Item("M10_CD_DADO").Value) > 0 Then
				'selecionas apenas os dados que o usuário cliente tem permissão
				Select Case objrsv.Fields.Item("M10_CD_DADO").Value
					Case "2148" 'SELECIONA O NOME DOS GRUPOS DE EMPRESAS DO CLIENTE
						sql = "SELECT DISTINCT E.CD_GRUPO AS CODIGO, E.NM_GRUPO AS DESCRICAO " &_
									...
									"ORDER BY DESCRICAO"  
                     Case "2136" 'SELECIONA O NOME DOS GRUPOS DE EMPRESAS DO CLIENTE
						sql = "SELECT DISTINCT E.CD_EMPRESA AS CODIGO, E.NM_EMPRESA + ' - ' + E.AP_EMPRESA AS DESCRICAO " &_
									...
									"ORDER BY DESCRICAO"       
                      Case "2137" 'SELECIONA O NOME DOS ORGAOS ANUENTES
						sql = " SELECT CODIGO, DESCRICAO FROM TORGAO_ANUENTES " &_
							  " ORDER BY DESCRICAO"                                                                                                         
				End Select
...
%>
			...
			Else
				...
				Select Case objrsv.Fields.Item("M10_CD_DADO").Value
					Case "2148" %><!--#include virtual="/selects/option_grupo_cliente.txt"--><%'Grupo Cliente   
                    Case "2136" %><!--#include virtual="/selects/option_cliente.txt"--><%'Cliente                                 	
				End Select
			End If
%>
								</select><input name="edt_<%= objrsv("M10_AP_FILTRO")%>" type="text" class="editbox" style="width: <%= CStr(vl_width_form)%>px; text-transform: uppercase;display:none" onFocus="enterInput(this);" <%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%>onKeyPress="if(window.event.shiftKey && event.keyCode == 45){return false;}if(window.event.shiftKey && event.keyCode == 43){criaCombo('<%= CStr(vl_width_form)%>','<%= objrsv("M10_AP_FILTRO")%>', document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'));return false;}" <%End if%> onBlur="escreveValor('<%= objrsv("M10_AP_FILTRO")%>',document.getElementById('combo_aux_<%= objrsv("M10_AP_FILTRO")%>'),2)"><input class="editbox" type="hidden" name="vazio_<%= objrsv("M10_AP_FILTRO")%>" <%If objrsv.Fields.Item("M11_IN_VAZIO").Value Then Response.write "value='V'" else Response.write "value='NV'" end if%> style="display:none"></nobr><%If objrsv.Fields.Item("M11_IN_VARIOS").Value Then%><div id="camposTexto_<%= objrsv("M10_AP_FILTRO")%>" style="display:none;"></div><%End If%></td>
...
if Request("ultima_pesquisa") = 1 Then
	...
	cnstr = "Provider=SQLOLEDB;Persist Security Info=True;"&_
					"Data Source="& SQLSERVER &";Initial Catalog=MYINDAIA;"&_
