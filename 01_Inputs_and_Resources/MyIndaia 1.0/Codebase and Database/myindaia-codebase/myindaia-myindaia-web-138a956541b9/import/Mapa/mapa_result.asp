...
If Not fnc_TestaVar(Session("sql_imp_mapa")) Then

sql_s = " SELECT  R.*   "
sql_f = sql_f & " FROM TREL_IMP_MAPA R " 
...
'Response.Redirect("teste.asp?var1="&sql_s&sql_f&"")
	...
	Else
	sql_o = sql_o &" CONVERT(DATETIME, DT_RECEBIMENTO_PO_MAPA,103) ASC" 
	End If
	...
	Session("sql_imp_mapa") = sql_s & sql_f & sql_w & sql_o
	'response.Write(Session("sql_imp_mapa"))
	'response.end
End If
...
tx_path_file  = "/import/mapa/mapa_excel"
tx_path_excel = "/import/mapa/mapa_excel"
