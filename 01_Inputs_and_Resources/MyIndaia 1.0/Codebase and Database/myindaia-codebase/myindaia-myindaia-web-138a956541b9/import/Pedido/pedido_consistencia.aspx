...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If codigo = "SERVICO" Then
            SqlAux = "SELECT COUNT(*) AS VALIDO FROM TCLIENTE_SERVICO (NOLOCK) " & _
            " WHERE CD_SERVICO  = '" & Request("cd_servico") & "' " & _
            "  AND CD_CLIENTE  = '" & Request("cd_cliente") & "' " & _
            "  AND CD_UNID_NEG = '" & Request("cd_unid_neg") & "' " & _
            "  AND CD_PRODUTO  = '06' " & _
            "  AND IN_ATIVO    = '1' "
            resposta = "ATENÇÃO: Serviço sem habilitação para esta Unidade/Produto/Cliente!"
        End If
