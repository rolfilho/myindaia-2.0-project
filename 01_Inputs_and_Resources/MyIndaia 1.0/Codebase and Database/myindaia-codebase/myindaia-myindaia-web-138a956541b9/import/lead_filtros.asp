...
<%
'---------------------------------------------------------------------------
'Sistema MyIndaiá WEB - Importação / KPI por Serviço
'Arquivo de Script e HTML: Filtros do Relatório
'
'Autor: Alexandre Gonçalves Neto
'Criado: 02/07/2005
'
'Manutenção: 08/08/2006
'---------------------------------------------------------------------------
%>
  ...
  <tr>
    ...
    <td width="100%" valign="top"><!-- :::::::::: INICIO DO CORPO CENTRAL :::::::::: -->
      <div id="dv_corpo" class="divMainTop">
          ...
          <form name="frmbusca" method="post" action="/import/lead_busca.asp" onSubmit="return validSubmit()">
            <tr>
...
%>
              ...
              <td><select class="select" style="width: <%= CStr(vl_width_form)%>px;" name="<%= objrsv("M10_AP_FILTRO")%>" onFocus="enterInput(this);">
                  ...
                  <option value="06"<%If Session("cd_produto") = "06" Then Response.Write(" selected")%>>Administração
                  de Pedido</option>
                </select></td>
              <%
