...
<%
    ...
    Dim vDtRealizacao, nr_parcial As String
    
    SqlAux = ""
    If Request.QueryString("dt_realizacao") = "" Then vDtRealizacao = "NULL" Else vDtRealizacao = "CONVERT(DATETIME,'" & Request.QueryString("dt_realizacao") & "',103)"
    If Request.QueryString("nr_parcial") = "S" Then nr_parcial = "0" Else nr_parcial = Request.QueryString("nr_parcial")
        ...
        Try
            If Request.QueryString("tp_atualiza") = "1" Then
               ...
               " IN_APLICAVEL  = " & Request.QueryString("aplica") & " " & _
