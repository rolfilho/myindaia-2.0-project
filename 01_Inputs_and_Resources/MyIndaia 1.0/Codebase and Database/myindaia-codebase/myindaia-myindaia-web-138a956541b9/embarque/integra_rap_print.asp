...
'Arquivo de Script e HTML: Impressão da Instrução de Embarque
'
...
<%
dim vNrRap, vNrCde, vVolume, vTpStatus, vDtStatus, vHrStatus
...
sql = "SELECT CD_RAP, CD_RAP_ANO, CD_STATUS, CD_USUARIO_CANC, CD_USUARIO_FIM, CD_USUARIO_CRIADOR, DT_INSERCAO, DT_CANCELADO, DT_FINALIZADO, "&_
			"  ISNULL((SELECT RTRIM(NM_EMPRESA) FROM TEMPRESA_NAC (NOLOCK) WHERE CD_EMPRESA = R.CD_EXPORTADOR), '&nbsp;') AS NM_EXPORTADOR, "&_
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="5">
			<tr>
				...
				<td colspan="2" class="titulo">Instrução de Embarque <%= Left(vNrRap,6)&"/"&Right(vNrRap,2)%></td>
			</tr>
			<tr>
				<td><%= objrs.Fields.Item("NM_EXPORTADOR").Value%><b><br>
					Nr. CDE/Fatura: <%= vNrCde%></b></td>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="1">
			...
			<tr height="<%= vl_heigth%>">
				...
				<td class="c2"><%= objrs.Fields.Item("NM_FABRICANTE").Value%></td>
			</tr>
			<tr height="<%= vl_heigth%>">
