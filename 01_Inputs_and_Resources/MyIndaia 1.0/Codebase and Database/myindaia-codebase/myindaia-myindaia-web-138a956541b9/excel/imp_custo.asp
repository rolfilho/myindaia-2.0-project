  			...
  			Case "0010" 'país de Procedência caso não tenha na capa pega o primeiro item
				...
				'Response.Redirect("../IMPORT/teste.asp?var1="&sql&"")
                 ...
                 Case "0085" 'Agente de carga
				   str = ""
				   If objrsx.State = adStateOpen Then objrsx.Close()
				   sql="select tp.NR_PROCESSO,tp.cd_agente,ta.nm_agente as agente "&_
				   " from tprocesso tp, tagente ta where NR_PROCESSO= '"& nr_processo &"' and ta.cd_agente=tp.cd_agente"
				   objrsx.Open sql, objcnn, adOpenStatic, adLockReadOnly, adCmdText
				   If objrsx.RecordCount > 0 Then
				     str =   Trim( Replace( objrsx.Fields.Item("agente").Value, """", "'") )
				   End If
'  			       Response.Redirect("../IMPORT/teste.asp?var1="&sql&"")
				   objtxt.WriteLine("    <td class='texto' bgcolor='"& bgcolor &"'>"& str &"</td>")
'				   objtxt.WriteLine("    <td class='texto' bgcolor='"& bgcolor &"'>OI</td>")
				   objrsx.Close					
