...
<%
	...
	Do While Not objrsv.Eof
		...
		Else
			...
			Select Case objrsv.Fields.Item("M10_CD_DADO").Value 
				Case "0018","0094","0096","0097","0098","0099","0100","0101","0118","0123"
					w = " width='100'"
				Case Else
					w = ""
			End Select
	...
	objtxt.WriteLine("  <tr>")
  objtxt.WriteLine("    <td height='15' colspan='"& col &"' align='left' class='gridsub'><nobr>Foram encontrados "& objrs.RecordCount &" registros.</nobr></td>")
  objtxt.WriteLine("  </tr>")
