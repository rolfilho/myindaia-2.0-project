...
type
  ...
  private
    ...
    FPosicaoConsulta : Integer;
    FUltimoProcesso : String;
    FDespachanteIndice : Integer;
    fConsultasPorLote: Integer;
  ...
  published
    ...
    property PosicaoConsulta : Integer read FPosicaoConsulta write FPosicaoConsulta;
    property UltimoProcesso : String read FUltimoProcesso write FUltimoProcesso;
    property CdDespachante : String read FCdDespachante write FCdDespachante;
    property DespachanteIndice : Integer read fDespachanteIndice write fDespachanteIndice;
    property ConsultasPorLote : Integer read fConsultasPorLote write fConsultasPorLote;
  public
...
//  if Self.Intervalo <= 1 then
//    Self.Intervalo := 120;
  //Self.IndiceCertificado := 0;
end;
