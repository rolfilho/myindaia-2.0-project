...
live in [IDP/04 — Questions for Indaiá.md](IDP/04%20%E2%80%94%20Questions%20for%20Indai%C3%A1.md); this
roll-up only summarises and points to them, so the two cannot drift out of sync.

---

## 1. CEO premises to confirm — [05_Kickoff_Brief.md](05_Kickoff_Brief.md) §1
...
## 2. Assumptions to re-test, not inherit — [02_Discovery_Plan.md](02_Discovery_Plan.md) §5
...
## 3. Critical-path dependencies & access asks — [02_Discovery_Plan.md](02_Discovery_Plan.md) §3 (CP-1/2/3) + [05_Kickoff_Brief.md](05_Kickoff_Brief.md) §4
...
## 4. Interview questions — [02_Discovery_Plan.md](02_Discovery_Plan.md) §7
...
## 5. OCR / IDP questions — [IDP/04 — Questions for Indaiá.md](IDP/04%20%E2%80%94%20Questions%20for%20Indai%C3%A1.md) (canonical detail — 13 questions, clusters A–E)
...
file a thin index. If this file is ever pushed to Notion, convert the `.md` links to absolute (GitHub)
URLs first — Notion rejects relative-path link targets (see the notion-sync troubleshooting note).
